...
retry:
	...
	j2iTransition(
		...
		isMethodDefaultConflictForMethodHandle = isMethodDefaultConflictForMethodHandle || (J9_BCLOOP_SEND_TARGET_DEFAULT_CONFLICT == J9_BCLOOP_DECODE_SEND_TARGET(_sendMethod->methodRunAddress));
