...
J9::Power::UnresolvedDataSnippet::UnresolvedDataSnippet(TR::CodeGenerator *cg, TR::Node *node,
    TR::SymbolReference *symRef, bool isStore, bool canCauseGC)
...
void TR_Debug::print(OMR::Logger *log, TR::UnresolvedDataSnippet *snippet)
{
    ...
    distance = *((int32_t *)cursor) & 0x03fffffc;
    distance = (distance << 6) >> 6; // sign extend
    log->printf("b \t" POINTER_PRINTF_FORMAT "\t\t; <clinit> case - Branch back to main line code",
