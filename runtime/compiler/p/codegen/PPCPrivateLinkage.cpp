...
int32_t J9::Power::PrivateLinkage::buildPrivateLinkageArgs(TR::Node                         *callNode,
   ...
   for (int32_t i = TR::RealRegister::FirstGPR; i <= TR::RealRegister::LastGPR; ++i)
      ...
      if (isJitDispatchJ9Method && i == getProperties().getVTableIndexArgumentRegister())
         continue;
...
void J9::Power::PrivateLinkage::buildDirectCall(TR::Node *callNode,
 ...
 //    newPostDeps->addPostCondition(j9MethodReg, TR::RealRegister::gr11);
   ...
   //   postDeps->addPreCondition(j9MethodReg, TR::RealRegister::NoReg);
     ...
     // interpCallSnippet->gcMap().setGCRegisterMask(flags);
      ...
      generateTrg1ImmInstruction(cg(), TR::InstOpCode::li, callNode, scratchReg2, 20);
     ...
     // generateTrg1ImmInstruction(cg, TR::InstOpCode::li, callNode, scratchReg2, 7);
      ...
      generateTrg1Src1ImmInstruction(cg(), TR::InstOpCode::srawi, callNode, j9MethodReg, j9MethodReg, 17);
      if (comp()->target().is64Bit())
         {
