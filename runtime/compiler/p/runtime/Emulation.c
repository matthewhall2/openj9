...
static void setrc(intptr_t r, unsigned long *gpregs)
{
...
static void cmprb(uint32_t insn, unsigned long *gpregs)
{
...
#ifdef TR_HOST_64BIT
static void cmpeqb(uint32_t insn, unsigned long *gpregs)
{
    uintptr_t ra = gpregs[XFORM_RA(insn)];
    uintptr_t rb = gpregs[XFORM_RB(insn)];

    uint8_t src1 = ra & 0xFFu;
    uint32_t match = src1 == ((rb >> 0) & 0xFFu) || src1 == ((rb >> 8) & 0xFFu) || src1 == ((rb >> 16) & 0xFFu)
        || src1 == ((rb >> 24) & 0xFFu) || src1 == ((rb >> 32) & 0xFFu) || src1 == ((rb >> 40) & 0xFFu)
        || src1 == ((rb >> 48) & 0xFFu) || src1 == ((rb >> 56) & 0xFFu);
...
static void modsw(uint32_t insn, unsigned long *gpregs)
{
    uintptr_t ra = gpregs[XFORM_RA(insn)];
    uintptr_t rb = gpregs[XFORM_RB(insn)];
...
static void moduw(uint32_t insn, unsigned long *gpregs)
{
    uintptr_t ra = gpregs[XFORM_RA(insn)];
    uintptr_t rb = gpregs[XFORM_RB(insn)];
...
#ifdef TR_HOST_64BIT
static void modsd(uint32_t insn, unsigned long *gpregs)
{
    uintptr_t ra = gpregs[XFORM_RA(insn)];
    uintptr_t rb = gpregs[XFORM_RB(insn)];
...
static void modud(uint32_t insn, unsigned long *gpregs)
{
    uintptr_t ra = gpregs[XFORM_RA(insn)];
    uintptr_t rb = gpregs[XFORM_RB(insn)];
...
static void setb(uint32_t insn, unsigned long *gpregs)
{
...
static void extswsli(uint32_t insn, unsigned long *gpregs)
{
...
static void addpcis(uint32_t insn, unsigned long *gpregs)
{
...
static void maddld(uint32_t insn, unsigned long *gpregs)
{
...
static void mtspr(uint32_t insn, unsigned long *gpregs, p9emu_ctx_t *ctx)
{
...
static void mfspr(uint32_t insn, unsigned long *gpregs, p9emu_ctx_t *ctx)
{
    uint32_t spr = XFXFORM_SPR(insn);
    uintptr_t rt;
...
static void rfebb(uint32_t insn, unsigned long *gpregs, p9emu_ctx_t *ctx)
{
...
static p9emu_insn_id_t p9emu_decode_insn_p4(uint32_t insn)
{
...
static p9emu_insn_id_t p9emu_decode_insn_p19(uint32_t insn)
{
...
static p9emu_insn_id_t p9emu_decode_insn_p31(uint32_t insn)
{
...
static p9emu_insn_id_t p9emu_decode_insn(uint32_t insn)
{
...
static int32_t p9emu_process(p9emu_ctx_t *ctx, ucontext_t *uctx)
{
#ifdef TR_HOST_64BIT
