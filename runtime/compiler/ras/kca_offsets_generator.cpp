...
const char *J9::Options::kcaOffsets(const char *option, void *, TR::OptionTable *entry)
{
    char szFileName[40];
    char szCMPRSS[8];
    char szRT[4];
    ...
    snprintf(szFileName, sizeof(szFileName), "kca_offsets_gen_R%d_%d%s%s.h", EsVersionMajor, EsVersionMinor, szCMPRSS,
        szRT);
