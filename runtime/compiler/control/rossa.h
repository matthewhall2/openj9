...
IDATA j9jit_testarossa_err(struct J9JITConfig *jitConfig, J9VMThread *context, J9Method *method, void *oldStartPC,
    TR_CompilationErrorCode *compErrCode);
IDATA retranslateWithPreparation(struct J9JITConfig *jitConfig, J9VMThread *vmThread, J9Method *method,
    void *oldStartPC, UDATA reason);
IDATA retranslateWithPreparationForMethodRedefinition(struct J9JITConfig *jitConfig, J9VMThread *vmThread,
    J9Method *method, void *oldStartPC);
...
jint onLoadInternal(J9JavaVM *javaVM, J9JITConfig *jitConfig, char *xjitCommandLine, char *xaotCommandLine,
    UDATA flagsParm, void *reserved0, I_32 xnojit);
