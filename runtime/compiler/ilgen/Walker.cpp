...
static TR::SymbolReference *createLoadFieldSymRef(TR::Compilation *comp, TR_OpaqueClassBlock *fieldClass,
    const char *fieldname, bool nullIfNotFound = false);
...
static void printTrees(OMR::Logger *log, TR::Compilation *comp, TR::TreeTop *firstTree, TR::TreeTop *stopTree,
    const char *message)
{
    // TODO: This should be in the debug DLL
...
TR::Block *TR_J9ByteCodeIlGenerator::walker(TR::Block *prevBlock)
{
    ...
    if (prevBlock == 0 && comp()->isOutOfProcessCompilation() && _methodSymbol->getResolvedMethod()) {
        ...
        if (_methodSymbol->getResolvedMethod() == comp()->getMethodBeingCompiled())
            static_cast<TR_ResolvedJ9JITServerMethod *>(_methodSymbol->getResolvedMethod())
                ->cacheResolvedMethodsCallees(2);
    ...
    while (_bcIndex < _maxByteCodeIndex) {
        ...
        switch (_bc) {
            ...
            case J9BCiconst1:
                ...
                break;
            case J9BCiconst2:
                loadConstant(TR::iconst, 2);
                _bcIndex += 1;
                break;
            case J9BCiconst3:
                loadConstant(TR::iconst, 3);
                _bcIndex += 1;
                break;
            case J9BCiconst4:
                loadConstant(TR::iconst, 4);
                _bcIndex += 1;
                break;
            case J9BCiconst5:
                loadConstant(TR::iconst, 5);
                _bcIndex += 1;
                break;

            case J9BClconst0:
                loadConstant(TR::lconst, (int64_t)0);
                _bcIndex += 1;
                break;
            case J9BClconst1:
                loadConstant(TR::lconst, (int64_t)1);
                _bcIndex += 1;
                break;
            ...
            case J9BCfconst0:
                ...
                break;
            case J9BCfconst1:
                loadConstant(TR::fconst, 1.0f);
                _bcIndex += 1;
                break;
            case J9BCfconst2:
                loadConstant(TR::fconst, 2.0f);
                _bcIndex += 1;
                break;
            ...
            case J9BCdconst0:
                ...
                break;
            case J9BCdconst1:
                loadConstant(TR::dconst, 1.0);
                _bcIndex += 1;
                break;

            case J9BCldc:
                loadFromCP(TR::NoType, nextByte());
                _bcIndex += 2;
                break;
            case J9BCldcw:
                loadFromCP(TR::NoType, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCldc2lw:
                loadFromCP(TR::NoType, next2Bytes());
            ...
            case J9BCdload0:
                loadAuto(TR::Double, 0);
                _bcIndex += 1;
                break;
            case J9BCdload1:
                loadAuto(TR::Double, 1);
                _bcIndex += 1;
                break;
            case J9BCdload2:
                loadAuto(TR::Double, 2);
                _bcIndex += 1;
                break;
            case J9BCdload3:
                loadAuto(TR::Double, 3);
                _bcIndex += 1;
                break;
            ...
            case J9BCaload0:
                ...
                break;
            case J9BCaload1:
                loadAuto(TR::Address, 1);
                _bcIndex += 1;
                break;
            case J9BCaload2:
                loadAuto(TR::Address, 2);
                _bcIndex += 1;
                break;
            case J9BCaload3:
                loadAuto(TR::Address, 3);
                _bcIndex += 1;
                break;

            case J9BCiaload:
                loadArrayElement(TR::Int32);
                _bcIndex += 1;
                break;
            case J9BClaload:
                loadArrayElement(TR::Int64);
                _bcIndex += 1;
                break;
            case J9BCfaload:
                loadArrayElement(TR::Float);
                _bcIndex += 1;
                break;
            case J9BCdaload:
            ...
            case J9BCaaload:
                ...
                break;
            case J9BCbaload:
                loadArrayElement(TR::Int8);
                genUnary(TR::b2i);
                _bcIndex += 1;
                break;
            case J9BCcaload:
                loadArrayElement(TR::Int16);
                genUnary(TR::su2i);
                _bcIndex += 1;
                break;
            case J9BCsaload:
            ...
            case J9BCiloadw:
                loadAuto(TR::Int32, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BClloadw:
                loadAuto(TR::Int64, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCfloadw:
                loadAuto(TR::Float, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCdloadw:
                loadAuto(TR::Double, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCaloadw:
                loadAuto(TR::Address, next2Bytes());
                _bcIndex += 3;
                break;

            case J9BCbipush:
                loadConstant(TR::iconst, nextByteSigned());
                _bcIndex += 2;
                break;
            case J9BCsipush:
                loadConstant(TR::iconst, next2BytesSigned());
                _bcIndex += 3;
                break;

            case J9BCiload:
                loadAuto(TR::Int32, nextByte());
                _bcIndex += 2;
                break;
            case J9BClload:
                loadAuto(TR::Int64, nextByte());
                _bcIndex += 2;
                break;
            case J9BCfload:
                loadAuto(TR::Float, nextByte());
                _bcIndex += 2;
                break;
            case J9BCdload:
                loadAuto(TR::Double, nextByte());
                _bcIndex += 2;
                break;
            case J9BCaload:
                loadAuto(TR::Address, nextByte());
                _bcIndex += 2;
                break;

            case J9BCistore:
                storeAuto(TR::Int32, nextByte());
                _bcIndex += 2;
                break;
            case J9BClstore:
                storeAuto(TR::Int64, nextByte());
                _bcIndex += 2;
                break;
            case J9BCfstore:
                storeAuto(TR::Float, nextByte());
                _bcIndex += 2;
                break;
            case J9BCdstore:
                storeAuto(TR::Double, nextByte());
                _bcIndex += 2;
                break;
            case J9BCastore:
                storeAuto(TR::Address, nextByte());
                _bcIndex += 2;
                break;

            case J9BCistore0:
                storeAuto(TR::Int32, 0);
                _bcIndex += 1;
                break;
            case J9BCistore1:
                storeAuto(TR::Int32, 1);
                _bcIndex += 1;
                break;
            case J9BCistore2:
                storeAuto(TR::Int32, 2);
                _bcIndex += 1;
                break;
            case J9BCistore3:
                storeAuto(TR::Int32, 3);
                _bcIndex += 1;
                break;

            case J9BClstore0:
                storeAuto(TR::Int64, 0);
                _bcIndex += 1;
                break;
            case J9BClstore1:
                storeAuto(TR::Int64, 1);
                _bcIndex += 1;
                break;
            case J9BClstore2:
                storeAuto(TR::Int64, 2);
                _bcIndex += 1;
                break;
            case J9BClstore3:
                storeAuto(TR::Int64, 3);
                _bcIndex += 1;
                break;

            case J9BCfstore0:
                storeAuto(TR::Float, 0);
                _bcIndex += 1;
                break;
            case J9BCfstore1:
                storeAuto(TR::Float, 1);
                _bcIndex += 1;
                break;
            case J9BCfstore2:
                storeAuto(TR::Float, 2);
                _bcIndex += 1;
                break;
            case J9BCfstore3:
                storeAuto(TR::Float, 3);
                _bcIndex += 1;
                break;

            case J9BCdstore0:
                storeAuto(TR::Double, 0);
                _bcIndex += 1;
                break;
            case J9BCdstore1:
                storeAuto(TR::Double, 1);
                _bcIndex += 1;
                break;
            case J9BCdstore2:
                storeAuto(TR::Double, 2);
                _bcIndex += 1;
                break;
            case J9BCdstore3:
                storeAuto(TR::Double, 3);
                _bcIndex += 1;
                break;

            case J9BCastore0:
                storeAuto(TR::Address, 0);
                _bcIndex += 1;
                break;
            case J9BCastore1:
                storeAuto(TR::Address, 1);
                _bcIndex += 1;
                break;
            case J9BCastore2:
                storeAuto(TR::Address, 2);
                _bcIndex += 1;
                break;
            case J9BCastore3:
                storeAuto(TR::Address, 3);
                _bcIndex += 1;
                break;

            case J9BCiastore:
                storeArrayElement(TR::Int32);
                _bcIndex += 1;
                break;
            case J9BClastore:
                storeArrayElement(TR::Int64);
                _bcIndex += 1;
                break;
            case J9BCfastore:
                storeArrayElement(TR::Float);
                _bcIndex += 1;
                break;
            case J9BCdastore:
                ...
                break;
            case J9BCaastore:
                storeArrayElement(TR::Address);
                _bcIndex += 1;
                break;
            case J9BCbastore:
                genUnary(TR::i2b);
                storeArrayElement(TR::Int8);
                _bcIndex += 1;
                break;
            case J9BCcastore:
                genUnary(TR::i2s);
                storeArrayElement(TR::Int16);
                _bcIndex += 1;
                break;
            case J9BCsastore:
                genUnary(TR::i2s);
            ...
            case J9BCistorew:
                storeAuto(TR::Int32, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BClstorew:
                storeAuto(TR::Int64, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCfstorew:
                storeAuto(TR::Float, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCdstorew:
                storeAuto(TR::Double, next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCastorew:
                storeAuto(TR::Address, next2Bytes());
                _bcIndex += 3;
                break;
            ...
            case J9BCinvokevirtual:
                genInvokeVirtual(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCinvokespecial:
                genInvokeSpecial(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCinvokestatic:
                genInvokeStatic(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCinvokeinterface:
                genInvokeInterface(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCinvokedynamic:
                genInvokeDynamic(next2Bytes());
                _bcIndex += 3;
                break; // Could eventually need next3bytes
            ...
            case J9BCinvokespecialsplit:
                genInvokeSpecial(next2Bytes() | J9_SPECIAL_SPLIT_TABLE_INDEX_FLAG);
                _bcIndex += 3;
                break;
            case J9BCinvokestaticsplit:
                genInvokeStatic(next2Bytes() | J9_STATIC_SPLIT_TABLE_INDEX_FLAG);
                _bcIndex += 3;
                break;

            case J9BCifeq:
                _bcIndex = genIfOneOperand(TR::ificmpeq);
                break;
            case J9BCifne:
                _bcIndex = genIfOneOperand(TR::ificmpne);
                break;
            case J9BCiflt:
                _bcIndex = genIfOneOperand(TR::ificmplt);
                break;
            case J9BCifge:
                _bcIndex = genIfOneOperand(TR::ificmpge);
                break;
            case J9BCifgt:
                _bcIndex = genIfOneOperand(TR::ificmpgt);
                break;
            case J9BCifle:
                _bcIndex = genIfOneOperand(TR::ificmple);
                break;
            case J9BCifnull:
                _bcIndex = genIfOneOperand(TR::ifacmpeq);
                break;
            case J9BCifnonnull:
                _bcIndex = genIfOneOperand(TR::ifacmpne);
                break;

            case J9BCificmpeq:
                _bcIndex = genIfTwoOperand(TR::ificmpeq);
                break;
            case J9BCificmpne:
                _bcIndex = genIfTwoOperand(TR::ificmpne);
                break;
            case J9BCificmplt:
                _bcIndex = genIfTwoOperand(TR::ificmplt);
                break;
            case J9BCificmpge:
                _bcIndex = genIfTwoOperand(TR::ificmpge);
                break;
            case J9BCificmpgt:
                _bcIndex = genIfTwoOperand(TR::ificmpgt);
                break;
            case J9BCificmple:
                _bcIndex = genIfTwoOperand(TR::ificmple);
                break;
            case J9BCifacmpeq:
                _bcIndex = genIfAcmpEqNe(TR::ifacmpeq);
                break;
            case J9BCifacmpne:
                _bcIndex = genIfAcmpEqNe(TR::ifacmpne);
                break;

            case J9BClcmp:
                _bcIndex = cmp(TR::lcmp, _lcmpOps, lastIndex);
                break;
            case J9BCfcmpl:
                _bcIndex = cmp(TR::fcmpl, _fcmplOps, lastIndex);
                break;
            case J9BCfcmpg:
                _bcIndex = cmp(TR::fcmpg, _fcmpgOps, lastIndex);
                break;
            case J9BCdcmpl:
                _bcIndex = cmp(TR::dcmpl, _dcmplOps, lastIndex);
                break;
            case J9BCdcmpg:
                _bcIndex = cmp(TR::dcmpg, _dcmpgOps, lastIndex);
                break;

            case J9BCtableswitch:
                _bcIndex = genTableSwitch();
                break;
            case J9BClookupswitch:
                _bcIndex = genLookupSwitch();
                break;

            case J9BCgoto:
                _bcIndex = genGoto(_bcIndex + next2BytesSigned());
                break;
            case J9BCgotow:
                _bcIndex = genGoto(_bcIndex + next4BytesSigned());
                break;
            ...
            case J9BCgetstatic:
                loadStatic(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCgetfield:
                loadInstance(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCputstatic:
                storeStatic(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCputfield:
                storeInstance(next2Bytes());
                _bcIndex += 3;
                break;

            case J9BCcheckcast:
                genCheckCast(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCinstanceof:
                genInstanceof(next2Bytes());
                _bcIndex += 3;
                break;
            ...
            case J9BCnew:
                ...
                break;
            case J9BCnewarray:
                genNewArray(nextByte());
                _bcIndex += 2;
                break;
            case J9BCanewarray:
                genANewArray(next2Bytes());
                _bcIndex += 3;
                break;
            case J9BCmultianewarray:
                genMultiANewArray(next2Bytes(), _code[_bcIndex + 3]);
                _bcIndex += 4;
                break;
    ...
    for (i = firstIndex; block; lastBlock = block, block = nextBlock) {
        ...
        if (!nextBlock && lastRealNode->getOpCode().isIf()) {
            ...
            if (_blocksToInline) {
                if (!blocks(i + 3)) {
                    TR_ASSERT(_blocksToInline->hasGeneratedRestartTree(),
                        "Fall Thru Block doesn't exist and we don't have a restart tree.\n");
...
int32_t TR_J9ByteCodeIlGenerator::cmp(TR::ILOpCodes cmpOpcode, TR::ILOpCodes *combinedOpcodes, int32_t &lastIndex)
{
    ...
    switch (convertOpCodeToByteCodeEnum(nextOpcode)) {
        case J9BCifeq:
            combinedOpcode = combinedOpcodes[0];
            break;
        case J9BCifne:
            combinedOpcode = combinedOpcodes[1];
            break;
        case J9BCiflt:
            combinedOpcode = combinedOpcodes[2];
            break;
        case J9BCifge:
            combinedOpcode = combinedOpcodes[3];
            break;
        case J9BCifgt:
            combinedOpcode = combinedOpcodes[4];
            break;
        case J9BCifle:
            combinedOpcode = combinedOpcodes[5];
            break;
        default:
            combinedOpcode = TR::BadILOp;
            break;
    }
...
int32_t TR_J9ByteCodeIlGenerator::cmpFollowedByIf(uint8_t ifOpcode, TR::ILOpCodes combinedOpcode, int32_t &lastIndex)
{
...
TR::SymbolReference *TR_J9ByteCodeIlGenerator::placeholderWithDummySignature()
{
    ...
    logprintf(comp()->getOption(TR_TraceMethodIndex), comp()->log(),
        "placeholderWithDummySignature using owning symbol M%p _methodSymbol: M%p\n", comp()->getJittedMethodSymbol(),
        _methodSymbol);
    ...
    //
    return comp()->getSymRefTab()->methodSymRefFromName(comp()->getJittedMethodSymbol(), JSR292_ILGenMacros,
        JSR292_placeholder, JSR292_placeholderSig, TR::MethodSymbol::Static);
}

TR::SymbolReference *TR_J9ByteCodeIlGenerator::placeholderWithSignature(const char *prefix, int prefixLength,
    const char *middle, int middleLength, const char *suffix, int suffixLength)
{
    return symRefWithArtificialSignature(placeholderWithDummySignature(), ".#.#.#", prefix, prefixLength, middle,
        middleLength, suffix, suffixLength);
}

TR::SymbolReference *TR_J9ByteCodeIlGenerator::symRefWithArtificialSignature(TR::SymbolReference *original,
    const char *effectiveSigFormat, ...)
{
    TR::StackMemoryRegion stackMemoryRegion(*comp()->trMemory());
    ...
    TR::SymbolReference *result
        = comp()->getSymRefTab()->methodSymRefWithSignature(original, effectiveSig, strlen(effectiveSig));
...
void TR_J9ByteCodeIlGenerator::genArgPlaceholderCall()
{
    ...
    TR::SymbolReference *placeholderSymRef
        = placeholderWithSignature("(", 1, callerExpandedArgsStart, lengthOfExpandedArgs, ")I", 2);
...
static bool isPlaceholderCall(TR::Node *node)
{
    if (node->getOpCode().isCall() && node->getSymbol()->getResolvedMethodSymbol())
        return node->getSymbol()->castToResolvedMethodSymbol()->getMandatoryRecognizedMethod()
            == TR::java_lang_invoke_ILGenMacros_placeholder;
    else
        return false;
}

int32_t TR_J9ByteCodeIlGenerator::expandPlaceholderCall()
{
    ...
    logprintf(comp()->getOption(TR_TraceILGen), comp()->log(), "  Expanding placeholder call %s\n",
...
TR::SymbolReference *TR_J9ByteCodeIlGenerator::expandPlaceholderSignature(TR::SymbolReference *symRef, int32_t numArgs)
{
    return expandPlaceholderSignature(symRef, numArgs, numArgs);
}

TR::SymbolReference *TR_J9ByteCodeIlGenerator::expandPlaceholderSignature(TR::SymbolReference *symRef, int32_t numArgs,
    int32_t firstArgStackDepth)
{
    ...
    for (int32_t childIndex = originalMethod->isStatic() ? 0 : 1; childIndex < numArgs; childIndex++) {
        ...
        TR_ASSERT(signatureChars[currentArgSignatureOffset] != ')',
            "expandPlaceholderSignature must not walk past the end of the argument portion of the signature");

        TR::Node *child = _stack->element(firstArgStackOffset + childIndex);
        if (isPlaceholderCall(child)) {
            // Replace the current argument's signature chars with the chars between the parentheses of the child's
            // signature
            int32_t signatureLength = symRefMethod->signatureLength();
            char *childSignatureChars
                = child->getSymbol()->castToResolvedMethodSymbol()->getResolvedMethod()->signatureChars();
            int32_t numCharsInserted = strcspn(childSignatureChars + 1, ")");
            symRef = symRefWithArtificialSignature(symRef,
                ".#.#.#", // TODO:JSR292: It may be possible to simplify this logic drastically with a more clever
                          // format
                signatureChars, currentArgSignatureOffset, childSignatureChars + 1, numCharsInserted,
...
int32_t TR_J9ByteCodeIlGenerator::numPlaceholderCalls(int32_t depthLimit)
{
    int32_t result = 0;
...
int32_t TR_J9ByteCodeIlGenerator::expandPlaceholderCalls(int32_t depthLimit)
{
    if (depthLimit <= 0) {
        return 0;
    } else {
...
TR::Node *TR_J9ByteCodeIlGenerator::genNodeAndPopChildren(TR::ILOpCodes opcode, int32_t numChildren,
    TR::SymbolReference *symRef, int32_t firstIndex, int32_t lastIndex)
{
...
TR::Node *TR_J9ByteCodeIlGenerator::genNodeAndPopChildren(TR::ILOpCodes opcode, int32_t numChildren,
    TR::SymbolReference *symRef, int32_t firstIndex)
{
    return genNodeAndPopChildren(opcode, numChildren, symRef, firstIndex, numChildren - 1);
}

void TR_J9ByteCodeIlGenerator::genUnary(TR::ILOpCodes unaryOp, bool isForArrayAccess)
{
    TR::Node *node = TR::Node::create(unaryOp, 1, pop());
    if (isForArrayAccess) {
        logprints(comp()->getOption(TR_TraceILGen), comp()->log(),
            "setting i2l node %p n%dn non-negative because it's for array access\n");
        node->setIsNonNegative(true);
    }
    push(node);
}

bool TR_J9ByteCodeIlGenerator::swapChildren(TR::ILOpCodes nodeop, TR::Node *firstChild)
{
...
void TR_J9ByteCodeIlGenerator::genBinary(TR::ILOpCodes nodeop, int32_t numChildren)
{
    TR::Node *second = pop();
    TR::Node *first = pop();
...
TR::TreeTop *TR_J9ByteCodeIlGenerator::genTreeTop(TR::Node *n)
{
    OMR::Logger *log = comp()->log();
    ...
    bool isExceptionOnlyPoint
        = comp()->getOSRMode() == TR::involuntaryOSR && !n->canGCandReturn(comp()) && n->canGCandExcept();
    logprintf(trace, log, "skip saving PPS for exceptionOnlyPoints %d node n%dn\n", isExceptionOnlyPoint,
        n->getGlobalIndex());

    // It is not necessary to save the stack under OSR if the bytecode index or caller has been marked as
    // cannotAttemptOSR
    ...
    if (trace && cannotAttemptOSR)
        log->printf("skip saving PPS for cannotAttemptOSR at %d:%d node n%dn\n", n->getByteCodeIndex(),
            n->getByteCodeInfo().getCallerIndex(), n->getGlobalIndex());
    ...
    if (!comp()->isPeekingMethod() && comp()->isPotentialOSRPoint(n) && !isExceptionOnlyPoint && !cannotAttemptOSR) {
        ...
        static int32_t osrTotalPPSThresh
            = (OSRTotalPPSThreshold = feGetEnv("TR_OSRTotalPPSThreshold")) ? atoi(OSRTotalPPSThreshold) : 0;

        static const char *OSRPPSThresholdOutsideLoops;
        static int32_t osrPPSThreshOutsideLoops
            = (OSRPPSThresholdOutsideLoops = feGetEnv("TR_OSRPPSThresholdOutsideLoops"))
            ? atoi(OSRPPSThresholdOutsideLoops)
            : 0;
        static const char *OSRTotalPPSThresholdOutsideLoops;
        static int32_t osrTotalPPSThreshOutsideLoops
            = (OSRTotalPPSThresholdOutsideLoops = feGetEnv("TR_OSRTotalPPSThresholdOutsideLoops"))
            ? atoi(OSRTotalPPSThresholdOutsideLoops)
            : 0;

        static const char *OSRLoopNestingThreshold;
        static int32_t osrLoopNestingThresh
            = (OSRLoopNestingThreshold = feGetEnv("TR_OSRLoopNestingThreshold")) ? atoi(OSRLoopNestingThreshold) : 1;

        static const char *OSRIndirectCallBCThreshold;
        static int32_t osrIndirectCallBCThresh
            = (OSRIndirectCallBCThreshold = feGetEnv("TR_OSRIndirectCallBCThreshold"))
            ? atoi(OSRIndirectCallBCThreshold)
            : 0;

        bool OSRTooExpensive = false;
        if ((n->getNumChildren() > 0) && !comp()->getOption(TR_EnableOSROnGuardFailure)
            && comp()->getHCRMode() != TR::osr &&

            (((comp()->getNumLoopNestingLevels() == 0)
                 && ((((int32_t)_stack->size()) > osrPPSThreshOutsideLoops) || true
                     || ((((int32_t)_stack->size() + (int32_t)comp()->getNumLivePendingPushSlots()))
                         > osrTotalPPSThreshOutsideLoops)))
                ||
                ...
                (n->getFirstChild()->getOpCode().isCallIndirect()
                    && (n->getFirstChild()->getSymbolReference()->isUnresolved() || true
                        || // turned OSR off for indirect calls for 727 due to failed guards being seen
                        n->getFirstChild()
                            ->getSymbol()
                            ->castToResolvedMethodSymbol()
                            ->getResolvedMethod()
                            ->virtualMethodIsOverridden()
                        || comp()->getPersistentInfo()->isClassLoadingPhase()
                        || (comp()->getOption(TR_EnableHCR)
                            && (!n->getFirstChild()->getSecondChild()->getOpCode().isLoadVarDirect()
                                || !n->getFirstChild()->getSecondChild()->getSymbol()->isParm()))
                        || (n->getFirstChild()
                                ->getSymbol()
                                ->castToResolvedMethodSymbol()
                                ->getResolvedMethod()
                                ->maxBytecodeIndex()
                            > osrIndirectCallBCThresh))))) {
            OSRTooExpensive = true;
            if (n->getFirstChild()->getOpCode().isCall() && !comp()->getOption(TR_FullSpeedDebug)
                && comp()->getOption(TR_EnableOSR)) {
                logprintf(trace, log, "Skipping OSR due to cost at bci %d.%d\n", comp()->getCurrentInlinedSiteIndex(),
                    n->getFirstChild()->getByteCodeIndex());
        ...
        if ((comp()->getOption(TR_MimicInterpreterFrameShape) || comp()->getOption(TR_FullSpeedDebug)
                || comp()->getHCRMode() == TR::osr
                || ((n->getNumChildren() > 0) && n->getFirstChild()->getOpCode().isCall() && !OSRTooExpensive
                    && comp()->getOption(TR_EnableOSR)))
            ...
            if (comp()->isOSRTransitionTarget(TR::postExecutionOSR)) {
                ...
                if ((n->getOpCode().isCheck() || n->getOpCodeValue() == TR::treetop)
                    && n->getFirstChild()->getOpCode().isCall()) {
                    ...
                    if (!_processedOSRNodes->contains(n->getFirstChild())) {
                        ...
                        logprintf(trace, log, "Skipping OSR stack state for repeated call n%dn in treetop n%dn\n",
...
void TR_J9ByteCodeIlGenerator::removeIfNotOnStack(TR::Node *n)
{
...
void TR_J9ByteCodeIlGenerator::popAndDiscard(int n)
{
...
void TR_J9ByteCodeIlGenerator::discardEntireStack()
{
    startCountingStackRefs();
...
void TR_J9ByteCodeIlGenerator::startCountingStackRefs()
{
    for (int i = 0; i < _stack->size(); i++)
        _stack->element(i)->incReferenceCount();
}

void TR_J9ByteCodeIlGenerator::stopCountingStackRefs()
{
    for (int i = 0; i < _stack->size(); i++)
...
//
void TR_J9ByteCodeIlGenerator::saveStack(int32_t targetIndex) { saveStack(targetIndex, false); }

void TR_J9ByteCodeIlGenerator::saveStack(int32_t targetIndex, bool anchorLoads)
{
    if (_stack->isEmpty())
        return;
    ...
    bool loadPP
        = !disallowOSRPPS2 && comp()->getOption(TR_EnableOSR) && !comp()->isOSRTransitionTarget(TR::postExecutionOSR);
    ...
    //    slot: The pending push slot, which must take into account the number of slots required by each node on the
    //    stack i: Index into _stack
    //
    int32_t slot = 0;
    tempIndex = 0;
    for (i = 0; i < _stack->size(); ++i) {
        ...
        if (!isPlaceholderCall(n)) {
            TR::SymbolReference *symRef
                = symRefTab()->findOrCreatePendingPushTemporary(_methodSymbol, slot, getDataType(n));
            if (_stackTemps.topIndex() < tempIndex || _stackTemps[tempIndex] != n) {
                ...
                // slots on the stack are replaced by loads of these temps. This ensures the pending push temp appears
                // live across any OSR points, due to the use of the load when it is popped off the stack.
                //
                if (loadPP) {
            ...
            // Under postExecutionOSR, the stack elements are saved to pending push slots but the corresponding slots on
            // the stack are not modified. Instead, calls to saveStack where anchorLoads is true will achieve the same
            // effect for liveness by generating anchored loads of any pending push slots that have not been modified.
            // There will be several superfluous loads, but they can be cleaned up in genILOpts once the OSR liveness
            // analysis is complete.
            //
            else if (anchorLoads && comp()->getOption(TR_EnableOSR)
                && comp()->isOSRTransitionTarget(TR::postExecutionOSR) && _stackTemps[tempIndex] == n
            ...
            for (int32_t j = 0; j < n->getNumChildren(); ++j) {
                ...
                TR::SymbolReference *symRef
                    = symRefTab()->findOrCreatePendingPushTemporary(_methodSymbol, slot, getDataType(child));
                if (_stackTemps.topIndex() < tempIndex || _stackTemps[tempIndex] != child) {
                    ...
                    && comp()->isOSRTransitionTarget(TR::postExecutionOSR) && _stackTemps[tempIndex] == child
            ...
            // all conditions
            TR_ASSERT_FATAL(!createTargetStack,
                "Cannot store and later load placeholder calls in current implementation");
        }
    }
}
...
//
void TR_J9ByteCodeIlGenerator::handlePendingPushSaveSideEffects(TR::Node *n, int32_t stackSize)
{
    if (_stack->size() == 0)
        return;
...
void TR_J9ByteCodeIlGenerator::handlePendingPushSaveSideEffects(TR::Node *n, TR::NodeChecklist &checklist,
    int32_t stackSize)
{
    ...
    //
    if (n->getOpCode().isLoadVarDirect() && n->getSymbolReference()->isTemporary(comp())
        && n->getSymbolReference()->getCPIndex() < 0) {
        ...
        //
        if (modifiedSlot == loadSlot && (stackSize == -1 || stackSize > absStackSlot) && i < _stack->size()
...
bool TR_J9ByteCodeIlGenerator::isAtBBStart(int32_t bcIndex)
{
 ...
 */
void TR_J9ByteCodeIlGenerator::stashArgumentsForOSR(TR_J9ByteCode byteCode)
{
    if (!_couldOSRAtNextBC && !isAtBBStart(_bcIndex)) // _couldOSRAtNextBC doesn't work if the curent bc is at bbstart,
                                                      // conversatively assume OSR transition can happen at bbstart
        return;
    _couldOSRAtNextBC = false;

    if (comp()->isPeekingMethod() || !comp()->getOption(TR_EnableOSR) || _cannotAttemptOSR
    ...
    switch (byteCode) {
        ...
        case J9BCinvokehandlegeneric:
            ...
            break;
        case J9BCinvokestaticsplit:
            symRef = symRefTab()->findOrCreateStaticMethodSymbol(_methodSymbol,
                next2Bytes() | J9_STATIC_SPLIT_TABLE_INDEX_FLAG);
            break;
        case J9BCinvokespecialsplit:
            symRef = symRefTab()->findOrCreateSpecialMethodSymbol(_methodSymbol,
                next2Bytes() | J9_SPECIAL_SPLIT_TABLE_INDEX_FLAG);
            break;
        default:
            return;
    }
    ...
    if (byteCode == J9BCinvokedynamic || byteCode == J9BCinvokehandle) {
        ...
        logprintf(trace(), comp()->log(),
            "Original num args for invokedynamic/handle: %d, num args to not stash for OSR: %d, stack size: %d\n",
    ...
    TR_OSRMethodData *osrMethodData = comp()->getOSRCompilationData()->findOrCreateOSRMethodData(
        comp()->getCurrentInlinedSiteIndex(), _methodSymbol);
...
void TR_J9ByteCodeIlGenerator::stashPendingPushLivenessForOSR(int32_t offset)
{
...
void TR_J9ByteCodeIlGenerator::handleSideEffect(TR::Node *sideEffect)
{
    // if any tree on the stack can be modified by the sideEffect then the node
    // on the stack must become a treetop before the sideEffect node is evaluated
    //
...
bool TR_J9ByteCodeIlGenerator::valueMayBeModified(TR::Node *sideEffect, TR::Node *node)
{
 ...
 * - for inlining/peeking: ilgen.abort/unresolved/{bytecodeName}/{refType}/({method signature})/bc={bcIndex}/root=({top
 ...
 */
void TR_J9ByteCodeIlGenerator::abortForUnresolvedValueTypeOp(const char *bytecodeName, const char *refType)
{
    const int32_t bcIndex = currentByteCodeIndex();
    if (isOutermostMethod()) {
        TR::DebugCounter::incStaticDebugCounter(comp(),
            TR::DebugCounter::debugCounterName(comp(), "ilgen.abort/unresolved/%s/%s/(%s)/bc=%d", bytecodeName, refType,
                comp()->signature(), bcIndex));
    } else {
        TR::DebugCounter::incStaticDebugCounter(comp(),
            TR::DebugCounter::debugCounterName(comp(), "ilgen.abort/unresolved/%s/%s/(%s)/bc=%d/root=(%s)",
                bytecodeName, refType, _method->signature(comp()->trMemory()), bcIndex, comp()->signature()));
    }

    comp()->failCompilation<TR::UnsupportedValueTypeOperation>("Unresolved %s encountered for %s bytecode instruction",
        refType, bytecodeName);
}

//----------------------------------------------
// gen array
//----------------------------------------------
void TR_J9ByteCodeIlGenerator::genArrayLength(bool contiguous)
{
    TR::Node *node = NULL;
    TR::Node *topNode = pop();
...
void TR_J9ByteCodeIlGenerator::genArrayBoundsCheck(TR::Node *offset, int32_t width)
{
    ...
    if (_classInfo) {
        ...
        TR_PersistentFieldInfo *fieldInfo
            = _classInfo->getFieldInfo() ? _classInfo->getFieldInfo()->findFieldInfo(comp(), baseArray, true) : NULL;
        if (fieldInfo) {
            ...
            if (arrayFieldInfo && arrayFieldInfo->isDimensionInfoValid()
                ...
                if (!TR::Compiler->om.useHybridArraylets()
                    ...
                    if (performTransformation(comp(),
                            "O^O CLASS LOOKAHEAD: Can skip array length calculation for array %p based on class file "
                            "examination\n",
                            baseArray))
                ...
                if (performTransformation(comp(),
                        "O^O CLASS LOOKAHEAD: Can skip null check for array %p based on class file examination\n",
                        baseArray))
                    canSkipThisNullCheck = true;

                if (offset->getOpCode().isLoadConst() && offset->getDataType() == TR::Int32
                    && offset->getInt() < firstDimension && offset->getInt() >= 0
                    && (!TR::Compiler->om.useHybridArraylets()
                        || !TR::Compiler->om.isDiscontiguousArray(firstDimension, width))) {
                    if (performTransformation(comp(),
                            "O^O CLASS LOOKAHEAD: Can skip bound check for access %p using array %p which has length "
                            "%d based on class file examination\n",
...
void TR_J9ByteCodeIlGenerator::calculateElementAddressInContiguousArray(int32_t width, int32_t headerSize)
{
    const bool isForArrayAccess = true;
    int32_t shift = TR::TransformUtil::convertWidthToShift(width);
    if (shift) {
        logprints(trace(), comp()->log(), "shift > 0 (i.e., is true)\n");
...
void TR_J9ByteCodeIlGenerator::calculateElementAddressInContiguousArrayUsingDataAddrField(int32_t width)
{
    TR_ASSERT(fej9()->isOffHeapAllocationEnabled(),
        "calculateElementAddressInContiguousArrayUsingDataAddrField should only be called when OffHeap is enabled");
...
// width is the width of each array element in bytes
// headerSize is the number of header bytes at the beginning of the array
void TR_J9ByteCodeIlGenerator::calculateIndexFromOffsetInContiguousArray(int32_t width, int32_t headerSize)
{
    if (comp()->target().is64Bit()) {
        if (headerSize > 0) {
            loadConstant(TR::lconst, (int64_t)headerSize);
...
//       then the arraylet
void TR_J9ByteCodeIlGenerator::calculateArrayElementAddress(TR::DataType dataType, bool checks)
{
...
void TR_J9ByteCodeIlGenerator::genAsyncCheck()
{
    // Create an asyncCheck tree and insert it at the start of the current block
    //

    TR::Node *node
        = TR::Node::createWithSymRef(TR::asynccheck, 0, symRefTab()->findOrCreateAsyncCheckSymbolRef(_methodSymbol));
 ...
 */
void TR_J9ByteCodeIlGenerator::genCheckCast()
{
    ...
    TR::Node *node
        = genNodeAndPopChildren(TR::checkcast, 2, symRefTab()->findOrCreateCheckCastSymbolRef(_methodSymbol));
    genTreeTop(node);
 ...
 */
void TR_J9ByteCodeIlGenerator::genCheckCast(int32_t cpIndex)
{
    loadClassObjectForTypeTest(cpIndex, TR_DisableAOTCheckCastInlining);
    genCheckCast();
}

void TR_J9ByteCodeIlGenerator::genDivCheck()
{
    if (!_methodSymbol->skipDivChecks()) {
        if (!cg()->getSupportsDivCheck())
            _unimplementedOpcode = _code[_bcIndex];
        genTreeTop(TR::Node::createWithSymRef(TR::DIVCHK, 1, 1, _stack->top(),
            symRefTab()->findOrCreateDivCheckSymbolRef(_methodSymbol)));
    }
}
...
//
void TR_J9ByteCodeIlGenerator::genIDiv()
{
...
void TR_J9ByteCodeIlGenerator::genLDiv()
{
...
void TR_J9ByteCodeIlGenerator::genIRem()
{
    if (cg()->getSupportsIDivAndIRemWithThreeChildren()) {
        genBinary(TR::irem, 3);
...
void TR_J9ByteCodeIlGenerator::genLRem()
{
    if (cg()->getSupportsLDivAndLRemWithThreeChildren()) {
        genBinary(TR::lrem, 3);
        TR::Node *rem = _stack->top();
 ...
 */
void TR_J9ByteCodeIlGenerator::genInstanceof(int32_t cpIndex)
{
    TR::SymbolReference *classSymRef = loadClassObjectForTypeTest(cpIndex, TR_DisableAOTInstanceOfInlining);
    TR::Node *node
        = genNodeAndPopChildren(TR:: instanceof, 2, symRefTab()->findOrCreateInstanceOfSymbolRef(_methodSymbol));
    push(node);
...
TR::Node *TR_J9ByteCodeIlGenerator::genCompressedRefs(TR::Node *address, bool genTT, int32_t isLoad)
{
    ...
    logprintf(trace(), comp()->log(), "IlGenerator: Generating compressedRefs anchor [%p] for node [%p]\n", newAddress,
        address);
...
TR::Node *TR_J9ByteCodeIlGenerator::genNullCheck(TR::Node *first)
{
    ...
    if (!_methodSymbol->skipNullChecks()) {
        ...
        if (!c && grandChild->getOpCode().hasSymbolReference() && grandChild->getSymbolReference()
            && grandChild->getSymbolReference()->getSymbol()
            && grandChild->getSymbolReference()->getSymbol()->getRecognizedField()
                == TR::Symbol::Java_lang_String_value) {
            logprintf(trace(), comp()->log(), "Skipping NULLCHK (node %p) on String.value field : %s -> %s\n",
                grandChild, comp()->signature(), _methodSymbol->signature(trMemory()));
        } else {
            return TR::Node::createWithSymRef(TR::NULLCHK, 1, 1, first,
...
TR::Node *TR_J9ByteCodeIlGenerator::genResolveCheck(TR::Node *first)
{
    return TR::Node::createWithSymRef(TR::ResolveCHK, 1, 1, first,
        symRefTab()->findOrCreateResolveCheckSymbolRef(_methodSymbol));
}

TR::Node *TR_J9ByteCodeIlGenerator::genResolveAndNullCheck(TR::Node *first)
{
    TR_ASSERT(first->getNumChildren() >= 1, "no grandchild to nullcheck?");
    TR::Node *grandChild = first->getChild(0);
    return TR::Node::createWithSymRef(TR::ResolveAndNULLCHK, 1, 1, first,
        symRefTab()->findOrCreateNullCheckSymbolRef(_methodSymbol));
}
...
int32_t TR_J9ByteCodeIlGenerator::genGoto(int32_t target)
{
    if (_blocksToInline) // partial inlining - only generate goto if its in the list of blocks.
    {
        bool success = false;
        ...
        TR_ASSERT(success,
            " Walker: genGoto for a partial inline has no target in the list of blocks to be inlined.\n");
    } else {
        if (_blocks[target]->getEntry()->getNode()->getByteCodeIndex()
            <= _block->getEntry()->getNode()->getByteCodeIndex())
            genAsyncCheck();
 ...
 */
int32_t TR_J9ByteCodeIlGenerator::genIfOneOperand(TR::ILOpCodes nodeop)
{
 ...
 *     The index of the next bytecode to generate.
 */
int32_t TR_J9ByteCodeIlGenerator::genIfTwoOperand(TR::ILOpCodes nodeop)
{
    int32_t branchBC = _bcIndex + next2BytesSigned();
 ...
 *     The index of the next bytecode to generate.
 */
int32_t TR_J9ByteCodeIlGenerator::genIfAcmpEqNe(TR::ILOpCodes ifacmpOp)
{
    ...
    TR::Node *substitutabilityTest = TR::Node::createWithSymRef(TR::icall, 2, 2, lhs, rhs, comparisonNonHelper);
...
//
int32_t TR_J9ByteCodeIlGenerator::genIfImpl(TR::ILOpCodes nodeop)
{
    int32_t branchBC = _bcIndex + next2BytesSigned();
    ...
    if (!disableIfFolding && !comp()->getOption(TR_EnableOSR) && branchBC > _bcIndex && first->getOpCode().isLoadConst()
        && second->getOpCode().isLoadConst() && type != TR::Address && type != TR::Float && type != TR::Double) {
        ...
        if (_blocksToInline) {
            logprints(trace, log, "Not folding the if because of partial inlining\n");
        } else {
    ...
    if (_blocksToInline) {
        ...
        if (genFallThru && genBranchBC) {
            ...
            if (swapChildren(nodeop, first)) {
                TR::TreeTop *tt = genTreeTop(TR::Node::createif(TR::ILOpCode(nodeop).getOpCodeForSwapChildren(), second,
            ...
            if (genFallThru) {
                ...
                branchDestination = _blocksToInline->hasGeneratedRestartTree()
                    ? _blocksToInline->getGeneratedRestartTree()
                    : _blocksToInline->setGeneratedRestartTree(genPartialInliningCallBack(branchBC,
                          _blocksToInline->getCallNodeTreeTop())); // not adding it to the queue
            ...
            if (genBranchBC) {
                _blocksToInline->hasGeneratedRestartTree()
                    ? genGotoPartialInliningCallBack(fallThruBC, _blocksToInline->getGeneratedRestartTree())
                    : _blocksToInline->setGeneratedRestartTree(
                          genPartialInliningCallBack(fallThruBC, _blocksToInline->getCallNodeTreeTop()));
        ...
        TR::TreeTop *branchDestination = genTarget(branchBC);
        if (swapChildren(nodeop, first)) {
            TR::TreeTop *tt = genTreeTop(
                TR::Node::createif(TR::ILOpCode(nodeop).getOpCodeForSwapChildren(), second, first, branchDestination));
            tt->getNode()->setSwappedChildren(true);
        } else
            genTreeTop(TR::Node::createif(nodeop, first, second, branchDestination));
...
void TR_J9ByteCodeIlGenerator::genInc()
{
...
void TR_J9ByteCodeIlGenerator::genIncLong()
{
...
void TR_J9ByteCodeIlGenerator::genInvokeStatic(int32_t cpIndex)
{
    OMR::Logger *log = comp()->log();
    bool trace = comp()->getOption(TR_TraceILGen);
    TR::SymbolReference *methodSymRef = symRefTab()->findOrCreateStaticMethodSymbol(_methodSymbol, cpIndex);

    logprintf(trace, log, "  genInvokeStatic(%d) // %s\n", cpIndex, comp()->getDebug()->getName(methodSymRef));

    if (runMacro(methodSymRef)) {
        if (comp()->compileRelocatableCode()) {
            logprintf(trace, log, "  ILGen macro %s not supported in AOT.  Aborting compile.\n",
        ...
        if (comp()->getOption(TR_FullSpeedDebug) && !isPeekingMethod()) {
            logprintf(trace, log, "  ILGen macro %s not supported in FSD. Failing ilgen\n",
                comp()->getDebug()->getName(methodSymRef));
            comp()->failCompilation<J9::FSDHasInvokeHandle>("An ILGen macro not supported in FSD.  Failing ilgen.");
        }

        logprintf(trace, log, "  Finished macro %s\n", comp()->getDebug()->getName(methodSymRef));
        return;
    }
    ...
    if (callNode && _methodSymbol->safeToSkipChecksOnArrayCopies()) {
        ...
        if (callNode->getOpCode().hasSymbolReference() && !callNode->getSymbolReference()->isUnresolved()) {
            TR::RecognizedMethod recognizedMethod
                = callNode->getSymbol()->castToResolvedMethodSymbol()->getRecognizedMethod();
...
void TR_J9ByteCodeIlGenerator::genInvokeSpecial(int32_t cpIndex)
{
    OMR::Logger *log = comp()->log();
    ...
    if (skipInvokeSpecialInterfaceTypeChecks()) {
        logprints(trace, log, "invokespecial type tests disabled by env var\n");
        return;
    }
    ...
    if (!_invokeSpecialSeen) {
        ...
        TR_OpaqueClassBlock * const defClass = fej9()->getHostClass(_method->containingClass());
        ...
        if (trace) {
            ...
            log->printf("within interface %p %.*s for the purpose of invokespecial\n", _invokeSpecialInterface, len,
                name);
        }
    }

    if (_invokeSpecialInterface == NULL) {
        logprints(trace, log, "no invokespecial type tests in this method\n");
        return;
    }

    TR::Method *callee = methodSymRef->getSymbol()->castToMethodSymbol()->getMethod();
    if (callee->isConstructor()) {
        logprints(trace, log, "no invokespecial type test for constructor\n");
        return;
    }

    if (callee->isFinalInObject()) {
        logprints(trace, log, "invokespecial of final Object method is really invokevirtual\n");
        return;
    }
    ...
    if (comp()->compileRelocatableCode()) {
        if (isOutermostMethod()) {
            TR::DebugCounter::incStaticDebugCounter(comp(),
                TR::DebugCounter::debugCounterName(comp(), "ilgen.abort/aot-invokespecial-interface/root/(%s)/bc=%d",
                    comp()->signature(), bcIndex));
        } else {
            TR::DebugCounter::incStaticDebugCounter(comp(),
                TR::DebugCounter::debugCounterName(comp(),
                    "ilgen.abort/aot-invokespecial-interface/inline/(%s)/bc=%d/root=(%s)",
                    _method->signature(comp()->trMemory()), bcIndex, comp()->signature()));
        }

        comp()->failCompilation<J9::AOTHasInvokeSpecialInInterface>("COMPILATION_AOT_HAS_INVOKESPECIAL_IN_INTERFACE");
    }
    ...
    {
        _invokeSpecialInterfaceCalls = new (trHeapMemory()) TR_BitVector(_maxByteCodeIndex + 1, trMemory());
    }

    _invokeSpecialInterfaceCalls->set(bcIndex);
    logprintf(trace, log, "request invokespecial type test at bc index %d\n", bcIndex);
}

void TR_J9ByteCodeIlGenerator::genInvokeVirtual(int32_t cpIndex)
{
    auto owningMethod = (TR_ResolvedJ9Method *)_methodSymbol->getResolvedMethod();
    bool unresolvedInCP;
    TR_ResolvedMethod *method = owningMethod->getResolvedPossiblyPrivateVirtualMethod(comp(), cpIndex,
        /* ignoreRtResolve = */ false, &unresolvedInCP);

    TR::SymbolReference *symRef = NULL;
    if (method != NULL && method->isPrivate()) {
        _methodSymbol->setMayHaveInlineableCall(true);
        symRef = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(), cpIndex, method,
    ...
    if (method != NULL) {
        isDirectCall = symRef->getSymbol()->isFinal() || method->isPrivate()
...
void TR_J9ByteCodeIlGenerator::genInvokeInterface(int32_t cpIndex)
{
    auto owningMethod = (TR_ResolvedJ9Method *)_methodSymbol->getResolvedMethod();
    TR_ResolvedMethod *improperMethod = owningMethod->getResolvedImproperInterfaceMethod(comp(), cpIndex);
    if (improperMethod == NULL) {
        ...
        if (improperMethod->isPrivate() || improperMethod->convertToMethod()->isFinalInObject()) {
            TR::SymbolReference *symRef = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(),
                cpIndex, improperMethod, TR::MethodSymbol::Special,
                /* isUnresolvedInCP = */ false);

            callNode = genInvokeDirect(symRef);
        } else {
            TR::SymbolReference *symRef = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(),
                cpIndex, improperMethod, TR::MethodSymbol::Virtual,
                /* isUnresolvedInCP = */ false);
        ...
        TR::SymbolReference *icce = symRefTab()->findOrCreateIncompatibleClassChangeErrorSymbolRef(_methodSymbol);

        TR::Node *check = TR::Node::createWithSymRef(TR::ZEROCHK, 1, 1, instanceof, icce);
        ...
        if (instanceOfTT && instanceOfTT->getNode()->getOpCodeValue() == TR::treetop
                && instanceOfTT->getNode()->getFirstChild() && instanceOfTT->getNode()->getFirstChild() == instanceof) {
            ...
            logprintf(comp()->getOption(TR_TraceILGen), comp()->log(),
                "%s: move the anchored instanceof n%dn before ZEROCHK n%dn\n", __FUNCTION__,
                instanceOfTT->getNode()->getGlobalIndex(), zeroCHKTT->getNode()->getGlobalIndex());
        }
    }
}
...
void TR_J9ByteCodeIlGenerator::genInvokeDynamic(int32_t callSiteIndex)
{
    if (comp()->getOption(TR_FullSpeedDebug) && !isPeekingMethod())
        comp()->failCompilation<J9::FSDHasInvokeHandle>("FSD_HAS_INVOKEHANDLE 0");
#if defined(J9VM_OPT_OPENJDK_METHODHANDLE)
    if (comp()->compileRelocatableCode()
        && (!comp()->getOption(TR_EnableMHRelocatableCompile) || !comp()->getOption(TR_UseSymbolValidationManager))) {
    ...
    TR::SymbolReference *callSiteTableEntrySymRef
        = symRefTab()->findOrCreateCallSiteTableEntrySymbol(_methodSymbol, callSiteIndex);
    ...
    /* We need to get the expected number of parameters from the signature. There is a case where
     * findOrCreateDynamicMethodSymbol() returns an error-throwing MethodHandle that takes 0 arguments (occurs when an
     * error is caught during resolveInvokeDynamic()). We cannot use TR::Method::numberOfExplicitParameters() since that
     * fetches the number of parameters of targetMethodSymRefs (the MH actually returned) instead of what's expected for
     * the invokedynamic call. This can be a problem since the expected number of args are already on the stack and
     * won't be popped properly.
     */
    ...
    if (!owningMethod->isUnresolvedCallSiteTableEntry(callSiteIndex)) {
        TR_ResolvedMethod *specimen = fej9()->createMethodHandleArchetypeSpecimen(trMemory(),
            (uintptr_t *)owningMethod->callSiteTableEntryAddress(callSiteIndex), owningMethod);
        if (specimen)
            symRef = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(), -1, specimen,
                TR::MethodSymbol::ComputedVirtual);
    }
...
TR::Node *TR_J9ByteCodeIlGenerator::genInvokeHandle(int32_t cpIndex)
{
    if (comp()->getOption(TR_FullSpeedDebug) && !isPeekingMethod())
    ...
    // treetop
    //    call
    //    java/lang/invoke/MethodHandle.linkToStatic(Ljava/lang/Object;arg0arg1...Ljava/lang/Object;Ljava/lang/Object;)<return
    //    type>
    //       aload  <Ljava/lang/invoke/MethodHandle;>
    //       arg0
    //       arg1
...
TR::Node *TR_J9ByteCodeIlGenerator::genInvokeHandle(TR::SymbolReference *invokeExactSymRef,
    ...
    if (!isPeekingMethod()) {
        if (!comp()->getHasMethodHandleInvoke()) {
            ...
            if (comp()->getOptions()->getVerboseOption(TR_VerboseMethodHandles))
                TR_VerboseLog::writeLineLocked(TR_Vlog_MH, "Jitted method contains MethodHandle invoke: %s",
                    comp()->signature());
        }
        if (comp()->getOptions()->getVerboseOption(TR_VerboseMethodHandleDetails)) {
            ...
            TR_VerboseLog::writeLineLocked(TR_Vlog_MHD, "Call to invokeExact%.*s from %s", callee->signatureLength(),
                callee->signatureChars(), comp()->signature());
        }
    }
...
#if defined(J9VM_OPT_OPENJDK_METHODHANDLE)
void TR_J9ByteCodeIlGenerator::loadInvokeCacheArrayElements(TR::SymbolReference *tableEntrySymRef,
    uintptr_t *invokeCacheArray, bool isUnresolved)
{
    ...
    if (isUnresolved) {
        ...
        TR::SymbolReference *appendixSymRef = comp()->getSymRefTab()->findOrCreateSymRefWithKnownObject(
...
TR::Node *TR_J9ByteCodeIlGenerator::genILGenMacroInvokeExact(TR::SymbolReference *invokeExactSymRef)
{
    TR_ASSERT(!comp()->compileRelocatableCode(), "Does not support ILGenMacro under AOT bci %d", _bcIndex);
    TR_ASSERT(!comp()->getOption(TR_FullSpeedDebug) || isPeekingMethod(),
        "Does not support ILGenMacro under FSD bci %d", _bcIndex);
    TR::Node *callNode = genInvokeHandle(invokeExactSymRef);
...
TR::Node *TR_J9ByteCodeIlGenerator::genHandleTypeCheck(TR::Node *handle, TR::Node *expectedType)
{
    uint32_t typeOffset = fej9()->getInstanceFieldOffsetIncludingHeader("Ljava/lang/invoke/MethodHandle;", "type",
        "Ljava/lang/invoke/MethodType;", method());
    TR::SymbolReference *typeSymRef = comp()->getSymRefTab()->findOrFabricateShadowSymbol(_methodSymbol,
        TR::Symbol::Java_lang_invoke_MethodHandle_type, TR::Address, typeOffset, false, false, true,
    ...
    logprintf(comp()->getOption(TR_TraceILGen), comp()->log(), "Inserted indirect load of MethodHandle.type n%dn %p\n",
        handleType->getGlobalIndex(), handleType);

    // Generate zerochk
    TR::Node *zerochkNode
        = TR::Node::createWithSymRef(TR::ZEROCHK, 1, 1, TR::Node::create(TR::acmpeq, 2, expectedType, handleType),
            symRefTab()->findOrCreateMethodTypeCheckSymbolRef(_methodSymbol));
    return zerochkNode;
}

TR::Node *TR_J9ByteCodeIlGenerator::genInvokeHandleGeneric(int32_t cpIndex)
{
    if (comp()->compileRelocatableCode()) {
    ...
    TR::SymbolReference *invokeExactOriginal
        = symRefTab()->methodSymRefFromName(_methodSymbol, JSR292_MethodHandle, JSR292_invokeExact,
            JSR292_invokeExactSig, TR::MethodSymbol::ComputedVirtual, invokeGenericSymRef->getCPIndex());
    TR::SymbolReference *invokeExactSymRef = symRefTab()->methodSymRefWithSignature(invokeExactOriginal,
        invokeGeneric->signatureChars(), invokeGeneric->signatureLength());
...
TR::Node *TR_J9ByteCodeIlGenerator::genOrFindAdjunct(TR::Node *node)
{
    TR::Node *adjunct;
...
{
    printf("[%s] shift:%d, ajdust:%d, length:%d\n", tags ? tags : "OP", op->shiftDistance, op->offsetAdjustment,
        op->lengthNew);
}
...
static struct OperationDescriptor opsLength7[] = {
    ...
    {  0, 0, 1 },
    {  8, 1, 2 },
    { 24, 3, 4 }  // little-endian
};
static struct OperationDescriptor *opsNonStandardLengths[]
    = { 0, 0, 0, opsLength3, 0, opsLength5, opsLength6, opsLength7 };
static int32_t numOpsNonStandardLengths[] = { 0, 0, 0, 2, 0, 2, 2, 3 };

TR::Node *TR_J9ByteCodeIlGenerator::getReceiverFor(TR::SymbolReference *symRef)
{
...
TR::Node *TR_J9ByteCodeIlGenerator::genInvokeWithVFTChild(TR::SymbolReference *symRef)
{
 ...
 */
static TR::SymbolReference *getPrimitiveValueFieldSymbolReference(TR_J9ByteCodeIlGenerator *generator,
    TR::RecognizedMethod method)
{
    ...
    TR_OpaqueClassBlock *fieldClass
        = generator->fej9()->getClassFromSignature(className, strlen(className), generator->method());
...
TR::Node *TR_J9ByteCodeIlGenerator::genInvoke(TR::SymbolReference *symRef, TR::Node *indirectCallFirstChild,
    TR::Node *invokedynamicReceiver, int32_t numExpectedArgs)
{
    TR::KnownObjectTable::Index requiredKoi;
    TR::Node *callNode
        = genInvokeInner(symRef, indirectCallFirstChild, invokedynamicReceiver, &requiredKoi, numExpectedArgs);

    if (requiredKoi == TR::KnownObjectTable::UNKNOWN)
        return callNode;

    TR_ASSERT_FATAL(callNode != NULL, "required constant at bc index %d (invoke*): missing call node", _bcIndex);
...
TR::Node *TR_J9ByteCodeIlGenerator::genInvokeInner(TR::SymbolReference *symRef, TR::Node *indirectCallFirstChild,
    TR::Node *invokedynamicReceiver, TR::KnownObjectTable::Index *requiredKoi, int32_t numExpectedArgs)
{
    OMR::Logger *log = comp()->log();
...
#define DAA_PRINT(a)                                   \
    ...
    if (comp()->cg()->getSupportsInlineConcurrentLinkedQueue()
        && (TR::Compiler->om.writeBarrierType() != gc_modron_wrtbar_satb)
    ...
    if (!isStatic && _classInfo && !symRef->isUnresolved()) {
        ...
        TR::Node *thisObject
            = invokedynamicReceiver ? invokedynamicReceiver : _stack->element(_stack->topIndex() - (numArgs - 1));
        TR_PersistentFieldInfo *fieldInfo
            = _classInfo->getFieldInfo() ? _classInfo->getFieldInfo()->findFieldInfo(comp(), thisObject, false) : NULL;
        if (fieldInfo && fieldInfo->isTypeInfoValid()) {
            if (fieldInfo->getNumChars() == len && !memcmp(s, fieldInfo->getClassPointer(), len)) {
                if (performTransformation(comp(),
                        "O^O CLASS LOOKAHEAD: Devirtualizing call to method %s on receiver object %p which has type "
                        "%.*s based on class file examination\n",
                        calledMethod->signature(trMemory()), thisObject, len, s))
                    isDirectCall = true;
            }
        } else if (fieldInfo && fieldInfo->isBigDecimalType()) {
        ...
        } else if (fieldInfo && fieldInfo->isBigIntegerType()) {
    ...
    if (isDirectCall) {
        ...
        if (resolvedMethodSymbol) {
            if (resolvedMethodSymbol->getRecognizedMethod() == TR::java_lang_Class_newInstanceImpl
                && // the method being called
                _methodSymbol->getRecognizedMethod() == TR::java_lang_Class_newInstance
                && // method we are doing genIl for
                comp()->getJittedMethodSymbol()->getRecognizedMethod() != TR::java_lang_Class_newInstance
                && // method we are compiling
                !isPeekingMethod() && cg()->getSupportsNewInstanceImplOpt()
                && !comp()->getOption(TR_DisableInliningOfNatives) && !comp()->compileRelocatableCode()
                && // disable when AOTing
            ...
            == 0) // might not be resolved
    {
        ...
        if (comp()->getOptLevel() < scorching && !comp()->getOptimizationPlan()->getDontFailOnPurpose()) {
    ...
    if (callNode && callNode->getOpCode().hasSymbolReference() && !callNode->getSymbolReference()->isUnresolved()
        ...
        && !strncmp(_methodSymbol->getResolvedMethod()->signatureChars(), ORB_CALLER_METHOD_SIG,
            ORB_CALLER_METHOD_SIG_LEN)) {
        logprintf(traceILGen, log, "handling callNode %p, current method %s\n", callNode,
            _methodSymbol->getResolvedMethod()->signature(trMemory()));
        TR::Node *receiver = callNode->getFirstArgument();
        if (receiver && receiver->getOpCode().hasSymbolReference() && receiver->getSymbol()->isParm()
            && !receiver->isThisPointer() && (calledMethod->nameLength() == ORB_CALLEE_METHOD_NAME_LEN)
            ...
            logprintf(traceILGen, log, "called method %s, containing class %p\n", calledMethod->signature(trMemory()),
                cl);

            bool isClassInitialized = false;
            TR_PersistentClassInfo *classInfo
                = comp()->getPersistentInfo()->getPersistentCHTable()->findClassInfoAfterLocking(cl, comp());
            if (classInfo && classInfo->isInitialized())
                isClassInitialized = true;

            logprintf(traceILGen, log, "isClassInitialized = %d\n", isClassInitialized);

            if (isClassInitialized) {
                TR_OpaqueClassBlock *orbClass = fej9()->getClassFromSignature(ORB_REPLACE_CLASS_NAME,
                    ORB_REPLACE_CLASS_LEN, callNode->getSymbol()->castToResolvedMethodSymbol()->getResolvedMethod());

                logprintf(traceILGen, log, "orbClass = %p, orbClassLoader %s systemClassLoader\n", orbClass,
                    (!fej9()->isClassLoadedBySystemClassLoader(cl)) ? "!=" : "==");
                ...
                if (orbClass && !fej9()->isClassLoadedBySystemClassLoader(cl)) {
                    ...
                    if (replacementMethod) {
                        if (performTransformation(comp(),
                                "O^O ORB OPTIMIZATION : changing ObjectInputStream.readObject call to ORB "
                                "redirectedReadObject\n")) {
                            TR::Node *clazzLoad = TR::Node::createWithSymRef(TR::loadaddr, 0,
                                symRefTab()->findOrCreateClassSymbol(_methodSymbol, 0, cl));
                            TR::Node *jlClazzLoad = TR::Node::createWithSymRef(TR::aloadi, 1, 1, clazzLoad,
                                symRefTab()->findOrCreateJavaLangClassFromClassSymbolRef());

                            push(receiver);
                            push(jlClazzLoad);
                            TR::SymbolReference *symRef
                                = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(), -1,
                                    replacementMethod, TR::MethodSymbol::Static);
    ...
    logprintf(traceILGen, log, "considering callNode %p for java serialization optimization\n", callNode);
    if (canDoSerializationOpt && callNode && callNode->getOpCode().hasSymbolReference()
        && !callNode->getSymbolReference()->isUnresolved() && callNode->getOpCode().isCallDirect()) {
        logprintf(traceILGen, log, "looking at receiver sig for callNode %p\n", callNode);
        TR::Node *receiver = callNode->getFirstArgument();
        if (receiver && receiver->getOpCode().hasSymbolReference()) {
            ...
            logprintf(traceILGen, log, "handling callNode %p, receiver class name %s\n", callNode, receiverSig);
            if (receiverSig != NULL && (receiverLen == JAVA_SERIAL_CLASS_NAME_LEN)
                ...
                if ((calledMethod->nameLength() == JAVA_SERIAL_CALLEE_METHOD_NAME_LEN)
                    && !strncmp(calledMethod->nameChars(), JAVA_SERIAL_CALLEE_METHOD_NAME,
                        JAVA_SERIAL_CALLEE_METHOD_NAME_LEN)
                    && (calledMethod->signatureLength() == JAVA_SERIAL_CALLEE_METHOD_SIG_LEN)
                    && !strncmp(calledMethod->signatureChars(), JAVA_SERIAL_CALLEE_METHOD_SIG,
                        JAVA_SERIAL_CALLEE_METHOD_SIG_LEN)) {
                    TR_OpaqueClassBlock *cl = _methodSymbol->getResolvedMethod()->containingClass();
                    ...
                    logprintf(traceILGen, log, "isClassInitialized = %d\n", isClassInitialized);
                    if (isClassInitialized) {
                        TR_OpaqueClassBlock *serialClass = fej9()->getClassFromSignature(JAVA_SERIAL_REPLACE_CLASS_NAME,
                            JAVA_SERIAL_REPLACE_CLASS_LEN,
                            callNode->getSymbol()->castToResolvedMethodSymbol()->getResolvedMethod());
                        ...
                        if (serialClass && !fej9()->isClassLoadedBySystemClassLoader(cl)) {
                            ...
                            if (replacementMethod) {
                                if (performTransformation(comp(),
                                        ...
                                        "call to ObjectInputStream redirectedReadObject\n")) {
                                    TR::Node *clazzLoad = TR::Node::createWithSymRef(TR::loadaddr, 0,
                                        symRefTab()->findOrCreateClassSymbol(_methodSymbol, 0, cl));
                                    TR::Node *jlClazzLoad = TR::Node::createWithSymRef(TR::aloadi, 1, clazzLoad, 0,
                                        symRefTab()->findOrCreateJavaLangClassFromClassSymbolRef());
                                    push(receiver);
                                    push(jlClazzLoad);
                                    TR::SymbolReference *symRef
                                        = symRefTab()->findOrCreateMethodSymbol(_methodSymbol->getResolvedMethodIndex(),
                                            -1, replacementMethod, TR::MethodSymbol::Static);
                                    callNode = genNodeAndPopChildren(replacementMethod->directCallOpCode(), 2, symRef);
                                    isStatic = true;
                                    callNode->getChild(0)->recursivelyDecReferenceCount();
                                }
    ...
    if (callNodeTreeTop && comp()->getOption(TR_EnableOSR) && !comp()->isPeekingMethod()
        && comp()->isOSRTransitionTarget(TR::postExecutionOSR)
        && comp()->isPotentialOSRPoint(callNodeTreeTop->getNode())
        && !_methodSymbol->cannotAttemptOSRAt(callNode->getByteCodeInfo(), NULL, comp()) && !_cannotAttemptOSR) {
    ...
    if (resolvedMethodSymbol && !isPeekingMethod()
        ...
        TR::Node *vftLoad
            = TR::Node::createWithSymRef(callNode, TR::aloadi, 1, obj, symRefTab()->findOrCreateVftSymbolRef());
        ...
        callNode = resultNode;
    } else if (resolvedMethodSymbol && !isPeekingMethod()
        ...
        TR::Node *j9Class = TR::Node::createWithSymRef(callNode, TR::aloadi, 1, jlClass,
            symRefTab()->findOrCreateClassFromJavaLangClassSymbolRef());

        if (comp()->target().is32Bit()) {
            resultNode = TR::Node::createWithSymRef(callNode, TR::iloadi, 1, j9Class,
                symRefTab()->findOrCreateInitializeStatusFromClassSymbolRef());
        } else {
            resultNode = TR::Node::createWithSymRef(callNode, TR::lloadi, 1, j9Class,
                symRefTab()->findOrCreateInitializeStatusFromClassSymbolRef());
    ...
    if ((numExpectedArgs > 0) && (numPopped < numExpectedArgs)) {
        logprints(traceILGen, log, "InvokeDynamic received error throwing MethodHandle. Popping extra args.\n");
    ...
    if (needOSRBookkeeping) {
        ...
        if (comp()->supportsInduceOSR() && comp()->getOSRMode() == TR::voluntaryOSR) {
            TR::Node *callToPotentialOSRPoint
                = TR::Node::createPotentialOSRPointHelperCallInILGen(callNodeTreeTop->getNode(), osrInductionOffset);
            _block->append(TR::TreeTop::create(comp(), TR::Node::create(TR::treetop, 1, callToPotentialOSRPoint)));
        }
    }

    // We disable this optimization for JITServer because TR_VMField is not supported on JITServer yet. Once we have
    // decided how to build the data structures required by this optimization efficiently, we can re-enable this
    // optimization.
    if (cg()->getEnforceStoreOrder() && calledMethod->isConstructor()) {
        ...
        if (resolvedMethodSymbol
            ...
            if ((len == 22 && !strncmp(className, "java/lang/StringBuffer", 22))
                ...
                logprintf(traceILGen, log, "added post-init fence for recognized class %s\n", className);
                fenceRequired = true;
            } else {
                ...
                TR_VMFieldsInfo *fieldsInfoByIndex
                    = new (comp()->trStackMemory()) TR_VMFieldsInfo(comp(), methodClass, 1, stackAlloc);
                ...
                for (TR_VMField *field = fieldIter.getFirst(); field; field = fieldIter.getNext()) {
                    if ((field->modifiers & J9AccFinal)
                        && methodClass
                            == jitGetDeclaringClassOfROMField(comp()->j9VMThread(), methodClass, field->shape)) {
                        logprintf(traceILGen, log, "added fence due to final field %s \n", field->name);
                        fenceRequired = true;
                        break;
                    }
                }
...
void TR_J9ByteCodeIlGenerator::chopPlaceholder(TR::Node *placeholder, int32_t firstChild, int32_t numChildren)
{
    ...
    placeholder->setSymbolReference(symRefWithArtificialSignature(placeholder->getSymbolReference(), "(.-).$",
        callSignature, firstChild, firstChild + numChildren - 1, callSignature));
}

bool TR_J9ByteCodeIlGenerator::runMacro(TR::SymbolReference *symRef)
{
    TR::MethodSymbol *symbol = symRef->getSymbol()->castToMethodSymbol();
    ...
    TR_ASSERT(symbol->isStatic(),
        "Macro methods must be static or else signature processing gets complicated by the implicit receiver");
    ...
    switch (recognizedMethod) {
        ...
        case TR::java_lang_invoke_ILGenMacros_rawNew: {
            if (!comp()->compileRelocatableCode()) {
                push(TR::Node::createWithSymRef(TR::aloadi, 1, 1, pop(),
                    symRefTab()->findOrCreateClassFromJavaLangClassSymbolRef()));
            ...
            if (!comp()->compileRelocatableCode()) {
                ...
                TR::SymbolReference *invokeExactWithSig
                    = symRefWithArtificialSignature(invokeExact, "(.*).$", invokeExactMacro->signatureChars(),
                        1, // skip explicit MethodHandle argument -- invokeExact has it as a receiver
        ...
        case TR::java_lang_invoke_ILGenMacros_arrayElements: {
            if (!comp()->compileRelocatableCode()) {
                ...
                char *macroSignature
                    = argPlaceholder->getSymbol()->castToResolvedMethodSymbol()->getResolvedMethod()->signatureChars();
                ...
                //
                TR::Node *placeholder = genNodeAndPopChildren(TR::icall, numElements,
                    symRefWithArtificialSignature(placeholderWithDummySignature(), "(.?)I", expandedArgsSignature));
...
void TR_J9ByteCodeIlGenerator::loadAuto(TR::DataType type, int32_t slot, bool isAdjunct)
{
    ...
    TR::Node *load = TR::Node::createLoad(
        symRefTab()->findOrCreateAutoSymbol(_methodSymbol, slot, type, true, false, true, isAdjunct));
...
void TR_J9ByteCodeIlGenerator::loadInstance(TR::SymbolReference *symRef)
{
    ...
    TR::ILOpCodes op = _generateReadBarriersForFieldWatch ? comp()->il.opCodeForIndirectReadBarrier(type)
                                                          : comp()->il.opCodeForIndirectLoad(type);
    ...
    if (!disableFinalFieldFoldingInILGen && !disableInstanceFinalFieldFoldingInILGen
        && address->getOpCode().hasSymbolReference() && address->getSymbolReference()->hasKnownObjectIndex()
        && address->isNonNull()) {
        TR::Node *nodeToRemove = NULL;
        if (TR::TransformUtil::transformIndirectLoadChain(comp(), dummyLoad, address,
                address->getSymbolReference()->getKnownObjectIndex(), &nodeToRemove)
            && nodeToRemove) {
...
static char *getTopLevelPrefixForFlattenedFields(TR_ResolvedJ9Method *owningMethod, int32_t cpIndex, int32_t &prefixLen,
    TR::Region &region)
{
    int32_t len;
...
void TR_J9ByteCodeIlGenerator::loadFlattenableInstance(int32_t cpIndex)
{
    ...
    int32_t prefixLen = 0;
    char *fieldNamePrefix = getTopLevelPrefixForFlattenedFields(owningMethod, cpIndex, prefixLen,
        comp()->trMemory()->currentStackRegion());

    TR_OpaqueClassBlock *containingClass
        = owningMethod->definingClassFromCPFieldRef(comp(), cpIndex, _methodSymbol->isStatic());
    ...
    TR::Node *newValueNode = genNodeAndPopChildren(TR::newvalue, flattenedFieldCount + 1,
        symRefTab()->findOrCreateNewValueSymbolRef(_methodSymbol));
...
void TR_J9ByteCodeIlGenerator::loadStatic(int32_t cpIndex)
{
    if (_generateReadBarriersForFieldWatch && comp()->compileRelocatableCode())
        comp()->failCompilation<J9::AOTNoSupportForAOTFailure>("NO support for AOT in field watch");
    ...
    logprintf(comp()->getOption(TR_TraceILGen), comp()->log(),
        "load static symref %d created with knownObjectIndex %d\n", symRef->getReferenceNumber(),
    ...
    if (_generateReadBarriersForFieldWatch) {
        ...
        loadSymbol(TR::loadaddr,
            symRefTab()->findOrCreateClassSymbol(_methodSymbol, cpIndex, staticClass, true /* cpIndexOfStatic */));
...
TR::Node *TR_J9ByteCodeIlGenerator::loadSymbol(TR::ILOpCodes loadop, TR::SymbolReference *symRef)
{
...
void TR_J9ByteCodeIlGenerator::loadClassObject(int32_t cpIndex)
{
 ...
 */
TR::SymbolReference *TR_J9ByteCodeIlGenerator::loadClassObjectForTypeTest(int32_t cpIndex,
    TR_CompilationOptions aotInhibit)
{
...
void TR_J9ByteCodeIlGenerator::loadClassObject(TR_OpaqueClassBlock *opaqueClass)
{
    loadSymbol(TR::loadaddr, symRefTab()->findOrCreateClassSymbol(_methodSymbol, 0, opaqueClass));
}

void TR_J9ByteCodeIlGenerator::loadClassObjectAndIndirect(int32_t cpIndex)
{
    void *classObject = method()->getClassFromConstantPool(comp(), cpIndex);
    loadSymbol(TR::loadaddr, symRefTab()->findOrCreateClassSymbol(_methodSymbol, cpIndex, classObject));
    TR::Node *node = pop();
...
void TR_J9ByteCodeIlGenerator::loadConstant(TR::ILOpCodes loadop, int32_t constant)
{
    push(TR::Node::create(loadop, 0, constant));
}

void TR_J9ByteCodeIlGenerator::loadConstant(TR::ILOpCodes loadop, int64_t constant)
{
...
void TR_J9ByteCodeIlGenerator::loadConstant(TR::ILOpCodes loadop, float constant)
{
    TR::Node *node = TR::Node::create(loadop, 0);
...
void TR_J9ByteCodeIlGenerator::loadConstant(TR::ILOpCodes loadop, double constant)
{
    TR::Node *node = TR::Node::create(loadop, 0);
...
void TR_J9ByteCodeIlGenerator::loadConstant(TR::ILOpCodes loadop, void *constant)
{
    TR::Node *node = TR::Node::create(loadop, 0);
...
void TR_J9ByteCodeIlGenerator::loadFromCP(TR::DataType type, int32_t cpIndex)
{
    OMR::Logger *log = comp()->log();
    bool trace = comp()->getOption(TR_TraceILGen);
    ...
    switch (type) {
        case TR::Int32:
            loadConstant(TR::iconst, (int32_t)method()->intConstant(cpIndex));
            break;
        case TR::Int64:
            loadConstant(TR::lconst, (int64_t)method()->longConstant(cpIndex));
            break;
        case TR::Float:
            if (!floatInCP)
        ...
        case TR::Address:
            if (method()->isConstantDynamic(cpIndex)) {
                if (comp()->compileRelocatableCode()) {
                    logprints(trace, log, "  Constant Dynamic not supported in AOT.\n");
                ...
                J9UTF8 *returnTypeUtf8
                    = (J9UTF8 *)_methodSymbol->getResolvedMethod()->getConstantDynamicTypeFromCP(cpIndex);
                ...
                if (!isCondyPrimitive && !isCondyUnresolved) {
                    ...
                    uintptr_t obj = 0;
                    uintptr_t *objLocation
                        = (uintptr_t *)_methodSymbol->getResolvedMethod()->dynamicConstant(cpIndex, &obj);
                    if (obj == 0) {
                        loadConstant(TR::aconst, (void *)0);
                        return;
                    }
                ...
                if (isCondyPrimitive) {
                    ...
                    switch (returnTypeUtf8Data[0]) {
                        case 'I':
                            ...
                            typeClassBlock = comp()->fej9()->getClassFromSignature(autoboxClassSig,
                                autoboxClassSigLength, method());
                    ...
                    if (!isCondyUnresolved) {
                        ...
                        if (primitiveCondyCriticalSection.hasVMAccess()) {
                            ...
                            uintptr_t *objLocation
                                = (uintptr_t *)_methodSymbol->getResolvedMethod()->dynamicConstant(cpIndex, &obj);
                            TR_ASSERT(obj,
                                "Resolved primitive Constant Dynamic-type CP entry %d must have autobox object",
                                cpIndex);
                            switch (returnTypeUtf8Data[0]) {
                                case 'I':
                                case 'Z':
                ...
                TR::Node *loadObjNode = loadSymbol(TR::aload,
                    symRefTab()->findOrCreateConstantDynamicSymbol(_methodSymbol, cpIndex, symbolTypeSig,
                        symbolTypeSigLength, isCondyPrimitive));
                ...
                if (isCondyPrimitive) {
                    ...
                    TR::SymbolReference *valueSymRef = comp()->getSymRefTab()->findOrFabricateShadowSymbol(
                        _methodSymbol, valueRecogField, dt, valueOffset, false, true, true, recogFieldName);
                    TR::Node *primitiveValueNode
                        = TR::Node::createWithSymRef(comp()->il.opCodeForIndirectLoad(dt), 1, 1, pop(), valueSymRef);
                ...
                if (comp()->compileRelocatableCode()) {
                    logprints(trace, log, "  Method Handle Constant not supported in AOT.\n");
                    comp()->failCompilation<J9::AOTHasMethodHandleConstant>(
                        "Method Handle Constant not supported in AOT.");
                }
                loadSymbol(TR::aload, symRefTab()->findOrCreateMethodHandleSymbol(_methodSymbol, cpIndex));
            } else {
                TR_ASSERT(method()->isMethodTypeConstant(cpIndex),
                    "Address-type CP entry %d must be class, string, methodHandle, or methodType", cpIndex);
                if (comp()->compileRelocatableCode()) {
                    logprints(trace, log, "  Method Type Constant not supported in AOT.\n");
...
void TR_J9ByteCodeIlGenerator::loadFromCallSiteTable(int32_t callSiteIndex)
{
...
void TR_J9ByteCodeIlGenerator::loadArrayElement(TR::DataType dataType, TR::ILOpCodes nodeop, bool checks,
    bool mayBeValueType)
{
    ...
    if (mayBeValueType && TR::Compiler->om.isValueTypeArrayFlatteningEnabled()
        ...
        auto *helperCallNode
            = TR::Node::createWithSymRef(TR::acall, 2, 2, elementIndex, arrayBaseAddress, helperSymRef);
...
void TR_J9ByteCodeIlGenerator::loadMonitorArg()
{
...
void TR_J9ByteCodeIlGenerator::genMonitorEnter()
{
    ...
    // We need to keep all synchronized objects on the stack.  We'll create meta data that represents each locked object
    // at each gc point so that the VM can figure out which objects are locked on the stack at any given gc point code
    // moved below, so that the store happens after the monent
    /*
    if (node->getOpCodeValue() != TR::aload || !comp()->getOption(TR_DisableLiveMonitorMetadata))
     ...
     comp()->addMonitorAuto(tempSymRef->getSymbol()->castToRegisterMappedSymbol(),
    comp()->getCurrentInlinedSiteIndex());
     }
    ...
    */
    ...
    if (disableMonentIdentityException || !TR::Compiler->om.areValueTypesEnabled()) {
        ...
        TR::SymbolReference *isIdentitySymRef
            = comp()->getSymRefTab()->findOrCreateIsIdentityObjectNonHelperSymbolRef();
        TR::Node *isIdentityObjectTestNode = TR::Node::createWithSymRef(TR::icall, 1, 1, node, isIdentitySymRef);
        TR::SymbolReference *identityExceptionSymRef
            = comp()->getSymRefTab()->findOrCreateIdentityExceptionSymbolRef(_methodSymbol);
...
void TR_J9ByteCodeIlGenerator::genMonitorExit(bool isReturn)
{
...
void TR_J9ByteCodeIlGenerator::genNew(int32_t cpIndex)
{
    loadClassObject(cpIndex);
    genNew();
}

void TR_J9ByteCodeIlGenerator::genNew(TR::ILOpCodes opCode)
{
    TR::Node *node
        = TR::Node::createWithSymRef(opCode, 1, 1, pop(), symRefTab()->findOrCreateNewObjectSymbolRef(_methodSymbol));
    _methodSymbol->setHasNews(true);
    genTreeTop(node);
    push(node);

    bool skipFlush = false;
    if (!node->getFirstChild()->getSymbolReference()->isUnresolved()
        && node->getFirstChild()->getSymbol()->isStatic()) {
        TR_OpaqueClassBlock *clazz
            = (TR_OpaqueClassBlock *)node->getFirstChild()->getSymbol()->castToStaticSymbol()->getStaticAddress();
        ...
        if (((len == 16) && strncmp(sig, "Ljava/lang/Long;", 16) == 0)
            ...
            || ((len == 68)
                && strncmp(sig, "Ljava/util/concurrent/locks/ReentrantReadWriteLock$Sync$HoldCounter;", 68) == 0)
            ...
            // The JIT removes checks for the following classes, therefore we need a post-init flush to ensure fields
            // are non-null. The <init> for these classes do not allow the 'this' to escape so we can skip the pre-init
            // flush.
            ((len == 24) && strncmp(sig, "Ljava/lang/StringBuffer;", 24) == 0)
            || ((len == 25) && strncmp(sig, "Ljava/lang/StringBuilder;", 25) == 0)) {
            logprintf(comp()->getOption(TR_TraceILGen), comp()->log(),
                "skipping pre-init fence for recognized class %s\n", sig);
            skipFlush = true;
        }
    }
...
static TR::SymbolReference *createLoadFieldSymRef(TR::Compilation *comp, TR_OpaqueClassBlock *fieldClass,
    const char *fieldname, bool nullIfNotFound)
{
    ...
    for (size_t idx = 0; idx < fieldClassFieldCount; idx++) {
        ...
        if (!strcmp(fieldname, fieldEntry._fieldname)) {
            auto *fieldSymRef = comp->getSymRefTab()->findOrFabricateShadowSymbol(fieldClass, fieldEntry._datatype,
                fieldEntry._offset, fieldEntry._isVolatile, fieldEntry._isPrivate, fieldEntry._isFinal,
                fieldEntry._fieldname, fieldEntry._typeSignature);
            return fieldSymRef;
        }
    }

    TR_ASSERT_FATAL(nullIfNotFound, "Did not find the matching fieldname %s", fieldname);
...
static bool isCallChainFromStringBuilderToStringToArraysCopyOfRange(TR::Compilation *comp)
{
    ...
    if (comp->getInlinedResolvedMethodSymbol(callerIndex)->getRecognizedMethod()
        != TR::java_util_Arrays_copyOfRange_byte)
        return false;
    ...
    callerIndex = comp->getInlinedCallSite(callerIndex)._byteCodeInfo.getCallerIndex();
    if (comp->getInlinedResolvedMethodSymbol(callerIndex)->getRecognizedMethod()
        != TR::java_lang_String_init_StringBuilder)
        return false;

    callerIndex = comp->getInlinedCallSite(callerIndex)._byteCodeInfo.getCallerIndex();
    TR::ResolvedMethodSymbol *caller = callerIndex > -1 ? comp->getInlinedResolvedMethodSymbol(callerIndex)
                                                        : comp->getOptimizer()->getMethodSymbol();
...
void TR_J9ByteCodeIlGenerator::genNewArray(int32_t typeIndex)
{
    loadConstant(TR::iconst, typeIndex);

    TR::Node *secondChild = pop();
    TR::Node *firstChild = pop();
    TR::Node *node = TR::Node::createWithSymRef(TR::newarray, 2, 2, firstChild, secondChild,
        symRefTab()->findOrCreateNewArraySymbolRef(_methodSymbol));
    ...
    if (!comp()->isOutermostMethod() && !comp()->isPeekingMethod() && !generateArraylets
        && _methodSymbol->getRecognizedMethod() == TR::java_util_Arrays_copyOf_byte) {
        int32_t callerIndex = comp()->getCurrentInlinedCallSite()->_byteCodeInfo.getCallerIndex();
        TR::ResolvedMethodSymbol *caller
    ...
    // The call chain is: StringBuilder.toString() -> String<init>(StringBuilder) -> String<init>(AbstractStringBuilder,
    // Void)
    ...
    if (!comp()->getOption(TR_DisableSeparateInitFromAlloc) && !node->canSkipZeroInitialization() && !generateArraylets
        && separateInitializationFromAllocation && comp()->cg()->getSupportsArraySet()) {
        node->setCanSkipZeroInitialization(true);
        ...
        TR::Node *sizeInBytes
            = TR::TransformUtil::generateConvertArrayElementIndexToOffsetTrees(comp(), sizeNode, NULL, elementSize);
...
void TR_J9ByteCodeIlGenerator::genANewArray(int32_t cpIndex)
{
    loadClassObject(cpIndex);
    genANewArray();
}

void TR_J9ByteCodeIlGenerator::genANewArray()
{
    TR::Node *secondChild = pop();
    TR::Node *firstChild = pop();
    TR::Node *node = TR::Node::createWithSymRef(TR::anewarray, 2, 2, firstChild, secondChild,
        symRefTab()->findOrCreateANewArraySymbolRef(_methodSymbol));
    _methodSymbol->setHasNews(true);
    genTreeTop(node);
    push(node);
    genFlush(0);
...
void TR_J9ByteCodeIlGenerator::genMultiANewArray(int32_t cpIndex, int32_t dims)
{
...
void TR_J9ByteCodeIlGenerator::genMultiANewArray(int32_t dims)
{
    // total number of params is 2+#dims
    //
    TR::Node *node = genNodeAndPopChildren(TR::multianewarray, dims + 2,
        symRefTab()->findOrCreateMultiANewArraySymbolRef(_methodSymbol), 1);
...
int32_t TR_J9ByteCodeIlGenerator::genReturn(TR::ILOpCodes nodeop, bool monitorExit)
{
    if (!comp()->isPeekingMethod() && (_methodSymbol->getMandatoryRecognizedMethod() == TR::java_lang_Object_init)) {
        ...
        TR::SymbolReference *finalizeSymRef
            = comp()->getSymRefTab()->findOrCreateRuntimeHelper(TR_jitCheckIfFinalizeObject, true, true, true);
    ...
    if ((fej9()->isMethodTracingEnabled(_methodSymbol->getResolvedMethod()->getPersistentIdentifier())
            || (!comp()->getOption(TR_FullSpeedDebug) && TR::Compiler->vm.canMethodExitEventBeHooked(comp())))
        ...
        if (nodeop == TR::Return) {
            ...
            methodExitNode = TR::Node::createWithSymRef(TR::MethodExitHook, 1, 1,
                TR::Node::createWithSymRef(TR::loadaddr, 0, tempSymRef), methodExitSymRef);
        }
    ...
    if (comp()->getOption(TR_EnableThisLiveRangeExtension)) {
        if (!_methodSymbol->isStatic()
            ...
            TR::SymbolReference *tempSymRef
                = symRefTab()->findOrCreateThisRangeExtensionSymRef(comp()->getMethodSymbol());
...
{
    if (!fieldInfo || !fieldInfo->isNotRead())
        return false;
    ...
    if (node->getOpCode().isCall() && !node->getSymbolReference()->isUnresolved()) {
        if (fieldInfo->isBigDecimalType()) {
            if ((node->getSymbol()->getResolvedMethodSymbol()->getRecognizedMethod() == TR::java_math_BigDecimal_add)
                || (node->getSymbol()->getResolvedMethodSymbol()->getRecognizedMethod()
        ...
        if (fieldInfo->isBigIntegerType()) {
            if ((node->getSymbol()->getResolvedMethodSymbol()->getRecognizedMethod() == TR::java_math_BigInteger_add)
                || (node->getSymbol()->getResolvedMethodSymbol()->getRecognizedMethod()
                    == TR::java_math_BigInteger_subtract)
                || (node->getSymbol()->getResolvedMethodSymbol()->getRecognizedMethod()
                    == TR::java_math_BigInteger_multiply))
                return true;
        }
    }
...
// gen store
//----------------------------------------------
void TR_J9ByteCodeIlGenerator::storeInstance(int32_t cpIndex)
{
...
TR::Node *TR_J9ByteCodeIlGenerator::narrowIntStoreIfRequired(TR::Node *value, TR::SymbolReference *symRef)
{
    TR::DataType type = symRef->getSymbol()->getDataType();
...
void TR_J9ByteCodeIlGenerator::storeInstance(TR::SymbolReference *symRef)
{
    TR::Symbol *symbol = symRef->getSymbol();
    TR::DataType type = symbol->getDataType();
    ...
    if ((type == TR::Address && _generateWriteBarriersForGC) || _generateWriteBarriersForFieldWatch) {
        node = TR::Node::createWithSymRef(comp()->il.opCodeForIndirectWriteBarrier(type), 3, 3, addressNode, value,
            parentObject, symRef);
    } else {
        if (type.isIntegral())
    ...
    if (symbol->isPrivate() && _classInfo && comp()->getNeedsClassLookahead()) {
        ...
        TR_PersistentFieldInfo *fieldInfo
            = _classInfo->getFieldInfo() ? _classInfo->getFieldInfo()->findFieldInfo(comp(), node, true) : NULL;
        if (storeCanBeRemovedForUnreadField(fieldInfo, value)
            && performTransformation(comp(),
                "O^O CLASS LOOKAHEAD: Can skip store to instance field (that is never read) storing value %p based on "
                "class file examination\n",
                value)) {
            genTreeTop(value);
            genTreeTop(address);
...
void TR_J9ByteCodeIlGenerator::storeFlattenableInstance(int32_t cpIndex)
{
    ...
    if (fieldCount == 0) {
        logprintf(trace, log, "%s: cpIndex %d fieldCount 0 value n%dn isNonNull %d address n%dn isNonNull %d\n",
            __FUNCTION__, cpIndex, value->getGlobalIndex(), value->isNonNull(), address->getGlobalIndex(),
            address->isNonNull());
        ...
        if (!value->isNonNull()
            && owningMethod->isFieldNullRestricted(comp(), cpIndex, false /* isStatic */, true /* isStore */)) {
            TR::Node *passThruNode = TR::Node::create(TR::PassThrough, 1, value);
            genTreeTop(genNullCheck(passThruNode));
        }
    ...
    for (size_t idx = 0; idx < fieldCount; idx++) {
        ...
        if (!strncmp(fieldNamePrefix, fieldEntry._fieldname, prefixLen)) {
            ...
            logprintf(trace, log, "Store flattened field %s to %s \n - field[%d] name %s type %d offset %d\n",
                comp()->getDebug()->getName(loadFieldSymRef), comp()->getDebug()->getName(fieldSymRef), idx,
                fieldEntry._fieldname, fieldEntry._datatype.getDataType(), fieldEntry._offset);
...
void TR_J9ByteCodeIlGenerator::storeStatic(int32_t cpIndex)
{
    if (_generateWriteBarriersForFieldWatch && comp()->compileRelocatableCode())
        comp()->failCompilation<J9::AOTNoSupportForAOTFailure>("NO support for AOT in field watch");
    ...
    if (owningMethod->isFieldNullRestricted(comp(), cpIndex, true /* isStatic */, true /* isStore */)) {
        logprintf(comp()->getOption(TR_TraceILGen), comp()->log(),
            "%s: cpIndex %d isFieldNullRestricted 1 value n%dn isNonNull %d\n", __FUNCTION__, cpIndex,
            value->getGlobalIndex(), value->isNonNull());
    ...
    if (symbol->isPrivate() && _classInfo && comp()->getNeedsClassLookahead() && !symbol->isVolatile()) {
        ...
        //
        TR_PersistentFieldInfo *fieldInfo
            = _classInfo->getFieldInfo() ? _classInfo->getFieldInfo()->findFieldInfo(comp(), node, false) : NULL;
        if (storeCanBeRemovedForUnreadField(fieldInfo, value)
            && performTransformation(comp(),
                "O^O CLASS LOOKAHEAD: Can skip store to static (that is never read) storing value %p based on class "
                "file examination\n",
                value)) {
            int32_t numChildren = node->getNumChildren();
            int32_t i = 0;
...
void TR_J9ByteCodeIlGenerator::storeDualAuto(TR::Node *storeValue, int32_t slot)
{
    TR_ASSERT(storeValue->isDualHigh() || storeValue->isSelectHigh(),
        "Coerced types only happen when a dual or select operator is generated.");
...
void TR_J9ByteCodeIlGenerator::storeAuto(TR::DataType type, int32_t slot, bool isAdjunct)
{
    ...
    // Partial Inlining: if we store into a parameter we need to create a temporary for the callback.  We need to create
    // the store for the temp in the first block.
    ...
    if (_blocksToInline) {
        if (slot < numParmSlots) {
            ...
            _blocksToInline->hasGeneratedRestartTree()
                ? patchPartialInliningCallBack(slot, symRef, tempRef, _blocksToInline->getGeneratedRestartTree())
                : addTempForPartialInliningCallBack(slot, tempRef, numParmSlots);
        }
    }
    ...
    //
    if (slot == 0 && _methodSymbol->isSynchronised() && !isStatic
        && !_methodSymbol->getSyncObjectTemp()) // RTSJ support
    {
    ...
    //
    if (slot == 0 && _methodSymbol->getResolvedMethod()->isObjectConstructor()
        ...
        for (TR::Node *finalize = i.getFirst(); finalize; finalize = i.getNext()) {
            ...
            if (receiverArg->getOpCode().hasSymbolReference() && receiverArg->getSymbolReference() != tempSymRef) {
...
void TR_J9ByteCodeIlGenerator::storeArrayElement(TR::DataType dataType, TR::ILOpCodes nodeop, bool checks)
{
    TR::Node *value = pop();
    ...
    if (generateNonHelper) {
        ...
        TR::TreeTop *storeHelperCallTT = genTreeTop(
            TR::Node::createWithSymRef(TR::call, 3, 3, value, elementIndex, arrayBaseAddress, helperSymRef));
    ...
    if (generateWriteBarrier) {
        storeNode = resultNode
            = TR::Node::createWithSymRef(TR::awrtbari, 3, 3, elementAddress, value, arrayBaseAddress, symRef);
    ...
    if (dataType == TR::Address) {
        bool canSkipThisArrayStoreCheck = _methodSymbol->skipArrayStoreChecks()
            && checks; // transformed java/lang/unsafe calls don't require checks;
        if (!canSkipThisArrayStoreCheck && _classInfo && value->getOpCodeValue() == TR::New) {
            if (!_classInfo->getFieldInfo())
                performClassLookahead(_classInfo);

            TR_PersistentFieldInfo *fieldInfo = _classInfo->getFieldInfo()
                ? _classInfo->getFieldInfo()->findFieldInfo(comp(), arrayBaseAddress, false)
                : NULL;
            ...
            if (arrayFieldInfo && arrayFieldInfo->isTypeInfoValid()) {
                ...
                if (arrayFieldInfo->getNumChars() == len && !memcmp(s, arrayFieldInfo->getClassPointer(), len)) {
                    if (performTransformation(comp(),
                            "O^O CLASS LOOKAHEAD: Can skip array store check for value %p using array object %p which "
                            "has type %s based on class file examination\n",
    ...
    //
    if (checkNode) {
        if (resultNode->getOpCodeValue() == TR::ArrayStoreCHK
            || (storeNode->getOpCode().isWrtBar() && !genTranslateTT)) {
...
int32_t TR_J9ByteCodeIlGenerator::genLookupSwitch()
{
    int32_t i = 1;
    while ((intptr_t)&_code[_bcIndex + i] & 3)
        ++i; // 4 byte align
...
int32_t TR_J9ByteCodeIlGenerator::genTableSwitch()
{
    int32_t i = 1;
    while ((intptr_t)&_code[_bcIndex + i] & 3)
        ++i; // 4 byte align
...
int32_t TR_J9ByteCodeIlGenerator::genAThrow()
{
    TR::Node *node
        = TR::Node::createWithSymRef(TR::athrow, 1, 1, pop(), symRefTab()->findOrCreateAThrowSymbolRef(_methodSymbol));
    ...
    if (!canSkipNullCheck && _classInfo) {
        ...
        if (fieldInfo && fieldInfo->isTypeInfoValid()) {
            if (performTransformation(comp(),
                    "O^O CLASS LOOKAHEAD: Can skip null check at exception throw %p based on class file examination\n",
                    thisObject))
 ...
 */
bool TR_J9ByteCodeIlGenerator::pushRequiredConst(TR::KnownObjectTable::Index *koi)
{
    *koi = TR::KnownObjectTable::UNKNOWN;
    ...
    if (value.isInt32())
        ...
        TR_ASSERT_FATAL(false, "unexpected constant type %s",
            value.isInt8()        ? "Int8"
                : value.isInt16() ? "Int16"
                                  : "???");
    }
 ...
 */
void TR_J9ByteCodeIlGenerator::markRequiredKnownObjectIndex(TR::Node *node, TR::KnownObjectTable::Index koi)
{
    if (koi == TR::KnownObjectTable::UNKNOWN)
        return;

    TR_ASSERT_FATAL(!comp()->getKnownObjectTable()->isNull(koi), "unexpected null index");
    ...
    TR_ASSERT_FATAL(symRefKoi == TR::KnownObjectTable::UNKNOWN || nodeKoi == TR::KnownObjectTable::UNKNOWN
            || symRefKoi == nodeKoi,
        "node n%un [%p] obj%d disagrees with symref #%d obj%d", node->getGlobalIndex(), node, nodeKoi,
        symRef->getReferenceNumber(), symRefKoi);

    TR::KnownObjectTable::Index existingKoi = symRefKoi != TR::KnownObjectTable::UNKNOWN ? symRefKoi : nodeKoi;
    ...
    if (existingKoi != TR::KnownObjectTable::UNKNOWN && existingKoi != koi) {
        ...
        // happen afterward.
        //
        comp()->failCompilation<TR::CompilationInterrupted>("required constant OSR assumption invalidated");
    }

    node->setKnownObjectIndex(koi);
    if (symRefKoi == TR::KnownObjectTable::UNKNOWN && node->getOpCode().isLoadVar()) {
        TR::SymbolReference *improvedSymRef = comp()->getSymRefTab()->findOrCreateSymRefWithKnownObject(symRef, koi);
