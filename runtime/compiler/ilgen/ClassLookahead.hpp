...
public:
    ...
    void findInitializerMethods(List<TR_ResolvedMethod> *, List<TR::ResolvedMethodSymbol> *,
        List<TR::ResolvedMethodSymbol> *, TR::ResolvedMethodSymbol **, bool *peekFailedForAnyMethod);
