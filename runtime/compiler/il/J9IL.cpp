...
static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForConst) / sizeof(J9::IL::opCodesForConst[0])),
    "J9::IL::opCodesForConst is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForDirectLoad) / sizeof(J9::IL::opCodesForDirectLoad[0])),
    "J9::IL::opCodesForDirectLoad is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForDirectStore) / sizeof(J9::IL::opCodesForDirectStore[0])),
    "J9::IL::opCodesForDirectStore is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForIndirectLoad) / sizeof(J9::IL::opCodesForIndirectLoad[0])),
    "J9::IL::opCodesForIndirectLoad is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForIndirectStore) / sizeof(J9::IL::opCodesForIndirectStore[0])),
    "J9::IL::opCodesForIndirectStore is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForIndirectArrayLoad) / sizeof(J9::IL::opCodesForIndirectArrayLoad[0])),
    "J9::IL::opCodesForIndirectArrayLoad is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForIndirectArrayStore) / sizeof(J9::IL::opCodesForIndirectArrayStore[0])),
    "J9::IL::opCodesForIndirectArrayStore is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForRegisterLoad) / sizeof(J9::IL::opCodesForRegisterLoad[0])),
    "J9::IL::opCodesForRegisterLoad is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForRegisterStore) / sizeof(J9::IL::opCodesForRegisterStore[0])),
    "J9::IL::opCodesForRegisterStore is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForCompareEquals) / sizeof(J9::IL::opCodesForCompareEquals[0])),
    "J9::IL::opCodesForCompareEquals is not the correct size");

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1
        == (sizeof(J9::IL::opCodesForCompareNotEquals) / sizeof(J9::IL::opCodesForCompareNotEquals[0])),
    "J9::IL::opCodesForCompareNotEquals is not the correct size");

TR::ILOpCodes J9::IL::opCodeForCorrespondingIndirectLoad(TR::ILOpCodes loadOpCode)
{
    ...
    switch (loadOpCode) {
        ...
        case TR::zdloadi:
            return TR::zdstorei;
        case TR::zdsleLoadi:
            return TR::zdsleStorei;
        case TR::zdslsLoadi:
            return TR::zdslsStorei;
        case TR::zdstsLoadi:
            return TR::zdstsStorei;
        case TR::udLoadi:
            return TR::udStorei;
        case TR::udslLoadi:
            return TR::udslStorei;
        case TR::udstLoadi:
            return TR::udstStorei;
        default:
            return OMR::IL::opCodeForCorrespondingIndirectLoad(loadOpCode);
    }
...
TR::ILOpCodes J9::IL::opCodeForCorrespondingIndirectStore(TR::ILOpCodes storeOpCode)
{
    ...
    switch (storeOpCode) {
        ...
        case TR::zdstorei:
            return TR::zdloadi;
        case TR::zdsleStorei:
            return TR::zdsleLoadi;
        case TR::zdslsStorei:
            return TR::zdslsLoadi;
        case TR::zdstsStorei:
            return TR::zdstsLoadi;
        case TR::udStorei:
            return TR::udLoadi;
        case TR::udslStorei:
            return TR::udslLoadi;
...
TR::ILOpCodes J9::IL::opCodeForCorrespondingDirectLoad(TR::ILOpCodes loadOpCode)
{
    if (OMR::ILOpCode::isOMROpCode(loadOpCode)) {
    ...
    switch (loadOpCode) {
        ...
        case TR::zdload:
            return TR::zdstore;
        case TR::zdsleLoad:
            return TR::zdsleStore;
        case TR::zdslsLoad:
            return TR::zdslsStore;
        case TR::zdstsLoad:
            return TR::zdstsStore;
        case TR::udLoad:
            return TR::udStore;
        case TR::udslLoad:
            return TR::udslStore;
...
TR::ILOpCodes J9::IL::opCodeForCorrespondingDirectStore(TR::ILOpCodes storeOpCode)
{
    if (OMR::ILOpCode::isOMROpCode(storeOpCode)) {
...
TR::ILOpCodes J9::IL::opCodeForConst(TR::DataType dt)
{
...
TR::ILOpCodes J9::IL::opCodeForDirectReadBarrier(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::irdbar;
    }
...
TR::ILOpCodes J9::IL::opCodeForDirectLoad(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::iload;
    }
...
TR::ILOpCodes J9::IL::opCodeForDirectStore(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::istore;
    }
...
TR::ILOpCodes J9::IL::opCodeForDirectWriteBarrier(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::iwrtbar;
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectReadBarrier(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::irdbari;
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectLoad(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::iloadi;
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectStore(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::istorei;
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectWriteBarrier(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::iwrtbari;
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectArrayLoad(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
...
TR::ILOpCodes J9::IL::opCodeForIndirectArrayStore(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
...
TR::ILOpCodes J9::IL::opCodeForRegisterLoad(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
...
TR::ILOpCodes J9::IL::opCodeForRegisterStore(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
...
TR::ILOpCodes J9::IL::opCodeForCompareEquals(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::icmpeq;
    }
...
TR::ILOpCodes J9::IL::opCodeForCompareNotEquals(TR::DataType dt)
{
    if (dt == TR::Int8 || dt == TR::Int16) {
        return TR::icmpne;
    }
