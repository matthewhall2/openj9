...
public:
    ...
    static RecognizedField searchRecognizedField(TR::Compilation *, TR_ResolvedMethod *owningMethodSymbol,
...
public:
    ...
    template<typename AllocatorType>
    static TR::Symbol *createPossiblyRecognizedShadowWithFlags(AllocatorType m, TR::DataType type, bool isVolatile,
        bool isFinal, bool isPrivate, RecognizedField recognizedField);

    template<typename AllocatorType>
    static TR::Symbol *createPossiblyRecognizedShadowFromCP(TR::Compilation *comp, AllocatorType m,
        TR_ResolvedMethod *owningMethod, int32_t cpIndex, TR::DataType *type, uint32_t *offset,
