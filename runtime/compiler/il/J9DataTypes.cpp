...
static TR::ILOpCodes conversionMapOMR2TR[TR::NumOMRTypes][TR::NumScalarTypes - TR::NumOMRTypes] =
    //                   PackedDec ZonedDec ZDecSLE ZDecSLS ZDecSTS UniDec  UniDecSL UniDecST
    {
        ...
        /* Int8 */
        {   TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Int8
        /* Int16 */
        {   TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Int16
        /* Int32 */
        { TR::i2pd, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Int32
        /* Int64 */
        { TR::l2pd, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Int64
        /* Float */
        { TR::f2pd, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Float
        /* Double */
        { TR::d2pd, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Double
        /* Address */
        {   TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad, TR_Bad }, // Address
};
...
static TR::ILOpCodes conversionMapTR2OMR[TR::NumScalarTypes - TR::NumOMRTypes][TR::NumOMRTypes] =
    //                                           No      Int8     Int16    Int32    Int64   Float     Double    Addr
    {
        ...
        /* ZonedDecimal */
        { TR_Bad, TR_Bad, TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad, TR_Bad }, // ZonedDecimal
        ...
        { TR_Bad, TR_Bad, TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad, TR_Bad }, // ZonedDecimal
        /* UnicodeDecimal */
        { TR_Bad, TR_Bad, TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad,   TR_Bad, TR_Bad }, // UnicodeDecim
...
static TR::ILOpCodes conversionMapTR2TR[TR::NumScalarTypes - TR::NumOMRTypes][TR::NumScalarTypes - TR::NumOMRTypes] =
    //                                       PackedDec    ZonedDec     ZDecSLE      ZDecSLS      ZDecSTS      UniDec
    //                                       UniDecSL    UniDecST
    {
        /* PackedDecimal */ {       TR_Bad,    TR::pd2zd,       TR_Bad, TR::pd2zdsls, TR::pd2zdsts,   TR::pd2ud, TR::pd2udsl,
                             TR::pd2udst                                                                                            },
        /* ZonedDecimal */
        {    TR::zd2pd,       TR_Bad, TR::zd2zdsle, TR::zd2zdsls, TR::zd2zdsts,      TR_Bad,      TR_Bad, TR_Bad },
        /* ZonedDecimalSignLeadingEmbedded */
        {       TR_Bad, TR::zdsle2zd,       TR_Bad,       TR_Bad,       TR_Bad,      TR_Bad,      TR_Bad, TR_Bad },
        /* ZonedDecimalSignLeadingSeparate*/
        { TR::zdsls2pd, TR::zdsls2zd,       TR_Bad,       TR_Bad,       TR_Bad,      TR_Bad,      TR_Bad, TR_Bad },
        /* ZonedDecimalSignTrailingSeparate*/
        { TR::zdsts2pd, TR::zdsts2zd,       TR_Bad,       TR_Bad,       TR_Bad,      TR_Bad,      TR_Bad, TR_Bad },
        /* UnicodeDecimal */
        {    TR::ud2pd,       TR_Bad,       TR_Bad,       TR_Bad,       TR_Bad,      TR_Bad,      TR_Bad, TR_Bad },
        /* UnicodeDecimalSignLeading */
        {  TR::udsl2pd,       TR_Bad,       TR_Bad,       TR_Bad,       TR_Bad, TR::udsl2ud,      TR_Bad, TR_Bad },
        /* UnicodeDecimalSignTrailing */
        {  TR::udst2pd,       TR_Bad,       TR_Bad,       TR_Bad,       TR_Bad, TR::udst2ud,      TR_Bad, TR_Bad }
};
...
TR::ILOpCodes J9::ILOpCode::getDataTypeConversion(TR::DataType t1, TR::DataType t2)
{
...
static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1 == (sizeof(J9DataTypeSizes) / sizeof(J9DataTypeSizes[0])),
    "J9DataTypeSizes is not the correct size");

const int32_t J9::DataType::getSize(TR::DataType dt)
{
...
void J9::DataType::setSize(TR::DataType dt, int32_t newSize)
{
...
static const char *J9DataTypeNames[] = { "PackedDecimal", "ZonedDecimal", "ZonedDecimalSignLeadingEmbedded",
    "ZonedDecimalSignLeadingSeparate", "ZonedDecimalSignTrailingSeparate", "UnicodeDecimal",
    "UnicodeDecimalSignLeading", "UnicodeDecimalSignTrailing" };

static_assert(TR::LastJ9Type - TR::FirstJ9Type + 1 == (sizeof(J9DataTypeNames) / sizeof(J9DataTypeNames[0])),
    "J9DataTypeNames is not the correct size");

const char *J9::DataType::getName(TR::DataType dt)
{
...
bool J9::DataType::isValidZonedDigit(uint8_t data)
{
...
bool J9::DataType::isValidUnicodeDigit(uint8_t dataHi, uint8_t dataLo)
{
...
bool J9::DataType::isValidZonedSeparateSign(uint8_t sign)
{
...
bool J9::DataType::isValidUnicodeSeparateSign(uint8_t signHi, uint8_t signLo)
{
...
bool J9::DataType::isValidZonedData(char *lit, int32_t start, int32_t end)
{
    if (start > end)
        return false;
...
bool J9::DataType::isValidUnicodeData(char *lit, int32_t start, int32_t end)
{
    if (start > end)
        return false;
...
bool J9::DataType::isValidBCDLiteral(char *lit, size_t litSize, TR::DataType dt, bool isEvenPrecision)
{
    if (dt.isAnyZoned()) {
        int32_t dataStart = 0;
...
bool J9::DataType::canGetMaxPrecisionFromType()
{
...
int32_t J9::DataType::getMaxPrecisionFromType()
{
    switch (self()->getDataType()) {
        case TR::PackedDecimal:
        case TR::ZonedDecimal:
...
int32_t J9::DataType::separateSignSize()
{
    switch (self()->getDataType()) {
        case TR::ZonedDecimalSignLeadingSeparate:
        case TR::ZonedDecimalSignTrailingSeparate:
...
int32_t J9::DataType::getLeftMostByte(TR::DataType dt, int32_t dataSize)
{
...
int32_t J9::DataType::getSignCodeOffset(TR::DataType dt, int32_t size)
{
    int32_t offset = 0;
    switch (dt) {
        case TR::PackedDecimal:
...
TR_SignCodeSize J9::DataType::getSignCodeSize(TR::DataType dt)
{
...
TR_BCDSignCode J9::DataType::getNormalizedSignCode(TR::DataType dt, int32_t rawSignCode)
{
    ...
    switch (dt) {
        case TR::PackedDecimal: {
            if (TR::DataType::embeddedSignCodeIsInRange(rawSignCode))
                ...
                TR_ASSERT(rawSignCode == TR::DataType::getIgnoredSignCode(),
                    "invalid embedded rawSignCode of 0x%x for datatype %s\n", rawSignCode, dt.toString());
            break;
        }
        case TR::ZonedDecimal:
        case TR::ZonedDecimalSignLeadingEmbedded: {
        ...
        case TR::ZonedDecimalSignLeadingSeparate: {
            if (rawSignCode == TR::DataType::getZonedSeparatePlus())
                ...
                TR_ASSERT(rawSignCode == TR::DataType::getIgnoredSignCode(),
                    "invalid zoned decimal separate rawSignCode of 0x%x for datatype %s\n", rawSignCode, dt.toString());
            break;
        }
        case TR::UnicodeDecimalSignTrailing:
        case TR::UnicodeDecimalSignLeading: {
            if (rawSignCode == TR::DataType::getNationalSeparatePlus())
                ...
                TR_ASSERT(rawSignCode == TR::DataType::getIgnoredSignCode(),
                    "invalid unicode decimal separate rawSignCode of 0x%x for datatype %s\n", rawSignCode,
                    dt.toString());
            break;
        }
        case TR::UnicodeDecimal: {
...
int32_t J9::DataType::getSizeFromBCDPrecision(TR::DataType dt, int32_t precision)
{
...
int32_t J9::DataType::getBCDPrecisionFromSize(TR::DataType dt, int32_t size)
{
...
uint32_t J9::DataType::printableToEncodedSign(uint32_t printableSign, TR::DataType dt)
{
...
uint32_t J9::DataType::encodedToPrintableSign(uint32_t encodedSign, TR::DataType dt)
{
    TR_ASSERT(dt.isBCD(), "encodedToPrintableSign() only valid for bcd types\n");
    uint32_t printableSign = '+';
    switch (dt) {
        case TR::PackedDecimal: {
            TR_ASSERT(encodedSign >= TR::DataType::getFirstValidSignCode()
                    && encodedSign <= TR::DataType::getLastValidSignCode(),
                "invalid sign code 0x%x for dt %s\n", encodedSign, dt.toString());
...
uint8_t J9::DataType::getOneByteBCDFill(TR::DataType dt)
{
...
uint16_t J9::DataType::getTwoByteBCDFill(TR::DataType dt)
{
...
TR_DigitSize J9::DataType::getDigitSize(TR::DataType dt)
{
...
int32_t J9::DataType::bytesToDigits(TR::DataType dt, int32_t bytes)
{
    int32_t digits = 0;
    switch (dt) {
        case TR::PackedDecimal:
...
int32_t J9::DataType::digitsToBytes(TR::DataType dt, int32_t digits)
{
    int32_t bytes = 0;
    switch (dt) {
        case TR::PackedDecimal:
...
int32_t J9::DataType::getPreferredPlusSignCode(TR::DataType dt)
{
...
int32_t J9::DataType::getPreferredMinusSignCode(TR::DataType dt)
{
...
bool J9::DataType::rawSignIsPositive(TR::DataType dt, int32_t rawSignCode)
{
...
bool J9::DataType::normalizedSignIsPositive(TR::DataType dt, TR_BCDSignCode normalizedSign)
{
...
bool J9::DataType::rawSignIsNegative(TR::DataType dt, int32_t rawSignCode)
{
    TR_BCDSignCode normalizedSign = TR::DataType::getNormalizedSignCode(dt, rawSignCode);
    return TR::DataType::normalizedSignIsNegative(dt, normalizedSign);
}

bool J9::DataType::normalizedSignIsNegative(TR::DataType dt, TR_BCDSignCode normalizedSign)
{
    if (normalizedSign == bcd_plus || normalizedSign == bcd_unsigned)
        return false;
    else if (normalizedSign == bcd_minus)
...
int32_t J9::DataType::getBCDPrecisionFromString(char *str, TR::DataType dt) // +123 prec=3, 123 prec=3
{
...
int32_t J9::DataType::getBCDStringFirstIndex(char *str, TR::DataType dt)
{
...
int32_t J9::DataType::getBCDStringLastIndex(char *str, TR::DataType dt) { return strlen(str) - 1; }

bool J9::DataType::isValidEmbeddedSign(uint8_t sign)
{
...
bool J9::DataType::isValidPackedData(char *lit, int32_t start, int32_t end, bool isEvenPrecision)
{
    if (start > end)
        return false;
...
bool J9::DataType::exceedsPaddingThreshold(int32_t digits, TR::DataType dt)
{
...
uint8_t J9::DataType::encodedToPrintableDigit(int32_t digit)
{
    ...
    switch (sourceSize) {
        case EmbeddedHalfByte: {
            if (TR::DataType::embeddedSignCodeIsInRange(sourceEncoding)) {
                TR_ASSERT(targetSize == SeparateOneByte || targetSize == SeparateTwoByte,
                    "target sign should be SeparateOneByte or SeparateTwoByte and not %d\n", targetSize);
                ...
                if (normalizedSignCode == bcd_plus || normalizedSignCode == bcd_unsigned)
                    sign = (targetSize == SeparateOneByte) ? TR::DataType::getZonedSeparatePlus()
                                                           : TR::DataType::getNationalSeparatePlus();
                else if (normalizedSignCode == bcd_minus)
                    sign = (targetSize == SeparateOneByte) ? TR::DataType::getZonedSeparateMinus()
        ...
        case SeparateOneByte: {
            TR_ASSERT(targetSize == EmbeddedHalfByte || targetSize == SeparateTwoByte,
                "target sign should be EmbeddedHalfByte or SeparateTwoByte and not %d\n", targetSize);
            if (sourceEncoding == TR::DataType::getZonedSeparatePlus())
                sign = (targetSize == EmbeddedHalfByte) ? TR::DataType::getPreferredPlusCode()
                                                        : TR::DataType::getNationalSeparatePlus();
            else if (sourceEncoding == TR::DataType::getZonedSeparateMinus())
                sign = (targetSize == EmbeddedHalfByte) ? TR::DataType::getPreferredMinusCode()
                                                        : TR::DataType::getNationalSeparateMinus();
            else
        ...
        case SeparateTwoByte: {
            TR_ASSERT(targetSize == EmbeddedHalfByte || targetSize == SeparateOneByte,
                "target sign should be EmbeddedHalfByte or SeparateOneByte and not %d\n", targetSize);
            if (sourceEncoding == TR::DataType::getZonedSeparatePlus())
                sign = (targetSize == EmbeddedHalfByte) ? TR::DataType::getPreferredPlusCode()
                                                        : TR::DataType::getNationalSeparatePlus();
            else if (sourceEncoding == TR::DataType::getZonedSeparateMinus())
