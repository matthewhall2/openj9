...
public:
    ...
    Compilation(int32_t compThreadId, J9VMThread *j9VMThread, TR_FrontEnd *, TR_ResolvedMethod *, TR::IlGenRequest &,
        ...
        TR_RelocationRuntime *reloRuntime, TR::Environment *target
    ...
    void addHWPInstruction(TR::Instruction *instruction, TR_HWPInstructionInfo::type instructionType,
        void *data = NULL);
    ...
    TR_ExternalRelocationTargetKind getReloTypeForMethodToBeInlined(TR_VirtualGuardSelection *guard, TR::Node *callNode,
...
#endif /* defined(J9VM_OPT_JITSERVER) */
    void setVectorApiTransformationPerformed(bool vectorApiTransformationPerformed)
    {
        _vectorApiTransformationPerformed = vectorApiTransformationPerformed;
    }
    ...
    J9::ConstProvenanceGraph *constProvenanceGraph() { return _constProvenanceGraph; }
    ...
    /**
     * \brief Populate the provided buffer with position independent AOT Method
     *        Dependencies.
     *
