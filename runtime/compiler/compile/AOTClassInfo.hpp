...
public:
    ...
    AOTClassInfo(TR_FrontEnd *fe, TR_OpaqueClassBlock *clazz, uintptr_t classChainOffset, TR_OpaqueMethodBlock *method,
        ...
        , _reloKind(reloKind)
    {
        ...
        TR_ASSERT(!aotCacheClassChainRecord
                || (fe->getPersistentInfo()->getRemoteCompilationMode() == JITServer::SERVER),
