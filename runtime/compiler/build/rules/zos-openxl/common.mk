...
#
# SPDX-License-Identifier: EPL-2.0 OR Apache-2.0 OR GPL-2.0-only WITH Classpath-exception-2.0 OR LGPL-2.0-only WITH OpenJDK-assembly-exception-1.0
...
#
include $(JIT_MAKE_DIR)/rules/zos-openxl/filetypes.mk
