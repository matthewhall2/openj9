...
CX_FLAGS+=\
    -fno-short-enums \
    -fno-strict-aliasing \
    -march=arch$(ARCHLEVEL) \
    -mtune=arch$(TUNELEVEL) \
    -fvisibility=default
...
CX_FLAGS+=\
    ...
    -isystem $(J9SRC)/a2e/headers \
    -isystem $(J9SRC)/zos_zlib/hzc/include \
    -isystem /usr/lpp/hzc/include \
    -isystem $(A2E_INCLUDE_PATH)
...
# Path to compiler include dir
CX_DEFINES+=COMPILER_HEADER_PATH_PREFIX=$(INCLUDE_DIR)
