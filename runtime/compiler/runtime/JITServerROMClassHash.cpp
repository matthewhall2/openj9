...
void JITServerROMClassHash::init(const JITServerROMClassHash &objectArrayHash,
...
void JITServerROMClassHash::init(const void *data, size_t size)
{
...
void JITServerROMClassHash::init(const J9ROMClass *romClass, TR_Memory &trMemory, TR_J9VMBase *fej9,
    bool checkGenerated, size_t prefixLength)
{
...
const char *JITServerROMClassHash::toString(char *buffer, size_t size) const
{
...
const JITServerROMClassHash &JITServerROMClassHash::getObjectArrayHash(const J9ROMClass *objectArrayROMClass,
