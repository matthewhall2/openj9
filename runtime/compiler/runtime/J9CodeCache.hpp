...
public:
     ...
     */
    bool initialize(TR::CodeCacheManager *manager, TR::CodeCacheMemorySegment *codeCacheSegment,
        size_t allocatedCodeCacheSizeInBytes, TR::CodeCacheKind kind);

    static TR::CodeCache *allocate(TR::CodeCacheManager *cacheManager, size_t segmentSize,
    ...
    void adjustTrampolineReservation(TR_OpaqueMethodBlock *method, void *cp, int32_t cpIndex);
