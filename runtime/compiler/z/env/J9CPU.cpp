...
TR::CPU J9::Z::CPU::detectRelocatable(OMRPortLibrary * const omrPortLib)
{
...
TR::CPU J9::Z::CPU::customize(OMRProcessorDesc processorDescription)
{
    ...
    if (processorDescription.processor < OMR_PROCESSOR_S390_Z14) {
        omrsysinfo_processor_set_feature(&processorDescription, OMR_FEATURE_S390_MISCELLANEOUS_INSTRUCTION_EXTENSION_2,
            FALSE);
    ...
    if (processorDescription.processor < OMR_PROCESSOR_S390_Z17) {
        omrsysinfo_processor_set_feature(&processorDescription, OMR_FEATURE_S390_MISCELLANEOUS_INSTRUCTION_EXTENSION_4,
            FALSE);
...
void J9::Z::CPU::enableFeatureMasks()
{
    ...
    const uint32_t utilizedFeatures[] = { OMR_FEATURE_S390_DFP, OMR_FEATURE_S390_TRANSACTIONAL_EXECUTION_FACILITY,
        OMR_FEATURE_S390_CONSTRAINED_TRANSACTIONAL_EXECUTION_FACILITY, OMR_FEATURE_S390_FPE, OMR_FEATURE_S390_RI,
        OMR_FEATURE_S390_VECTOR_FACILITY, OMR_FEATURE_S390_HIGH_WORD,
        OMR_FEATURE_S390_MISCELLANEOUS_INSTRUCTION_EXTENSION_2, OMR_FEATURE_S390_GUARDED_STORAGE,
        OMR_FEATURE_S390_VECTOR_PACKED_DECIMAL, OMR_FEATURE_S390_VECTOR_FACILITY_ENHANCEMENT_1,
        OMR_FEATURE_S390_VECTOR_FACILITY_ENHANCEMENT_2, OMR_FEATURE_S390_MISCELLANEOUS_INSTRUCTION_EXTENSION_3,
        OMR_FEATURE_S390_VECTOR_PACKED_DECIMAL_ENHANCEMENT_FACILITY,
        OMR_FEATURE_S390_VECTOR_PACKED_DECIMAL_ENHANCEMENT_FACILITY_2,
        OMR_FEATURE_S390_MISCELLANEOUS_INSTRUCTION_EXTENSION_4, OMR_FEATURE_S390_VECTOR_FACILITY_ENHANCEMENT_3,
        OMR_FEATURE_S390_PLO_EXTENSION, OMR_FEATURE_S390_VECTOR_PACKED_DECIMAL_ENHANCEMENT_FACILITY_3 };
...
bool J9::Z::CPU::isCompatible(const OMRProcessorDesc &processorDescription)
{
