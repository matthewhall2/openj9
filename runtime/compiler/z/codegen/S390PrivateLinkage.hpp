...
public:
    ...
    virtual TR::RealRegister *getSystemStackPointerRealRegister()
    {
        return getRealRegister(getSystemStackPointerRegister());
    }
    ...
    virtual int32_t calculateRegisterSaveSize(TR::RealRegister::RegNum f, TR::RealRegister::RegNum l, int32_t &rsd,
...
protected:
    ...
    void setupJNICallOutFrame(TR::Node *callNode, TR::RealRegister *javaStackPointerRealRegister,
...
public:
     ...
     */
    void processJNIReturnValue(TR::Node *callNode, TR::CodeGenerator *cg, TR::Register *javaReturnRegister);
    ...
    void releaseVMAccessMaskAtomicFree(TR::Node *callNode, TR::Register *methodMetaDataVirtualRegister,
        TR::Register *tempReg1);

    void acquireVMAccessMaskAtomicFree(TR::Node *callNode, TR::Register *methodMetaDataVirtualRegister,
        TR::Register *tempReg1);
