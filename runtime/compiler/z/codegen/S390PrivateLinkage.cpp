...
J9::Z::PrivateLinkage::buildDirectCall(TR::Node * callNode, TR::SymbolReference * callSymRef,
   ...
   if (isJitDispatchJ9Method)
      ...
      gcPoint = generateS390BranchInstruction(cg(), TR::InstOpCode::BRC, oolBranchOp, callNode, interpreterCallLabel, dependencies);
      gcPoint->setNeedsGCMap(getPreservedRegisterMapForGC());
...
J9::Z::PrivateLinkage::addSpecialRegDepsForBuildArgs(TR::Node * callNode, TR::RegisterDependencyConditions * dependencies, int32_t& from, int32_t step)
   ...
   if (callNode->isJitDispatchJ9MethodCall(comp())) {
      ...
      specialArgReg = getJ9MethodArgumentRegister();
      TR::Register *specialArg = copyArgRegister(callNode, child, cg()->gprClobberEvaluate(child)); // TODO:JSR292: We don't need a copy of the highOrder reg on 31-bit
...
J9::Z::PrivateLinkage::buildDirectDispatch(TR::Node * callNode)
   ...
   //    killMask &= ~(0x1L << REGINDEX(getVTableIndexArgumentRegister()));
