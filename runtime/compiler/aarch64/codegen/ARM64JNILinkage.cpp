...
int32_t J9::ARM64::JNILinkage::buildArgs(TR::Node *callNode, TR::RegisterDependencyConditions *dependencies)
{
...
void J9::ARM64::JNILinkage::buildVirtualDispatch(TR::Node *callNode, TR::RegisterDependencyConditions *dependencies,
    uint32_t argSize)
{
    TR_ASSERT(0, "Calling J9::ARM64::JNILinkage::buildVirtualDispatch does not make sense.");
}

void J9::ARM64::JNILinkage::releaseVMAccess(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
    TR::Register *scratchReg1, TR::Register *scratchReg2, TR::Register *scratchReg3)
{
    ...
    // Shareable shareability domain" thus, inner shareable dmb suffices
    ...
    generateTrg1MemInstruction(cg(), TR::InstOpCode::ldxrx, callNode, scratchReg2,
        TR::MemoryReference::createWithDisplacement(cg(), scratchReg0, 0));
    ...
    TR::Snippet *releaseVMAccessSnippet = new (trHeapMemory()) TR::ARM64HelperCallSnippet(cg(), callNode,
        releaseVMAccessSnippetLabel, relVMSymRef, releaseVMAccessRestartLabel);
    ...
    generateTrg1MemSrc1Instruction(cg(), TR::InstOpCode::stxrx, callNode, scratchReg2,
        TR::MemoryReference::createWithDisplacement(cg(), scratchReg0, 0), scratchReg2);
...
void J9::ARM64::JNILinkage::acquireVMAccess(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
    TR::Register *scratchReg1, TR::Register *scratchReg2)
{
    TR_J9VMBase *fej9 = reinterpret_cast<TR_J9VMBase *>(fe());
    ...
    TR::Snippet *reacquireVMAccessSnippet = new (trHeapMemory()) TR::ARM64HelperCallSnippet(cg(), callNode,
        reacquireVMAccessSnippetLabel, acqVMSymRef, reacquireVMAccessRestartLabel);
    ...
    generateTrg1MemSrc1Instruction(cg(), TR::InstOpCode::stxrx, callNode, scratchReg2,
        TR::MemoryReference::createWithDisplacement(cg(), scratchReg0, 0), scratchReg1);
    generateCompareBranchInstruction(cg(), TR::InstOpCode::cbnzx, callNode, scratchReg2, loopHead);
...
void J9::ARM64::JNILinkage::releaseVMAccessAtomicFree(TR::Node *callNode, TR::Register *vmThreadReg,
    TR::Register *scratchReg0, TR::Register *scratchReg1)
{
    TR_J9VMBase *fej9 = reinterpret_cast<TR_J9VMBase *>(fe());
    ...
    //
    static_assert(static_cast<uint64_t>(J9_PUBLIC_FLAGS_VM_ACCESS) < (1 << 12),
        "J9_PUBLIC_FLAGS_VM_ACCESS must fit in immediate");
    generateTrg1ImmInstruction(cg(), TR::InstOpCode::movzx, callNode, scratchReg0, 1);
#ifdef J9VM_INTERP_ATOMIC_FREE_JNI_USES_FLUSH
    auto strInNativeInstr = generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, offsetof(J9VMThread, inNative)), scratchReg0);
    auto ldrPubliFlagsInstr = generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg1,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetPublicFlagsOffset()));
#else /* J9VM_INTERP_ATOMIC_FREE_JNI_USES_FLUSH */
    generateTrg1Src1ImmInstruction(cg(), TR::InstOpCode::addimmx, callNode, scratchReg1, vmThreadReg,
        offsetof(J9VMThread, inNative));
    auto strInNativeInstr = generateMemSrc1Instruction(cg(), TR::InstOpCode::stlrx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), scratchReg1, 0), scratchReg0);
    generateTrg1Src1ImmInstruction(cg(), TR::InstOpCode::addimmx, callNode, scratchReg0, vmThreadReg,
        fej9->thisThreadGetPublicFlagsOffset());
    auto ldrPubliFlagsInstr = generateTrg1MemInstruction(cg(), TR::InstOpCode::ldarx, callNode, scratchReg1,
        TR::MemoryReference::createWithDisplacement(cg(), scratchReg0, 0));
#endif
    if (debugObj) {
...
void J9::ARM64::JNILinkage::acquireVMAccessAtomicFree(TR::Node *callNode, TR::Register *vmThreadReg,
    TR::Register *scratchReg0, TR::Register *zeroReg)
{
    TR_J9VMBase *fej9 = reinterpret_cast<TR_J9VMBase *>(fe());
    TR_Debug *debugObj = cg()->getDebug();
    ...
    static_assert(static_cast<uint64_t>(J9_PUBLIC_FLAGS_VM_ACCESS) < (1 << 12),
        "J9_PUBLIC_FLAGS_VM_ACCESS must fit in immediate");
    auto strInNativeInstr = generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, offsetof(J9VMThread, inNative)), zeroReg);
#ifndef J9VM_INTERP_ATOMIC_FREE_JNI_USES_FLUSH
    generateSynchronizationInstruction(cg(), TR::InstOpCode::dmb, callNode, TR::InstOpCode::ish);
#endif
    auto ldrPubliFlagsInstr = generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg0,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetPublicFlagsOffset()));
    if (debugObj) {
...
void J9::ARM64::JNILinkage::buildJNICallOutFrame(TR::Node *callNode, bool isWrapperForJNI,
    TR::LabelSymbol *returnAddrLabel, TR::Register *vmThreadReg, TR::Register *javaStackReg, TR::Register *scratchReg0,
    TR::Register *scratchReg1)
{
     ...
     */
    generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg1,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetCallOutCountOffset()));
    generateTrg1Src1ImmInstruction(cg(), TR::InstOpCode::addimmx, callNode, scratchReg1, scratchReg1, 1);
    generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetCallOutCountOffset()),
        scratchReg1);
#endif
    ...
    generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaFrameFlagsOffset()),
        scratchReg1);
    ...
    generateMemSrc1Instruction(cg(), TR::InstOpCode::strprex, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), javaStackReg, -TR::Compiler->om.sizeofReferenceAddress()),
        scratchReg0);
    ...
    if (fej9->needClassAndMethodPointerRelocations()) {
        ...
        TR::Instruction *firstInstruction
            = generateTrg1ImmInstruction(cg(), TR::InstOpCode::movzx, callNode, scratchReg0, methodAddr & 0x0000ffff);
        generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg0,
            ((methodAddr >> 16) & 0x0000ffff) | TR::MOV_LSL16);
        generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg0,
            ((methodAddr >> 32) & 0x0000ffff) | TR::MOV_LSL32);
        generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg0,
            (methodAddr >> 48) | TR::MOV_LSL48);
        ...
        cg()->addExternalRelocation(new (trHeapMemory()) TR::BeforeBinaryEncodingExternalRelocation(firstInstruction,
                                        reinterpret_cast<uint8_t *>(callNode->getSymbolReference()),
                                        reinterpret_cast<uint8_t *>(callNode->getInlinedSiteIndex()), reloType, cg()),
    ...
    // store out java sp
    generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaSPOffset()),
        javaStackReg);
    ...
    generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaPCOffset()), scratchReg0);

    generateMemSrc1Instruction(cg(), TR::InstOpCode::strimmx, callNode,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaLiteralsOffset()),
        scratchReg1);
}

void J9::ARM64::JNILinkage::restoreJNICallOutFrame(TR::Node *callNode, bool tearDownJNIFrame, TR::Register *vmThreadReg,
    TR::Register *javaStackReg, TR::Register *scratchReg)
{
    TR_J9VMBase *fej9 = reinterpret_cast<TR_J9VMBase *>(fe());
    ...
    generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaLiteralsOffset()));
    generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, javaStackReg,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetJavaSPOffset()));
    ...
    if (tearDownJNIFrame) {
        ...
        TR::SymbolReference *collapseSymRef
            = cg()->getSymRefTab()->findOrCreateRuntimeHelper(TR_ARM64jitCollapseJNIReferenceFrame);
        TR::Snippet *snippet = new (trHeapMemory())
            TR::ARM64HelperCallSnippet(cg(), callNode, refPoolSnippetLabel, collapseSymRef, refPoolRestartLabel);
        cg()->addSnippet(snippet);
        generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg,
            TR::MemoryReference::createWithDisplacement(cg(), javaStackReg, fej9->constJNICallOutFrameFlagsOffset()));

        TR_ASSERT_FATAL(fej9->constJNIReferenceFrameAllocatedFlags() == 0x30000,
            "constJNIReferenceFrameAllocatedFlags must be 0x30000");
    ...
    generateTrg1Src1ImmInstruction(cg(), TR::InstOpCode::addimmx, callNode, javaStackReg, javaStackReg,
        5 * TR::Compiler->om.sizeofReferenceAddress());
}

size_t J9::ARM64::JNILinkage::buildJNIArgs(TR::Node *callNode, TR::RegisterDependencyConditions *dependencies,
    bool passThread, bool passReceiver, bool killNonVolatileGPRs)
{
...
#error Unsupported platform
     ...
     */
    TR_ASSERT_FATAL(totalSize <= sizeof(UDATA) * J9_INLINE_JNI_MAX_ARG_COUNT,
        "totalSize must not be larger than J9_INLINE_JNI_MAX_ARG_COUNT slots");
...
#error Unsupported platform
    ...
    for (i = (TR::RealRegister::RegNum)((uint32_t)TR::RealRegister::v0 + floatRegsUsed); i <= TR::RealRegister::LastFPR;
         i++) {
...
TR::Register *J9::ARM64::JNILinkage::getReturnRegisterFromDeps(TR::Node *callNode,
    TR::RegisterDependencyConditions *deps)
{
    ...
    switch (callNode->getOpCodeValue()) {
        case TR::icall:
            retReg = deps->searchPostConditionRegister(pp.getIntegerReturnRegister());
            break;
        case TR::lcall:
        case TR::acall:
            retReg = deps->searchPostConditionRegister(pp.getLongReturnRegister());
            break;
        case TR::fcall:
        case TR::dcall:
            retReg = deps->searchPostConditionRegister(pp.getFloatReturnRegister());
            break;
        case TR::call:
            retReg = NULL;
            break;
    ...
    if (child->getOpCodeValue() == TR::loadaddr) {
        ...
        if (sym) {
            if (sym->isAddressOfClassObject()) {
                ...
                generateCondTrg1Src2Instruction(cg(), TR::InstOpCode::cselx, child, pushRegister, pushRegister, whatReg,
                    TR::CC_NE);
    ...
    switch (resolvedMethod->returnType()) {
        case TR::Address:
            if (wrapRefs) {
                ...
                generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, returnRegister,
        ...
        case TR::Int8:
            if (comp()->getSymRefTab()->isReturnTypeBool(callSymRef)) {
                ...
                TR::InstOpCode::Mnemonic op
                    = resolvedMethod->returnTypeIsUnsigned() ? TR::InstOpCode::ubfmw : TR::InstOpCode::sbfmw;
    ...
    TR::Register *scratchReg)
{
    ...
    generateTrg1MemInstruction(cg(), TR::InstOpCode::ldrimmx, callNode, scratchReg,
        TR::MemoryReference::createWithDisplacement(cg(), vmThreadReg, fej9->thisThreadGetCurrentExceptionOffset()));

    TR::SymbolReference *throwSymRef
        = cg()->getSymRefTab()->findOrCreateThrowCurrentExceptionSymbolRef(comp()->getJittedMethodSymbol());
    TR::LabelSymbol *exceptionSnippetLabel = generateLabelSymbol(cg());
    TR::Snippet *snippet
        = new (trHeapMemory()) TR::ARM64HelperCallSnippet(cg(), callNode, exceptionSnippetLabel, throwSymRef);
    cg()->addSnippet(snippet);
    TR::Instruction *gcPoint
        = generateCompareBranchInstruction(cg(), TR::InstOpCode::cbnzx, callNode, scratchReg, exceptionSnippetLabel);
    ...
    TR::RegisterDependencyConditions *deps, uintptr_t targetAddress, TR::Register *scratchReg)
{
    ...
    // load a 64-bit constant into a register with a fixed 4 instruction sequence
    TR::Instruction *firstInstruction
        = generateTrg1ImmInstruction(cg(), TR::InstOpCode::movzx, callNode, scratchReg, targetAddress & 0x0000ffff);
    generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg,
        ((targetAddress >> 16) & 0x0000ffff) | TR::MOV_LSL16);
    generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg,
        ((targetAddress >> 32) & 0x0000ffff) | TR::MOV_LSL32);
    generateTrg1ImmInstruction(cg(), TR::InstOpCode::movkx, callNode, scratchReg,
        (targetAddress >> 48) | TR::MOV_LSL48);
    ...
    cg()->getJNICallSites().push_front(
        new (trHeapMemory()) TR_Pair<TR_ResolvedMethod, TR::Instruction>(resolvedMethod, firstInstruction));
