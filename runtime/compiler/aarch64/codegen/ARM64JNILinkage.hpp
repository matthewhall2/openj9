...
private:
     ...
     */
    void releaseVMAccess(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
     ...
     * @param[in] scratchReg2 : scratch register
     */
    void acquireVMAccess(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
     ...
     * @param[in] scratchReg1 : scratch register
     */
    void releaseVMAccessAtomicFree(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
    ...
    void acquireVMAccessAtomicFree(TR::Node *callNode, TR::Register *vmThreadReg, TR::Register *scratchReg0,
        TR::Register *zeroReg);
     ...
     * @param[in] scratchReg1 : scratch register
     */
    void buildJNICallOutFrame(TR::Node *callNode, bool isWrapperForJNI, TR::LabelSymbol *returnAddrLabel,
     ...
     */
    void restoreJNICallOutFrame(TR::Node *callNode, bool tearDownJNIFrame, TR::Register *vmThreadReg,
     ...
     */
    size_t buildJNIArgs(TR::Node *callNode, TR::RegisterDependencyConditions *deps, bool passThread, bool passReceiver,
     ...
     */
    TR::Instruction *generateMethodDispatch(TR::Node *callNode, bool isJNIGCPoint,
