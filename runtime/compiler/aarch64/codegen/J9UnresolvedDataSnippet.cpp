...
J9::ARM64::UnresolvedDataSnippet::UnresolvedDataSnippet(TR::CodeGenerator *cg, TR::Node *node,
...
TR_RuntimeHelper J9::ARM64::UnresolvedDataSnippet::getHelper()
{
...
uint8_t *J9::ARM64::UnresolvedDataSnippet::emitSnippetBody()
{
...
void TR_Debug::print(OMR::Logger *log, TR::UnresolvedDataSnippet *snippet)
{
    ...
    log->printf("bl \t" POINTER_PRINTF_FORMAT "\t\t;%s%s", (intptr_t)cursor + distance, getRuntimeHelperName(helper),
        info);
    cursor += 4;
...
uint32_t J9::ARM64::UnresolvedDataSnippet::getLength(int32_t estimatedSnippetStart) { return 9 * 4; }
