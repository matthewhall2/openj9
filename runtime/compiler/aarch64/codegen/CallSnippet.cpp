...
static void
printArgumentFlush(OMR::Logger *log, TR_Debug *debug, uint8_t *cursor, const char *mnemonic, uint32_t offset, TR::Register *reg, TR::Register *stackReg)
   {
...
uint8_t *
TR_Debug::printARM64ArgumentsFlush(OMR::Logger *log, TR::Node *callNode, uint8_t *cursor, int32_t argSize)
   {
   uint32_t intArgNum=0, floatArgNum=0, offset;
...
void
TR_Debug::print(OMR::Logger *log, TR::ARM64CallSnippet *snippet)
   {
...
void
TR_Debug::print(OMR::Logger *log, TR::ARM64UnresolvedCallSnippet *snippet)
   {
...
void
TR_Debug::print(OMR::Logger *log, TR::ARM64VirtualUnresolvedSnippet * snippet)
   {
...
void
TR_Debug::print(OMR::Logger *log, TR::ARM64InterfaceCallSnippet * snippet)
   {
   TR::SymbolReference *callSymRef = snippet->getNode()->getSymbolReference();
   uint8_t *cursor = snippet->getSnippetLabel()->getCodeLocation();
