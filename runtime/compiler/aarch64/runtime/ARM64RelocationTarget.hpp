...
#ifndef ARM64RELOCATION_TARGET_INCL
#define ARM64RELOCATION_TARGET_INCL
...
class TR_ARM64RelocationTarget : public TR_RelocationTarget {
public:
    TR_ALLOC(TR_Memory::Relocation)
    void *operator new(size_t, J9JITConfig *);

    TR_ARM64RelocationTarget(TR_RelocationRuntime *reloRuntime)
...
#endif /* ARM64RELOCATION_TARGET_INCL */
