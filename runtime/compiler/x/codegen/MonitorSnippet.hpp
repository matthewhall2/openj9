...
#define NON_INC_DEC_MASK                                                                    \
    ((~OBJECT_HEADER_LOCK_BITS_MASK) | OBJECT_HEADER_LOCK_INFLATED | OBJECT_HEADER_LOCK_FLC \
        | OBJECT_HEADER_LOCK_RESERVED | OBJECT_HEADER_LOCK_LEARNING)
...
#define MAX_INL_INC_DEC_MASK                                                                \
    ((~OBJECT_HEADER_LOCK_BITS_MASK) | OBJECT_HEADER_LOCK_INFLATED | OBJECT_HEADER_LOCK_FLC \
        | OBJECT_HEADER_LOCK_RESERVED | OBJECT_HEADER_LOCK_LEARNING | OBJECT_HEADER_LOCK_LAST_RECURSION_BIT)
...
#define FLAGS_MASK \
    (OBJECT_HEADER_LOCK_INFLATED | OBJECT_HEADER_LOCK_FLC | OBJECT_HEADER_LOCK_RESERVED | OBJECT_HEADER_LOCK_LEARNING)
