...
public:
     ...
     *         - \c _classId of a class becomes -1 if it was invalidated, otherwise it's a valid class that will be
     * transformed
     *
     */
    ...
    static TR::VectorLength supportedOnPlatform(TR::Compilation *comp, vec_sz_t vectorLength)
    {
        ...
        if (length == TR::NoVectorLength && TR::Options::getVerboseOption(TR_VerboseVectorAPI)) {
            TR_VerboseLog::writeLine(TR_Vlog_VECTOR_API, "VectorLength%d is not implemented in %s at %s %s\n",
                vectorLength, comp->signature(), comp->getHotnessName(comp->getMethodHotness()),
                comp->isDLT() ? "DLT" : "");
        }
     ...
     */
    void findAllAliases(int32_t classId, int32_t id, TR_BitVector *vectorAliasTableElement::*aliasesField,
     ...
     *     Pointer to the struct member that contains class
     */
    void validateVectorAliasClasses(TR_BitVector *vectorAliasTableElement::*aliasesField,
        int32_t vectorAliasTableElement::*classField);
     ...
     */
    static TR_OpaqueClassBlock *getOpaqueClassBlockFromClassNode(TR::Compilation *comp, TR::Node *classNode);
     ...
     *     Address node
     */
    static TR::Node *generateArrayElementAddressNode(TR::Compilation *comp, TR::Node *array, TR::Node *arrayIndex,
        int32_t elementSize);
     ...
     */
    static TR::ILOpCodes ILOpcodeFromVectorAPIOpcode(TR::Compilation *comp, int32_t vectorOpCode,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, vapiOpCodeType opCodeType,
        bool withMask, bool trace, TR::DataType sourceElementType = TR::NoType,
     ...
     *
     */
    static TR::Node *vectorizeLoadOrStore(TR_VectorAPIExpansion *opt, TR::Node *node, TR::DataType opCodeType,
        bool newLoad = false);
     ...
     *    Element type used to create new temporary
     */
    static void scalarizeLoadOrStore(TR_VectorAPIExpansion *opt, TR::Node *node, TR::DataType elementType,
        int32_t numLanes);
     ...
     *
     */
    static void addScalarNode(TR_VectorAPIExpansion *opt, TR::Node *node, int32_t numLanes, int32_t i,
        TR::Node *scalarNode);
     ...
     *
     */
    static void aloadHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node, TR::DataType elementType,
     ...
     *
     */
    static void astoreHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
     ...
     *      NULL
     */
    static TR::Node *unsupportedHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *loadIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *storeIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *unaryIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *binaryIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *maskReductionCoercedIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop,
        TR::Node *node, TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType,
     ...
     *
     */
    static TR::Node *reductionCoercedIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *ternaryIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *testIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     */
    static TR::Node *transformRORtoROL(TR_VectorAPIExpansion *opt, TR::Node *node, TR::DataType elementType,
     ...
     */
    static bool getConvertSourceType(TR_VectorAPIExpansion *opt, TR::Node *node, TR::DataType &sourceElementType,
        vec_sz_t &bitsLength);
     ...
     *      Transformed node
     */
    static TR::Node *naryIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode, int32_t numChidren, vapiOpCodeType opCodeType);
     ...
     *      Transformed node
     */
    static TR::Node *blendIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *      Transformed node
     */
    static TR::Node *broadcastIntIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *      Transformed node
     */
    static TR::Node *fromBitsCoercedIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *      Transformed node
     */
    static TR::Node *compareIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *      Transformed node
     */
    static TR::Node *compressExpandOpIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *      Transformed node
     */
    static TR::Node *convertIntrinsicHandler(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode);
     ...
     *
     */
    static TR::Node *transformLoadFromArray(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode, TR::Node *array, TR::Node *arrayIndex);
     ...
     *
     */
    static TR::Node *transformStoreToArray(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, vapiObjType objectType, int32_t numLanes,
        handlerMode mode, TR::Node *valueToWrite, TR::Node *array, TR::Node *arrayIndex);
     ...
     *      Transformed node
     */
    static TR::Node *transformNary(TR_VectorAPIExpansion *opt, TR::TreeTop *treeTop, TR::Node *node,
        TR::DataType elementType, TR::VectorLength vectorLength, int32_t numLanes, handlerMode mode,
    ...
    static bool isOpCodeImplemented(TR::Compilation *comp, TR::ILOpCode opCode, bool check = true)
    {
        ...
        if (!result && TR::Options::getVerboseOption(TR_VerboseVectorAPI)) {
            ...
            TR_VerboseLog::writeLine(TR_Vlog_VECTOR_API, "%s%s%s%s is not implemented in %s at %s %S", opCode.getName(),
                twoTypes ? TR::DataType::getName(opCode.getVectorSourceDataType()) : "", twoTypes ? "_" : "",
        ...
        vapiOpCodeType opCodeType, bool withMask)
    {
        if (TR::Options::getVerboseOption(TR_VerboseVectorAPI)) {
            TR_VerboseLog::writeLine(TR_Vlog_VECTOR_API,
                "IL is missing for vectorAPIOpCode %s %d on %s %s in %s at %s %S", vapiOpCodeTypeNames[opCodeType],
                vectorAPIOpCode, vapiObjTypeNames[objectType], withMask ? "with Mask" : "", comp->signature(),
                comp->getHotnessName(comp->getMethodHotness()), comp->isDLT() ? "DLT" : "");
        }
        comp->setVectorApiTransformationPerformed(true);
     ...
     *      conversion opcode
     */
    static TR::ILOpCodes getLoadToMaskConversion(TR::Compilation *comp, int32_t numLanes, TR::DataType maskType,
     ...
     *      conversion opcode
     */
    static TR::ILOpCodes getMaskToStoreConversion(TR::Compilation *comp, int32_t numLanes, TR::DataType maskType,
