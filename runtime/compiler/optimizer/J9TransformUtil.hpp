...
public:
     ...
     */
    static bool avoidFoldingInstanceField(uintptr_t object, TR::Symbol *field, uint32_t fieldOffset, int cpIndex,
        TR_ResolvedMethod *owningMethod, TR::Compilation *comp);

    static bool avoidFoldingInstanceField(uintptr_t object, TR::SymbolReference *symRef, TR::Compilation *comp);
     ...
     */
    static bool attemptVarHandleStaticFinalFieldFolding(TR::Optimization *opt, TR::TreeTop *currentTree,
        TR::Node *node);
     ...
     */
    static TR_YesNoMaybe canFoldStaticFinalField(TR::Compilation *comp, TR_OpaqueClassBlock *declaringClass,
    ...
    static bool transformIndirectLoadChainImpl(TR::Compilation *, TR::Node *node, TR::Node *baseExpression,
        TR::KnownObjectTable::Index baseKnownObject, void *baseAddress, int32_t baseStableArrayRank,
        TR::Node **removedNode);
     ...
     */
    static TR::Node *calculateOffsetFromIndexInContiguousArrayWithElementStride(TR::Compilation *, TR::Node *index,
        int32_t elementStride);
    static TR::Node *calculateElementAddress(TR::Compilation *, TR::Node *array, TR::Node *index, TR::DataType type);
    static TR::Node *calculateElementAddressWithElementStride(TR::Compilation *, TR::Node *array, TR::Node *index,
        int32_t elementStride);
     ...
     */
    static bool refineMethodHandleInvokeBasic(TR::Compilation *comp, TR::TreeTop *treetop, TR::Node *node,
        TR::KnownObjectTable::Index mhIndex, bool trace = false);
    /*
     * \brief
     ...
     */
    static bool refineMethodHandleLinkTo(TR::Compilation *comp, TR::TreeTop *treetop, TR::Node *node,
        TR::KnownObjectTable::Index mnIndex, bool trace = false);
     ...
     */
    static bool staticFinalFieldValue(TR::Compilation *comp, TR_ResolvedMethod *owningMethod, int32_t cpIndex,
     ...
     */
    static TR::TreeTop *convertUnsafeCopyMemoryCallToArrayCopyWithSymRefLoad(TR::Compilation *comp,
     ...
     */
    static TR::Block *insertUnsafeCopyMemoryArgumentChecksAndAdjustForOffHeap(TR::Compilation *comp, TR::Node *node,
        TR::SymbolReference *symRef, TR::Block *callBlock, bool insertArrayCheck, TR::CFG *cfg);
     ...
     */
    static void transformUnsafeCopyMemorytoArrayCopyForOffHeap(TR::Compilation *comp, TR::TreeTop *arrayCopyTT,
...
protected:
     ...
     */
    static bool attemptStaticFinalFieldFoldingImpl(TR::Optimization *opt, TR::TreeTop *currentTree, TR::Node *node,
        bool varHandleOnly);
};
