...
private:
     ...
     */
    void processAutosAndPendingPushes(TR::ResolvedMethodSymbol *rms, DefiningMap *induceDefiningMap,
     ...
     *                numbers of live autos and pending pushes
     */
    void processSymbolReferences(TR_Array<List<TR::SymbolReference> > *symbolReferences, DefiningMap *induceDefiningMap,
        TR_BitVector *deadSymRefs, TR_BitVector &symRefsToLoad);
};
