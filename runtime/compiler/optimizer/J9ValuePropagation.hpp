...
public:
    ...
    virtual bool isUnreliableSignatureType(TR_OpaqueClassBlock *klass, TR_OpaqueClassBlock *&erased);
    virtual void doDelayedTransformations();
    void transformCallToNodeWithHCRGuard(TR::TreeTop *callTree, TR::Node *result);
    void transformCallToIconstInPlaceOrInDelayedTransformations(TR::TreeTop *callTree, int32_t result, bool isGlobal,
        bool inPlace = true, bool requiresGuard = false);
     ...
     */
    virtual bool canArrayClassBeTrustedAsFixedClass(TR_OpaqueClassBlock *arrayClass,
     ...
     *
     */
    bool transformFlattenedArrayElementStore(TR_OpaqueClassBlock *arrayClass, TR::TreeTop *callTree, TR::Node *callNode,
     ...
     *
     */
    void transformFlattenedArrayElementLoadStoreUseTypeHint(TR_OpaqueClassBlock *typeHintClass, TR::Node *callNode,
        TR::TreeTop *callTree, bool isLoad, bool needsNullValueCheck);
     ...
     */
    void transformUnflattenedArrayElementLoadStoreUseTypeHint(TR_OpaqueClassBlock *typeHintClass, TR::Node *callNode,
        TR::TreeTop *callTree, bool isLoad, bool needsNullValueCheck, bool needsStoreCheck,
     ...
     */
    void transformIntoRegularArrayElementStore(TR::TreeTop *callTree, TR::Node *callNode, bool needsNullValueCheck,
        bool needsStoreCheck, TR_OpaqueClassBlock *storeClassForArrayStoreCHK,
     ...
     *             \c false otherwise.
     */
    virtual void getArrayLengthLimits(TR::VPConstraint *arrayConstraint, int32_t &lowerBoundLimit,
...
private:
     ...
     */
    bool transformIndexOfKnownString(TR::Node *indexOfNode, TR::Node *sourceStringNode, TR::Node *targetCharNode,
        TR::Node *startNode, TR::Node *lengthNode, bool is16Bit = true);
    ...
    struct TreeNodeResultPair {
        ...
        TreeNodeResultPair(TR::TreeTop *tree, TR::Node *result, bool requiresHCRGuard)
            : _tree(tree)
            , _result(result)
            , _requiresHCRGuard(requiresHCRGuard)
        {}
    };
    ...
    struct ValueTypesHelperCallTransform {
         ...
         */
        virtual bool isObjectComparisonHelperCallTransform() { return false; }
         ...
         *        helper
         */
        virtual bool isArrayOperationHelperCallTransform() { return false; }
         ...
         */
        virtual bool isArrayElementLoadHelperCallTransform() { return false; }
         ...
         */
        virtual bool isArrayElementStoreHelperCallTransform() { return false; }
        ...
        {
            TR_ASSERT_FATAL(isObjectComparisonHelperCallTransform(),
                "ValueTypesHelperCallTransform is not an ObjectComparisonHelperCallTransform\n");
        ...
        {
            TR_ASSERT_FATAL(isArrayOperationHelperCallTransform(),
                "ValueTypesHelperCallTransform is not an ArrayOperationHelperCallTransform\n");
        ...
        {
            TR_ASSERT_FATAL(isArrayElementLoadHelperCallTransform(),
                "ValueTypesHelperCallTransform is not an ArrayElementLoadHelperCallTransform\n");
        ...
        {
            TR_ASSERT_FATAL(isArrayElementStoreHelperCallTransform(),
                "ValueTypesHelperCallTransform is not an ArrayElementStoreHelperCallTransform\n");
    ...
    struct ObjectComparisonHelperCallTransform : ValueTypesHelperCallTransform {
         ...
         *        call to the <objectEqualityCompare> or <objectInequalityCompare> helper
         */
        virtual bool isObjectComparisonHelperCallTransform() { return true; }
    };
    ...
    struct ArrayOperationHelperCallTransform : ValueTypesHelperCallTransform {
         ...
         *        helper
         */
        virtual bool isArrayOperationHelperCallTransform() { return true; }
    };
    ...
    struct ArrayElementLoadHelperCallTransform : ArrayOperationHelperCallTransform {
         ...
         *        call to the <jitLoadFlattenableArrayElement>
         */
        virtual bool isArrayElementLoadHelperCallTransform() { return true; }
    };
    ...
    struct ArrayElementStoreHelperCallTransform : ArrayOperationHelperCallTransform {
        ...
        ArrayElementStoreHelperCallTransform(TR::TreeTop *tree, TR::Node *callNode, flags8_t flags, int32_t arrayLength,
            ...
            , _componentClassForArrayStoreCHK(componentClassForCheck)
        {}
         ...
         *        call to the <jitStoreFlattenableArrayElement>
         */
        virtual bool isArrayElementStoreHelperCallTransform() { return true; }
    };
