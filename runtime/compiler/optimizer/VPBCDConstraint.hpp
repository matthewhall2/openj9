...
// For example if constraint1 = Plus and constraint2 = Minus then the common constraint is Preferred as both Plus and
// Minus are preferred signs
const TR_BCDSignConstraint signConstraintMergeMap[TR_Sign_Num_Types][TR_Sign_Num_Types] =
    //                         Unknown          Clean             Preferred           Plus               Minus Unsigned
    //                         Minus_Clean
    {
        /* TR_Sign_Unknown */ { TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown,
                               TR_Sign_Unknown,TR_Sign_Unknown                                  },
        /* TR_Sign_Clean */
        { TR_Sign_Unknown,     TR_Sign_Clean, TR_Sign_Preferred,     TR_Sign_Clean, TR_Sign_Preferred,  TR_Sign_Unknown,
                               TR_Sign_Clean      },
        /* TR_Sign_Preferred */
        { TR_Sign_Unknown, TR_Sign_Preferred, TR_Sign_Preferred, TR_Sign_Preferred, TR_Sign_Preferred,  TR_Sign_Unknown,
                               TR_Sign_Preferred  },
        /* TR_Sign_Plus */
        { TR_Sign_Unknown,     TR_Sign_Clean, TR_Sign_Preferred,      TR_Sign_Plus, TR_Sign_Preferred,  TR_Sign_Unknown,
                               TR_Sign_Clean      },
        /* TR_Sign_Minus */
        { TR_Sign_Unknown, TR_Sign_Preferred, TR_Sign_Preferred, TR_Sign_Preferred,     TR_Sign_Minus,  TR_Sign_Unknown,
                               TR_Sign_Minus      },
        /* TR_Sign_Unsigned */
        { TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown,   TR_Sign_Unknown, TR_Sign_Unsigned,
                               TR_Sign_Unknown    },
        /* TR_Sign_Minus_Clean */
        { TR_Sign_Unknown,     TR_Sign_Clean, TR_Sign_Preferred,     TR_Sign_Clean,     TR_Sign_Minus,  TR_Sign_Unknown,
                               TR_Sign_Minus_Clean },
};
...
public:
    ...
    const char *getName() { return getName(_sign); }
    ...
    static TR_BCDSignConstraint getMergedSignConstraint(TR_BCDSignConstraint signConstraintOne,
        TR_BCDSignConstraint signConstraintTwo)
    {
    ...
    virtual void print(OMR::Logger *log, TR::Compilation *comp);
...
public:
    VP_BCDValue(char *lit, int32_t litLowSize, char *str, TR_BCDSignConstraint sign, TR::DataType dt,
    ...
    bool isEqualTo(int32_t otherPrecision, char *otherLit, int32_t otherLitSize, TR_BCDSignConstraint otherSign,
        TR::DataType otherDataType);
    virtual bool isHighEqualTo(int32_t otherPrecision, char *otherLit, int32_t otherLitSize,
        TR_BCDSignConstraint otherSign, TR::DataType otherDataType)
        = 0;
    static bool compareBCDConstraints(int32_t precisionOne, char *litOne, int32_t litSizeOne,
        TR_BCDSignConstraint signOne, TR::DataType dataTypeOne, int32_t precisionTwo, char *litTwo, int32_t litSizeTwo,
        TR_BCDSignConstraint signTwo, TR::DataType dataTypeTwo);
