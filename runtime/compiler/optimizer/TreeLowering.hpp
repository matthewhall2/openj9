...
public:
    ...
    protected:
         ...
         */
        TR::Block *splitForFastpath(TR::Block * const block, TR::TreeTop * const splitPoint,
...
private:
    ...
    public:
         ...
         */
        explicit TransformationManager(TR::Region &allocator)
            : _transformationQueue(allocator)
        {}
...
private:
    ...
    template<typename T> Transformer *getTransformer() { return new (comp()->region()) T(this); }
};

void TR::TreeLowering::TransformationManager::Transformation::doTransformation() { transformer->lower(node, tt); }
