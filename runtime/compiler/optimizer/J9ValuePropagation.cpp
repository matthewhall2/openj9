    ...
    if (!comp()->compileRelocatableCode()) {
        switch (rm) {
            ...
            case TR::java_lang_invoke_MethodHandleImpl_isCompileConstant: {
                ...
                printf("Trying to fold MethodHandleImpl.isCompileConstant\n");
                ...
                if (mhConstraint && mhConstraint->getKnownObject() && mhConstraint->isNonNullObject()) {
                    ...
                    printf("MethodHandleImpl.isCompileConstant folded to true\n");
                    return;
                }
                ...
                logprintf(trace(), log, "MethodHandleImpl.isCompileConstant folded to true\n");
                printf("MethodHandleImpl.isCompileConstant folded to false\n");
                break;
            }
            default:
                break;
