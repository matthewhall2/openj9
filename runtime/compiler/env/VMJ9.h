...
inline void getClassNameSignatureFromMethod(J9Method *method, J9UTF8 *&methodClazz, J9UTF8 *&methodName,
...
public:
    ...
    //
    virtual void setInlineThresholds(TR::Compilation *comp, int32_t &callerWeightLimit,
    ...
    virtual int32_t adjustedInliningWeightBasedOnArgument(int32_t origWeight, TR::Node *argNode,
    ...
    virtual TR::DataType dataTypeForLoadOrStore(TR::DataType dt)
    {
        return (dt == TR::Int8 || dt == TR::Int16) ? TR::Int32 : dt;
    }
     ...
     */
    virtual bool isResolvedDirectDispatchGuaranteed(TR::Compilation *comp) { return true; }
     ...
     */
    virtual bool isResolvedVirtualDispatchGuaranteed(TR::Compilation *comp) { return true; }
    ...
    uintptr_t necessaryClassChainLength(J9Class *clazz)
    {
        return 2 + numInterfacesImplemented(clazz) + numSuperclasses(clazz);
    }

    virtual uint32_t numInterfacesImplemented(J9Class *clazz);

    uintptr_t numSuperclasses(J9Class *clazz)
    {
        return TR::Compiler->cls.classDepthOf(convertClassPtrToClassOffset(clazz));
    }
...
public:
    ...
    virtual TR_OpaqueMethodBlock *getResolvedInterfaceMethod(TR_OpaqueMethodBlock *ownerMethod,
        TR_OpaqueClassBlock *classObject, int32_t cpIndex);

    TR_OpaqueMethodBlock *getResolvedInterfaceMethod(J9ConstantPool *ownerCP, TR_OpaqueClassBlock *classObject,
        int32_t cpIndex);

    uintptr_t getReferenceField(uintptr_t objectPointer, const char *fieldName, const char *fieldSignature)
    {
        return getReferenceFieldAt(objectPointer,
            getInstanceFieldOffset(getObjectClass(objectPointer), fieldName, fieldSignature));
    }

    uintptr_t getVolatileReferenceField(uintptr_t objectPointer, const char *fieldName, const char *fieldSignature)
    {
        return getVolatileReferenceFieldAt(objectPointer,
            getInstanceFieldOffset(getObjectClass(objectPointer), fieldName, fieldSignature));
    }

    /**
     * @brief Get the int32 value in the VarHandle$AccessDescriptor's mode field. This value is used as the index of the
     * MethodHandle for the access mode in the MethodHandle table.
     *
     ...
     */
    virtual TR::KnownObjectTable::Index getMethodHandleTableEntryIndex(TR::Compilation *comp,
     ...
     * @return TR::KnownObjectTable::Index the known object index of the MemorySegmentView VarHandle,
     * TR::KnownObjectTable::UNKNOWN otherwise
     */
     ...
     * @return TR::KnownObjectTable::Index the known object index of the MethodAccessor object if valid,
     * TR::KnownObjectTable::UNKNOWN otherwise
     */
    ...
    virtual TR_ResolvedMethod *createResolvedMethodWithVTableSlot(TR_Memory *, uint32_t vTableSlot,
        TR_OpaqueMethodBlock *aMethod, TR_ResolvedMethod *owningMethod = 0,
        TR_OpaqueClassBlock *classForNewInstance = 0);
    virtual TR_ResolvedMethod *createResolvedMethodWithSignature(TR_Memory *, TR_OpaqueMethodBlock *,
        TR_OpaqueClassBlock *, char *signature, int32_t signatureLength, TR_ResolvedMethod *, uint32_t = 0);
    ...
    {
        return ((TR_PersistentMemory *)_jitConfig->scratchSegment)->getPersistentInfo();
    }
    ...
    virtual uint8_t *allocateCodeMemory(TR::Compilation *, uint32_t warmCodeSize, uint32_t coldCodeSize,
        uint8_t **coldCode, bool isMethodHeaderNeeded = true);
    ...
    virtual bool ensureOSRBufferSize(TR::Compilation *comp, uintptr_t osrFrameSizeInBytes,
    ...
    virtual uintptr_t getReferenceFieldAtAddress(void *fieldAddress)
    {
        return getReferenceFieldAtAddress((uintptr_t)fieldAddress);
    }
    ...
    TR::KnownObjectTable::ObjectInfo getObjClassInfoFromKnotIndex(TR::Compilation *comp,
        TR::KnownObjectTable::Index knotIndex);
    ...
    virtual bool compareAndSwapInt64FieldAt(uintptr_t objectPointer, uintptr_t fieldOffset, int64_t oldValue,
        int64_t newValue);

    bool compareAndSwapInt64Field(uintptr_t objectPointer, const char *fieldName, int64_t oldValue, int64_t newValue)
    {
        return compareAndSwapInt64FieldAt(objectPointer,
            getInstanceFieldOffset(getObjectClass(objectPointer), fieldName, "J"), oldValue, newValue);
    }
    ...
    virtual TR_OpaqueClassBlock *getSystemClassFromClassName(const char *name, int32_t length,
    ...
    virtual int32_t
    getITableEntryJitVTableOffset(); // Must add this to the negation of an itable entry to get a jit vtable offset
    ...
    virtual int32_t getJavaLangClassHashCode(TR::Compilation *comp, TR_OpaqueClassBlock *clazzPointer,
    ...
    virtual bool scanReferenceSlotsInClassForOffset(TR::Compilation *comp, TR_OpaqueClassBlock *classPointer,
        int32_t offset);
    ...
    virtual bool maybeHighlyPolymorphic(TR::Compilation *, TR_ResolvedMethod *caller, int32_t cpIndex,
        TR::Method *callee, TR_OpaqueClassBlock *receiverClass = NULL);
    ...
    virtual bool startAsyncCompile(TR_OpaqueMethodBlock *methodInfo, void *oldStartPC, bool *queued,
    ...
    virtual int32_t printTruncatedSignature(char *sigBuf, int32_t bufLen, J9UTF8 *className, J9UTF8 *name,
        J9UTF8 *signature);
    ...
    virtual char *getJ2IThunkSignatureForDispatchVirtual(char *invokeHandleSignature, uint32_t signatureLength,
        TR::Compilation *comp);
    ...
    virtual TR_ResolvedMethod *createMethodHandleArchetypeSpecimen(TR_Memory *, uintptr_t *methodHandleLocation,
        TR_ResolvedMethod *owningMethod = 0);
    virtual TR_ResolvedMethod *createMethodHandleArchetypeSpecimen(TR_Memory *, TR_OpaqueMethodBlock *archetype,
        uintptr_t *methodHandleLocation,
        TR_ResolvedMethod *owningMethod = 0); // more efficient if you already know the archetype

    virtual uintptr_t mutableCallSiteCookie(uintptr_t mutableCallSite, uintptr_t potentialCookie = 0);
    virtual TR::KnownObjectTable::Index mutableCallSiteEpoch(TR::Compilation *comp, TR::KnownObjectTable::Index mcs);
     ...
     */
    virtual TR_OpaqueMethodBlock *targetMethodFromMemberName(TR::Compilation *comp,
     ...
     *    VM access is not required
     */
    virtual TR_OpaqueMethodBlock *targetMethodFromMethodHandle(TR::Compilation *comp,
        TR::KnownObjectTable::Index objIndex);
     ...
     */
    virtual bool getMemberNameMethodInfo(TR::Compilation *comp, TR::KnownObjectTable::Index objIndex,
     ...
     * successful, or an exception object otherwise. The entry is considered valid when the object in the slot is an
     * array type. This helper must be used before trying to access elements of an invokeCacheArray corresponding to an
     * invokedynamic bytecode \param invokeCacheArray the invokeCacheArray address \return true if entry is an array
     ...
     */
    virtual TR_ResolvedMethod *targetMethodFromInvokeCacheArrayMemberNameObj(TR::Compilation *comp,
     ...
     *    Encapsulates code that requires VM access to make JITServer support easier.
     */
    virtual TR::KnownObjectTable::Index getKnotIndexOfInvokeCacheArrayAppendixElement(TR::Compilation *comp,
     ...
     */
    TR::KnownObjectTable::Index delegatingMethodHandleTarget(TR::Compilation *comp,
        TR::KnownObjectTable::Index dmhIndex, bool trace);
    virtual TR::KnownObjectTable::Index delegatingMethodHandleTargetHelper(TR::Compilation *comp,
     ...
     * \param mhIndex known object index of the java/lang/invoke/MethodHandle object
     * \param expectedTypeIndex known object index of  java/lang/invoke/MethodType object
     * \return the converted method handle, or 0 if a conversion cannot be made
     */
    virtual uintptr_t getConvertedMethodhandle(TR::Compilation *comp, TR::KnownObjectTable::Index mhIndex,
        TR::KnownObjectTable::Index expectedTypeIndex);
     ...
     *    the method accessing the field
     */
    virtual bool canDereferenceAtCompileTimeWithFieldSymbol(TR::Symbol *fieldSymbol, int32_t cpIndex,
        TR_ResolvedMethod *owningMethod);

    virtual bool getStringFieldByName(TR::Compilation *, TR::SymbolReference *stringRef, TR::SymbolReference *fieldRef,
        void *&pResult);
    ...
    virtual void initializeLocalObjectHeader(TR::Compilation *, TR::Node *allocationNode,
        TR::TreeTop *allocationTreeTop);
    virtual void initializeLocalArrayHeader(TR::Compilation *, TR::Node *allocationNode,
        TR::TreeTop *allocationTreeTop);
    virtual TR::TreeTop *initializeClazzFlagsMonitorFields(TR::Compilation *, TR::TreeTop *prevTree,
    ...
    virtual TR::CodeCache *getResolvedTrampoline(TR::Compilation *, TR::CodeCache *curCache, J9Method *method,
    ...
    virtual TR_ExternalValueProfileInfo *getValueProfileInfoFromIProfiler(TR_ByteCodeInfo &bcInfo,
        TR::Compilation *comp);
    uint32_t *getAllocationProfilingDataPointer(TR_ByteCodeInfo &bcInfo, TR_OpaqueClassBlock *clazz,
    ...
    virtual bool releaseClassUnloadMonitorAndAcquireVMaccessIfNeeded(TR::Compilation *comp,
        bool *hadClassUnloadMonitor);
    virtual void acquireClassUnloadMonitorAndReleaseVMAccessIfNeeded(TR::Compilation *comp, bool hadVMAccess,
        bool hadClassUnloadMonitor);
    ...
    virtual void releaseVMAccessIfNeeded(bool haveAcquiredVMAccess)
    {
    ...
    virtual U_8 *fetchMethodExtendedFlagsPointer(
        J9Method *method); // wrapper method of fetchMethodExtendedFlagsPointer in util/extendedmethodblockaccess.c, for
                           // JITServer override purpose
    ...
    bool shouldSleep()
    {
        _shouldSleep = !_shouldSleep;
        return _shouldSleep;
    } // no need for virtual; we need this per thread

    virtual bool isAnonymousClass(TR_OpaqueClassBlock *j9clazz)
    {
        return (J9_ARE_ALL_BITS_SET(((J9Class *)j9clazz)->romClass->extraModifiers, J9AccClassAnonClass));
    }

    virtual bool isAnonymousClass(J9ROMClass *romClass)
    {
        return (J9_ARE_ALL_BITS_SET(romClass->extraModifiers, J9AccClassAnonClass));
    }
     ...
     */
    virtual bool isHiddenClass(TR_OpaqueClassBlock *j9clazz)
    {
        return (J9_ARE_ALL_BITS_SET(((J9Class *)j9clazz)->romClass->extraModifiers, J9AccClassHidden));
    }

    virtual int64_t getCpuTimeSpentInCompThread(
        TR::Compilation *comp); // resolution is 0.5 sec or worse. Returns -1 if unavailable
    ...
    TR::CompilationInfo
        *_compInfo; // storing _compInfo in multiple places could spell trouble when we free the structure
    ...
    virtual int findOrCreateMethodSymRef(TR::Compilation *comp, TR::ResolvedMethodSymbol *owningMethodSym,
    ...
    virtual TR::SymbolReference *findOrCreateMethodSymRef(TR::Compilation *comp,
    ...
    // Called by the current compilation thread at the beginning of a remote compilation to clear the
    // _deserializerWasReset flag
    ...
    virtual bool classInitIsFinished(TR_OpaqueClassBlock *clazz)
    {
        return (((J9Class *)clazz)->initializeStatus & J9ClassInitStatusMask) == J9ClassInitSucceeded;
    }
    ...
    uint32_t getInstanceFieldOffsetIncludingHeader(const char *classSignature, const char *fieldName,
    ...
    virtual void markClassForTenuredAlignment(TR::Compilation *comp, TR_OpaqueClassBlock *opclazz,
    ...
    virtual void *getInvokeExactThunkHelperAddress(TR::Compilation *comp, TR::SymbolReference *glueSymRef,
...
protected:
    ...
    {
        return sigLength == 1
            && (*sig == 'I' || *sig == 'Z' || *sig == 'C' || *sig == 'B' || *sig == 'J' || *sig == 'F' || *sig == 'D'
                || *sig == 'S');
    }
...
public:
    ...
    virtual TR_OpaqueClassBlock *getClassFromSignature(const char *sig, int32_t sigLength, TR_ResolvedMethod *method,
        bool isVettedForAOT = false);
    virtual TR_OpaqueClassBlock *getClassFromSignature(const char *sig, int32_t sigLength, TR_OpaqueMethodBlock *method,
        bool isVettedForAOT = false);
    virtual TR_OpaqueClassBlock *getClassFromSignature(const char *sig, int32_t sigLength, TR_OpaqueClassBlock *clazz,
        bool isVettedForAOT = false);
...
private:
    void transformJavaLangClassIsArrayOrIsPrimitive(TR::Compilation *, TR::Node *callNode, TR::TreeTop *treeTop,
        int32_t andMask);
...
public:
    ...
    virtual bool isPrimitiveArray(TR_OpaqueClassBlock *);
    virtual bool isReferenceArray(TR_OpaqueClassBlock *);
    virtual TR_OpaqueClassBlock *getClassFromSignature(const char *sig, int32_t length, J9ConstantPool *constantPool,
        bool isVettedForAOT = false);
    virtual TR_OpaqueClassBlock *getSystemClassFromClassName(const char *name, int32_t length,
        bool isVettedForAOT = false);
...
static inline char *utf8Data(J9UTF8 *name) { return (char *)J9UTF8_DATA(name); }
...
inline bool isValidVmStateIndex(uint32_t &index)
{
    ...
    //
    if (index <= 0 || (index >= 10 && index != 0x11))
        return false;
...
inline TR_PersistentMemory *persistentMemory(J9JITConfig *jitConfig)
{
    return (TR_PersistentMemory *)jitConfig->scratchSegment;
}
