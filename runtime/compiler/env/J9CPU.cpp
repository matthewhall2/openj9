...
TR::CPU J9::CPU::customize(OMRProcessorDesc processorDescription)
{
...
TR::CPU J9::CPU::detect(OMRPortLibrary * const omrPortLib)
{
    if (omrPortLib == NULL)
        return TR::CPU();
...
bool J9::CPU::supportsFeature(uint32_t feature)
{
