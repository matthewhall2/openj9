...
public:
    ...
    virtual TR_PersistentClassInfo *findClassInfoAfterLocking(TR_OpaqueClassBlock *classId, TR::Compilation *,
        bool returnClassInfoForAOT = false) override;
...
public:
    ...
    virtual bool classGotInitialized(TR_FrontEnd *fe, TR_PersistentMemory *persistentMemory,
        TR_OpaqueClassBlock *classId, TR_PersistentClassInfo *clazz) override;
    virtual void classGotRedefined(TR_FrontEnd *vm, TR_OpaqueClassBlock *oldClassId,
        TR_OpaqueClassBlock *newClassId) override;
 ...
 * @brief Class for serializing and deserializing CHTable data for JITServerPersistentCHtable and
