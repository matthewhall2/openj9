...
using VirtualGuardForCHTable = std::tuple<VirtualGuardInfoForCHTable, std::vector<TR_VirtualGuardSite>,
    std::vector<VirtualGuardInfoForCHTable> >;

using FlatClassLoadCheck = std::vector<std::string>;
using FlatClassExtendCheck = std::vector<TR_OpaqueClassBlock *>;

using CHTableCommitData = std::tuple<std::vector<TR_OpaqueClassBlock *>, // classes
