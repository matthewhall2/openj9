...
public:
    ...
    void invalidateRedefinedClass(TR_PersistentCHTable *table, TR_J9VMBase *fej9, TR_OpaqueClassBlock *oldClass,
...
public:
    ...
    static uintptr_t decodeDependencyOffset(uintptr_t offset) { return offset | 1; }
...
private:
    ...
    J9Class *findCandidateForDependency(const PersistentUnorderedSet<J9Class *> &loadedClasses,
