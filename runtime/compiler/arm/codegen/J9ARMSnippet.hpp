...
public:
    ARMMonitorEnterSnippet(TR::CodeGenerator *codeGen, TR::Node *monitorNode, int32_t lwOffset,
        // bool               isPreserving,
...
public:
    ARMMonitorExitSnippet(TR::CodeGenerator *codeGen, TR::Node *monitorNode, int32_t lwOffset,
        // bool               flag,
        // bool               isPreserving,
