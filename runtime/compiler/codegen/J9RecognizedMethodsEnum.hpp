...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_Class_getComponentType, java_lang_Class_getModifiersImpl, java_lang_Class_getStackClass,
    java_lang_Class_getSuperclass, java_lang_Class_isAssignableFrom, java_lang_Class_isInstance,
    java_lang_Class_isInterface, java_lang_Class_cast, java_lang_Class_all, java_lang_ClassLoader_callerClassLoader,
    ...
    java_lang_Math_sinh, java_lang_Math_sqrt, java_lang_Math_tan, java_lang_Math_tanh, java_lang_Math_fma_D,
    java_lang_Math_fma_F, java_lang_Math_multiplyHigh, java_lang_Object_init, java_lang_Object_getClass,
    java_lang_Object_clone, java_lang_Object_newInstancePrototype, java_lang_Object_getAddressAsPrimitive,
    java_lang_Object_hashCode, java_lang_ref_Reference_getImpl, java_lang_ref_Reference_reachabilityFence,
    java_lang_ref_Reference_refersTo, java_lang_ref_SoftReference_get, java_lang_Thread_currentThread,
    java_lang_Thread_onSpinWait, java_lang_Thread_runWith, java_lang_VirtualThread_runWith,
    java_lang_ScopedValue_runWith, java_lang_System_arraycopy, java_lang_System_currentTimeMillis,
    java_lang_System_nanoTime, java_lang_System_hiresClockImpl, java_lang_System_identityHashCode,
    sun_reflect_Reflection_getCallerClass, sun_reflect_Reflection_getClassAccessFlags,
    ...
    java_lang_String_getBytes_subString,
    ...
    java_lang_StringUTF16_getChars_ByteArray,
    ...
    java_lang_StringUTF16_replace_char,
