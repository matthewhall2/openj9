...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_Character_toLowerCase, java_lang_Class_newInstance, java_lang_Class_newInstanceImpl,
    java_lang_Class_newInstancePrototype, java_lang_Class_isArray, java_lang_Class_isPrimitive, java_lang_Class_isValue,
    java_lang_Class_isIdentity, java_lang_Class_getComponentType, java_lang_Class_getModifiersImpl,
    java_lang_Class_getStackClass, java_lang_Class_getSuperclass, java_lang_Class_isAssignableFrom,
    java_lang_Class_isInstance, java_lang_Class_isInterface, java_lang_Class_cast, java_lang_Class_all,
    java_lang_ClassLoader_callerClassLoader, java_lang_ClassLoader_getCallerClassLoader,
    java_lang_ClassLoader_getStackClassLoader, java_lang_Double_longBitsToDouble, java_lang_Double_doubleToLongBits,
    java_lang_Float_intBitsToFloat, java_lang_Float_floatToIntBits, java_lang_Double_doubleToRawLongBits,
    java_lang_Float_floatToRawIntBits, java_lang_Math_abs_I, java_lang_Math_abs_L, java_lang_Math_abs_F,
    java_lang_Math_abs_D, java_lang_Math_acos, java_lang_Math_asin, java_lang_Math_atan, java_lang_Math_atan2,
    java_lang_Math_cbrt, java_lang_Math_ceil, java_lang_Math_copySign_F, java_lang_Math_copySign_D, java_lang_Math_cos,
    java_lang_Math_cosh, java_lang_Math_exp, java_lang_Math_expm1, java_lang_Math_floor, java_lang_Math_hypot,
    java_lang_Math_IEEEremainder, java_lang_Math_log, java_lang_Math_log10, java_lang_Math_log1p, java_lang_Math_max_I,
    java_lang_Math_max_L, java_lang_Math_max_F, java_lang_Math_max_D, java_lang_Math_min_I, java_lang_Math_min_L,
    java_lang_Math_min_F, java_lang_Math_min_D, java_lang_Math_nextAfter_F, java_lang_Math_nextAfter_D,
    java_lang_Math_pow, java_lang_Math_rint, java_lang_Math_round_F, java_lang_Math_round_D, java_lang_Math_scalb_F,
    java_lang_Math_scalb_D, java_lang_Math_sin, java_lang_Math_sinh, java_lang_Math_sqrt, java_lang_Math_tan,
    java_lang_Math_tanh, java_lang_Math_fma_D, java_lang_Math_fma_F, java_lang_Math_multiplyHigh, java_lang_Object_init,
    java_lang_Object_getClass, java_lang_Object_clone, java_lang_Object_newInstancePrototype,
    java_lang_Object_getAddressAsPrimitive, java_lang_Object_hashCode, java_lang_ref_Reference_getImpl,
    java_lang_ref_Reference_reachabilityFence, java_lang_ref_Reference_refersTo, java_lang_ref_SoftReference_get,
    java_lang_Thread_currentThread, java_lang_Thread_onSpinWait, java_lang_Thread_runWith,
    java_lang_VirtualThread_runWith, java_lang_ScopedValue_runWith, java_lang_System_arraycopy,
    ...
    // Unboxing methods
    java_lang_Boolean_booleanValue, java_lang_Byte_byteValue, java_lang_Character_charValue, java_lang_Short_shortValue,
    java_lang_Integer_intValue, java_lang_Long_longValue, java_lang_Float_floatValue, java_lang_Double_doubleValue,

    java_lang_String_charAt, java_lang_String_charAtInternal_I, java_lang_String_charAtInternal_IB,
    java_lang_String_checkBoundsBeginEnd, java_lang_String_checkIndex, java_lang_String_coder,
    java_lang_String_compareTo, java_lang_String_compareToIgnoreCase, java_lang_String_compressedArrayCopy_BIBII,
    java_lang_String_compressedArrayCopy_BICII, java_lang_String_compressedArrayCopy_CIBII,
    java_lang_String_compressedArrayCopy_CICII, java_lang_String_concat, java_lang_String_decodeUTF8_UTF16,
    java_lang_String_decompressedArrayCopy_BIBII, java_lang_String_decompressedArrayCopy_BICII,
    java_lang_String_decompressedArrayCopy_CIBII, java_lang_String_decompressedArrayCopy_CICII,
    java_lang_String_deduplicateStrings, java_lang_String_encodeASCII, java_lang_String_equalsIgnoreCase,
    java_lang_String_getBytes, java_lang_String_getBytes_subString, java_lang_String_getChars_byteArray,
    java_lang_String_getChars_charArray, java_lang_String_hashCode, java_lang_String_hashCodeImplCompressed,
    java_lang_String_hashCodeImplDecompressed, java_lang_String_indexOf_char, java_lang_String_indexOf_fast,
    java_lang_String_indexOf_native, java_lang_String_indexOf_String, java_lang_String_indexOf_String_int,
    java_lang_String_init_AbstractStringBuilder_Void, java_lang_String_init_int_int_char_boolean,
    java_lang_String_init_int_String_int_String_String, java_lang_String_init_String, java_lang_String_init_String_char,
    java_lang_String_init_StringBuilder, java_lang_String_isCompressed, java_lang_String_isLatin1,
    java_lang_String_lastIndexOf, java_lang_String_length, java_lang_String_lengthInternal,
    java_lang_String_regionMatches, java_lang_String_regionMatches_bool, java_lang_String_regionMatchesInternal,
    java_lang_String_replace, java_lang_String_split_str_int, java_lang_String_startsWith, java_lang_String_subString,
    java_lang_String_toCharArray, java_lang_String_toLowerCase, java_lang_String_toLowerCaseCore,
    java_lang_String_toUpperCase, java_lang_String_toUpperCaseCore, java_lang_String_trim,
    java_lang_String_unsafeCharAt, java_lang_String_valueOf_C,

    java_lang_StringLatin1_charAt, java_lang_StringLatin1_indexOf, java_lang_StringLatin1_indexOf_BB,
    java_lang_StringLatin1_indexOf_BIII, java_lang_StringLatin1_indexOfChar, java_lang_StringLatin1_inflate_BIBII,
    java_lang_StringLatin1_inflate_BICII, java_lang_StringLatin1_lastIndexOf, java_lang_StringLatin1_newString,
    java_lang_StringLatin1_replace_char, java_lang_StringLatin1_replace_CharSequence, java_lang_StringLatin1_toBytes,
    java_lang_StringLatin1_toChars, java_lang_StringLatin1_toLowerCase, java_lang_StringLatin1_toUpperCase,
    java_lang_StringLatin1_trim,

    java_lang_StringUTF16_charAt, java_lang_StringUTF16_checkIndex, java_lang_StringUTF16_compareCodePointCI,
    java_lang_StringUTF16_compareToCIImpl, java_lang_StringUTF16_compareValues, java_lang_StringUTF16_getChar,
    java_lang_StringUTF16_getChars_ByteArray, java_lang_StringUTF16_getChars_Integer,
    java_lang_StringUTF16_getChars_Long, java_lang_StringUTF16_indexOf, java_lang_StringUTF16_indexOfCharUnsafe,
    java_lang_StringUTF16_indexOfUnsafe, java_lang_StringUTF16_length, java_lang_StringUTF16_newBytesFor,
    java_lang_StringUTF16_putChar, java_lang_StringUTF16_replace_char, java_lang_StringUTF16_replace_CharSequence,
    java_lang_StringUTF16_toBytes, java_lang_StringUTF16_toLowerCase, java_lang_StringUTF16_toUpperCase,
    ...
    java_lang_StringBuilder_append_int, java_lang_StringBuilder_append_long, java_lang_StringBuilder_append_Object,
    java_lang_StringBuilder_append_String, java_lang_StringBuilder_capacityInternal,
    java_lang_StringBuilder_ensureCapacityImpl, java_lang_StringBuilder_lengthInternal,
    java_lang_StringBuilder_toString,

    java_lang_AbstractStringBuilder_append_char, java_lang_AbstractStringBuilder_append_String,
    java_lang_AbstractStringBuilder_appendChars, java_lang_AbstractStringBuilder_ensureCapacityInternal,
    java_lang_AbstractStringBuilder_inflateIfNeededFor, java_lang_AbstractStringBuilder_putStringAt,
    ...
    java_nio_Bits_copyToByteArray, java_nio_Bits_copyFromByteArray, java_nio_Bits_keepAlive, java_nio_Bits_byteOrder,
    java_nio_Bits_getCharB, java_nio_Bits_getCharL, java_nio_Bits_getShortB, java_nio_Bits_getShortL,
    java_nio_Bits_getIntB, java_nio_Bits_getIntL, java_nio_Bits_getLongB, java_nio_Bits_getLongL,

    java_nio_HeapByteBuffer__get, java_nio_HeapByteBuffer_put,

    java_nio_ByteOrder_nativeOrder,

    java_util_regex_Matcher_init, java_util_regex_Matcher_usePattern,

    java_util_AbstractCollection_all, java_util_ArrayDeque_all, java_util_ArrayList_all,
    java_util_ComparableTimSort_all, java_util_concurrent_ConcurrentHashMap_all, java_util_HashMap_all,
    java_util_Hashtable_all, java_util_IdentityHashMap_all, java_util_ImmutableCollections_all,
    java_util_LinkedHashMap_all, java_util_LinkedList_all, java_util_Map_all, java_util_regex_Pattern_all,
    java_util_stream_Nodes_all, java_util_TimSort_all, java_util_Vector_all, java_util_WeakHashMap_all,
    ...
    java_util_Vector_subList, java_util_TreeMap_all,
    ...
    java_util_HashMap_rehash, java_util_HashMap_analyzeMap, java_util_HashMap_calculateCapacity,
    java_util_HashMap_findNullKeyEntry, java_util_HashMap_get, java_util_HashMap_getNode,
    java_util_HashMap_getNode_Object, java_util_HashMap_findNonNullKeyEntry, java_util_HashMap_hash,
    java_util_HashMap_put, java_util_HashMap_putImpl, java_util_HashMap_resize, java_util_HashMap_prepareArray,
    java_util_HashMap_keysToArray, java_util_HashMap_valuesToArray, java_util_HashMapHashIterator_nextNode,
    java_util_HashMapHashIterator_init, java_util_zip_CRC32_update, java_util_zip_CRC32_updateBytes,
    java_util_zip_CRC32_updateBytes0, java_util_zip_CRC32_updateByteBuffer, java_util_zip_CRC32_updateByteBuffer0,
    java_util_zip_CRC32C_updateBytes, java_util_zip_CRC32C_updateDirectByteBuffer,
    ...
    jdk_internal_misc_Unsafe_getBooleanAcquire_jlObjectJ_Z, jdk_internal_misc_Unsafe_getByteAcquire_jlObjectJ_B,
    jdk_internal_misc_Unsafe_getCharAcquire_jlObjectJ_C, jdk_internal_misc_Unsafe_getShortAcquire_jlObjectJ_S,
    jdk_internal_misc_Unsafe_getIntAcquire_jlObjectJ_I, jdk_internal_misc_Unsafe_getLongAcquire_jlObjectJ_J,
    jdk_internal_misc_Unsafe_getFloatAcquire_jlObjectJ_F, jdk_internal_misc_Unsafe_getDoubleAcquire_jlObjectJ_D,
    jdk_internal_misc_Unsafe_getReferenceAcquire_jlObjectJ_jlObject,

    jdk_internal_misc_Unsafe_getBooleanOpaque_jlObjectJ_Z, jdk_internal_misc_Unsafe_getByteOpaque_jlObjectJ_B,
    jdk_internal_misc_Unsafe_getCharOpaque_jlObjectJ_C, jdk_internal_misc_Unsafe_getShortOpaque_jlObjectJ_S,
    jdk_internal_misc_Unsafe_getIntOpaque_jlObjectJ_I, jdk_internal_misc_Unsafe_getLongOpaque_jlObjectJ_J,
    jdk_internal_misc_Unsafe_getFloatOpaque_jlObjectJ_F, jdk_internal_misc_Unsafe_getDoubleOpaque_jlObjectJ_D,
    jdk_internal_misc_Unsafe_getReferenceOpaque_jlObjectJ_jlObject,

    jdk_internal_misc_Unsafe_putBooleanOpaque_jlObjectJZ_V, jdk_internal_misc_Unsafe_putByteOpaque_jlObjectJB_V,
    jdk_internal_misc_Unsafe_putCharOpaque_jlObjectJC_V, jdk_internal_misc_Unsafe_putShortOpaque_jlObjectJS_V,
    jdk_internal_misc_Unsafe_putIntOpaque_jlObjectJI_V, jdk_internal_misc_Unsafe_putLongOpaque_jlObjectJJ_V,
    jdk_internal_misc_Unsafe_putFloatOpaque_jlObjectJF_V, jdk_internal_misc_Unsafe_putDoubleOpaque_jlObjectJD_V,
    jdk_internal_misc_Unsafe_putReferenceOpaque_jlObjectJjlObject_V,

    jdk_internal_misc_Unsafe_compareAndExchangeInt, jdk_internal_misc_Unsafe_compareAndExchangeLong,
    jdk_internal_misc_Unsafe_compareAndExchangeObject, jdk_internal_misc_Unsafe_compareAndExchangeReference,

    jdk_internal_misc_Unsafe_copyMemory0, jdk_internal_misc_Unsafe_getCharUnaligned,
    jdk_internal_misc_Unsafe_getShortUnaligned, jdk_internal_misc_Unsafe_getIntUnaligned,
    ...
    jdk_internal_vm_vector_VectorSupport_store, jdk_internal_vm_vector_VectorSupport_binaryOp,
    jdk_internal_vm_vector_VectorSupport_blend, jdk_internal_vm_vector_VectorSupport_broadcastInt,
    jdk_internal_vm_vector_VectorSupport_compare, jdk_internal_vm_vector_VectorSupport_compressExpandOp,
    jdk_internal_vm_vector_VectorSupport_convert, jdk_internal_vm_vector_VectorSupport_extract,
    jdk_internal_vm_vector_VectorSupport_fromBitsCoerced,
    jdk_internal_vm_vector_VectorSupport_indexPartiallyInUpperRange, jdk_internal_vm_vector_VectorSupport_indexVector,
    jdk_internal_vm_vector_VectorSupport_insert, jdk_internal_vm_vector_VectorSupport_loadMasked,
    jdk_internal_vm_vector_VectorSupport_loadWithMap, jdk_internal_vm_vector_VectorSupport_maskReductionCoerced,
    jdk_internal_vm_vector_VectorSupport_rearrangeOp, jdk_internal_vm_vector_VectorSupport_reductionCoerced,
    jdk_internal_vm_vector_VectorSupport_selectFromOp, jdk_internal_vm_vector_VectorSupport_selectFromTwoVectorOp,
    jdk_internal_vm_vector_VectorSupport_shuffleIota, jdk_internal_vm_vector_VectorSupport_shuffleToVector,
    jdk_internal_vm_vector_VectorSupport_storeMasked, jdk_internal_vm_vector_VectorSupport_storeWithMap,
    jdk_internal_vm_vector_VectorSupport_ternaryOp, jdk_internal_vm_vector_VectorSupport_test,
    jdk_internal_vm_vector_VectorSupport_unaryOp, jdk_internal_vm_vector_VectorSupport_wrapShuffleIndexes,
    ...
    sun_nio_cs_ext_IBM1388_Encoder_encodeArrayLoop, sun_nio_cs_SingleByteDecoder_decodeToLatin1Impl,
    sun_nio_cs_SingleByteEncoder_encodeFromLatin1Impl,
    ...
    java_math_BigDecimal_floatValue, java_math_BigDecimal_doubleValue, java_math_BigDecimal_possibleClone,
    ...
    com_ibm_jit_JITHelpers_getClassInitializeStatus, com_ibm_jit_JITHelpers_dispatchComputedStaticCall,
    ...
    java_lang_StrictMath_fma_D, java_lang_StrictMath_fma_F,
    ...
    java_util_concurrent_ConcurrentHashMap_setTabAt, java_util_concurrent_ConcurrentHashMap_get,
    ...
    // JSR292
    java_lang_invoke_BruteArgumentMoverHandle_permuteArgs, java_lang_invoke_ArgumentMoverHandle_permuteArgs,
    java_lang_invoke_AsTypeHandle_convertArgs, java_lang_invoke_CatchHandle_numCatchTargetArgsToPassThrough,
    java_lang_invoke_CollectHandle_numArgsToCollect, java_lang_invoke_CollectHandle_numArgsToPassThrough,
    java_lang_invoke_CollectHandle_collectionStart, java_lang_invoke_CollectHandle_numArgsAfterCollectArray,
    java_lang_invoke_CollectHandle_invokeExact, java_lang_invoke_CollectHandle_allocateArray,
    java_lang_invoke_ComputedCalls_dispatchDirect, java_lang_invoke_ComputedCalls_dispatchJ9Method,
    java_lang_invoke_ComputedCalls_dispatchVirtual, java_lang_invoke_ConvertHandleFilterHelpers_object2J,
    java_lang_invoke_ConvertHandleFilterHelpers_number2J, java_lang_invoke_DirectHandle_compiledEntryPoint,
    java_lang_invoke_DirectHandle_nullCheckIfRequired, java_lang_invoke_DirectHandle_directCall,
    java_lang_invoke_DirectHandle_invokeExact, java_lang_invoke_DirectHandle_isAlreadyCompiled,
    java_lang_invoke_ExplicitCastHandle_convertArgs, java_lang_invoke_FilterArgumentsHandle_filterArguments,
    java_lang_invoke_FilterArgumentsHandle_numArgsToFilter, java_lang_invoke_FilterArgumentsHandle_numPrefixArgs,
    ...
    java_lang_invoke_FilterArgumentsWithCombinerHandle_numSuffixArgs, java_lang_invoke_GuardWithTestHandle_numGuardArgs,
    java_lang_invoke_ILGenMacros_arrayElements, java_lang_invoke_ILGenMacros_arrayLength,
    java_lang_invoke_ILGenMacros_dropFirstN, java_lang_invoke_ILGenMacros_first, java_lang_invoke_ILGenMacros_firstN,
    java_lang_invoke_ILGenMacros_getField, java_lang_invoke_ILGenMacros_invokeExact,
    java_lang_invoke_ILGenMacros_invokeExactAndFixup, java_lang_invoke_ILGenMacros_invokeExact_X,
    java_lang_invoke_ILGenMacros_isCustomThunk, java_lang_invoke_ILGenMacros_isShareableThunk,
    java_lang_invoke_ILGenMacros_last, java_lang_invoke_ILGenMacros_lastN, java_lang_invoke_ILGenMacros_middleN,
    java_lang_invoke_ILGenMacros_numArguments, java_lang_invoke_ILGenMacros_parameterCount,
    java_lang_invoke_ILGenMacros_placeholder, java_lang_invoke_ILGenMacros_pop,
    java_lang_invoke_ILGenMacros_populateArray, java_lang_invoke_ILGenMacros_push, java_lang_invoke_ILGenMacros_rawNew,
    java_lang_invoke_ILGenMacros_typeCheck, java_lang_invoke_InsertHandle_numPrefixArgs,
    ...
    java_lang_invoke_Invokers_checkGenericType,java_lang_invoke_Invokers_checkVarHandleGenericType,java_lang_invoke_MethodHandle_doCustomizationLogic,
    ...
    java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthI, java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthJ,
    java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthF, java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthD,
    java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthZ, java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthB,
    java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthS, java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthC,
    java_lang_invoke_MethodHandleImpl_ArrayAccessor_lengthL,
    java_lang_invoke_MethodHandleImpl_CountingWrapper_getTarget, java_lang_invoke_DelegatingMethodHandle_getTarget,
    java_lang_invoke_DirectMethodHandle_internalMemberName,
    java_lang_invoke_DirectMethodHandle_internalMemberNameEnsureInit,
    java_lang_invoke_DirectMethodHandle_constructorMethod, java_lang_invoke_DirectMethodHandle_checkCast,
    java_lang_invoke_DirectMethodHandle_Accessor_checkCast, java_lang_invoke_MethodHandles_getStackClass,
    java_lang_invoke_MethodHandle_type, java_lang_invoke_MethodHandle_undoCustomizationLogic,
    ...
    java_lang_invoke_StaticFieldGetterHandle_invokeExact, java_lang_invoke_StaticFieldSetterHandle_invokeExact,
    java_lang_invoke_FieldGetterHandle_invokeExact, java_lang_invoke_FieldSetterHandle_invokeExact,
    java_lang_invoke_FilterArgumentsHandle_invokeExact, java_lang_invoke_VarHandle_asDirect,
    ...
    java_lang_invoke_MethodHandleImpl_profileBoolean, java_lang_invoke_MethodHandleImpl_isCompileConstant,

    java_lang_invoke_VarHandleX_Array_method, java_lang_invoke_VarHandleX_FieldInstanceReadOnlyOrReadWrite_method,
    ...
    java_lang_J9VMInternals_defaultClone, java_lang_J9VMInternals_getNumBitsInReferenceField,
    java_lang_J9VMInternals_getNumBytesInReferenceField, java_lang_J9VMInternals_getNumBitsInDescriptionWord,
    java_lang_J9VMInternals_getNumBytesInDescriptionWord, java_lang_J9VMInternals_getNumBytesInJ9ObjectHeader,
    java_lang_J9VMInternals_getJ9ClassFromClass32, java_lang_J9VMInternals_getInstanceShapeFromJ9Class32,
    java_lang_J9VMInternals_getInstanceDescriptionFromJ9Class32, java_lang_J9VMInternals_getDescriptionWordFromPtr32,
    java_lang_J9VMInternals_getJ9ClassFromClass64, java_lang_J9VMInternals_getInstanceShapeFromJ9Class64,
    java_lang_J9VMInternals_getInstanceDescriptionFromJ9Class64, java_lang_J9VMInternals_getDescriptionWordFromPtr64,
    java_lang_J9VMInternals_getSuperclass, java_lang_J9VMInternals_primitiveClone,
