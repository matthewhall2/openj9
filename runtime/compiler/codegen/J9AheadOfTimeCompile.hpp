...
public:
     ...
     * @param[out] classChainRecord pointer to the AOT cache class chain record corresponding to the class chain, if
     * this is an out-of-process compilation that will be stored in JITServerAOT cache; ignored for local compilations
     * and out-of-process compilations not stored in AOT cache
     ...
     */
    void addClassSerializationRecord(const AOTCacheClassChainRecord *classChainRecord,
     ...
     */
    void addMethodSerializationRecord(J9Method *method, TR_OpaqueClassBlock *definingClass,
     ...
     */
    void addClassChainSerializationRecord(const AOTCacheClassChainRecord *classChainRecord,
     ...
     */
    void addClassLoaderSerializationRecord(const AOTCacheClassChainRecord *classChainRecord,
     ...
     */
    void addWellKnownClassesSerializationRecord(const AOTCacheWellKnownClassesRecord *wkcRecord,
    ...
    {
        return TR_RelocationRecord::getSizeOfAOTRelocationHeader(k);
    }
...
protected:
     ...
     */
    uintptr_t offsetInSharedCacheFromMethod(TR_SharedCache *sharedCache, TR_OpaqueMethodBlock *method,
     ...
     */
    void initializeCommonAOTRelocationHeader(TR::IteratedExternalRelocation *relocation,
        TR_RelocationTarget *reloTarget, TR_RelocationRecord *reloRecord, uint8_t kind);
     ...
     *
     * @param comp pointer to the TR::Compilation object
     */
