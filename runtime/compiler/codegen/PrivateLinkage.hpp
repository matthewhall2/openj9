...
public:
    ...
    public:
        ...
        {
            TR_ASSERT((_word & HasFailedRecompilation) == 0,
                "Cannot setHasBeenRecompiled because method has failed recompilation");
            _word |= HasBeenRecompiled;
        }

        void setHasFailedRecompilation()
        {
            TR_ASSERT((_word & HasBeenRecompiled) == 0,
                "Cannot setHasFailedRecompilation because method has been recompiled");
