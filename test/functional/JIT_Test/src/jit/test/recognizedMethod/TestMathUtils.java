 ...
 */
 ...
 public class TestMathUtils {
     ...
     private static final int fNaNQuietBit = 0x00400000;
     private static final int fNaNPrefix = 0x7f800000;
     ...
     private static final long dNaNPrefix = 0x7ff0000000000000L;
     private static final long  dNaNQuietBit = 0x0008000000000000L;
     ...
     private static NaNTestPair<Double, Long> getDoubleNaNPair(){
         ...
         if (arg1Type == 0) {
             iarg1 = iarg1 | dNaNPrefix | dNaNQuietBit;
             farg1 = Double.longBitsToDouble(iarg1);
         } else if (arg1Type == 1) {
             iarg1 = iarg1 | dNaNPrefix;
             farg1 = Double.longBitsToDouble(iarg1);
         } else {
         ...
         if (arg2Type == 0) {
             iarg2 = iarg2 | dNaNPrefix | dNaNQuietBit;
             farg2 = Double.longBitsToDouble(iarg2);
         }
         else if (arg2Type == 1) {
             iarg2 = iarg2 | dNaNPrefix;
             farg2 = Double.longBitsToDouble(iarg2);
         } else {
             if (arg1Type != 2) {
     ...
     private static NaNTestPair<Float, Integer> getFloatNaNPair(){ // 0: max, 1: min
         ...
         if (arg2Type == 0) {
             ...
             iarg2 = (r.nextInt(fNaNMantisaMax - 1) + 1) | fNaNPrefix;
             farg2 = Float.intBitsToFloat(iarg2);
         } else {
             if (arg1Type != 2) {
